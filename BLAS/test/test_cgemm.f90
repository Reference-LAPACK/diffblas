! Test program for CGEMM differentiation
...
contains
  ...
  subroutine run_test_for_size(n, passed)
    ...
    call cgemm_d(transa, transb, msize, nsize, ksize, alpha, alpha_d, a, a_d, lda_val, b, b_d, ldb_val, beta, beta_d, c, c_d, ldc_val)

    write(*,*) 'Function calls completed successfully'

    ! Numerical differentiation check
    call check_derivatives_numerically(n, transa, transb, msize, nsize, ksize, lda_val, ldb_val, ldc_val, a_orig, alpha_orig, c_orig, b_orig, beta_orig, a_d_orig, alpha_d_orig, c_d_orig, b_d_orig, beta_d_orig, c_d, passed)

  end subroutine run_test_for_size

  subroutine check_derivatives_numerically(n, transa, transb, msize, nsize, ksize, lda_val, ldb_val, ldc_val, a_orig, alpha_orig, c_orig, b_orig, beta_orig, a_d_orig, alpha_d_orig, c_d_orig, b_d_orig, beta_d_orig, c_d, passed)
    implicit none
    integer, intent(in) :: n
