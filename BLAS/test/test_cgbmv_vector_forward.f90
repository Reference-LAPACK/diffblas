! Test program for CGBMV vector forward mode differentiation
! Generated automatically by run_tapenade_blas.py
! Using REAL*4 precision with nbdirs=4

program test_cgbmv_vector_forward
  implicit none
  ...
  test_sizes = (/ 4 /)
  write(*,*) 'Testing CGBMV (Vector Forward, multi-size: n = 4)'
  all_passed = .true.
  do itest = 1, 1
    n = test_sizes(itest)
    write(*,*) 'Testing CGBMV (Vector Forward, n =', n, ')'
...
contains
  ...
  subroutine run_test_for_size(n, passed)
    ...
    write(*,*) 'Testing CGBMV (Vector Forward Mode)'
    ...
    call cgbmv_dv(trans, msize, nsize, kl, ku, alpha, alpha_dv, a, a_dv, lda_val, x, x_dv, incx_val, beta, beta_dv, y, y_dv, incy_val, nbdirs)
...
end program test_cgbmv_vector_forward