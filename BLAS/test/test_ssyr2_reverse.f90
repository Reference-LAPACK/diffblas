! Test program for SSYR2 reverse mode (adjoint) differentiation
! Generated automatically by run_tapenade_blas.py
! Using REAL*4 precision
! Multi-size test with outlined run_test_for_size(n) - arrays declared to size n

program test_ssyr2_reverse
  implicit none
...
contains
  ...
  subroutine run_test_for_size(n, passed)
    ...
    call ssyr2_b(uplo, nsize, alpha, alphab, x, xb, incx_val, y, yb, incy_val, a, ab, lda_val)

    call set_ISIZE1OFX(-1)
    call set_ISIZE1OFY(-1)

    call check_vjp_numerically(n, uplo, nsize, incx_val, incy_val, lda_val, alpha_orig, x_orig, y_orig, a_orig, ab_orig, alphab, xb, yb, ab, passed)

  end subroutine run_test_for_size

  subroutine check_vjp_numerically(n, uplo, nsize, incx_val, incy_val, lda_val, alpha_orig, x_orig, y_orig, a_orig, ab_orig, alphab, xb, yb, ab, passed)
    implicit none
    integer, intent(in) :: n
...
end program test_ssyr2_reverse