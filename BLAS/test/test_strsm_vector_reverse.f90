! Test program for STRSM vector reverse (BLAS3 outlined)
program test_strsm_vector_reverse
  ...
  test_sizes = (/ 4 /)
  write(*,*) 'Testing STRSM (Vector Reverse, multi-size: n =', test_sizes(1), ')'
  all_passed = .true.
  do i = 1, 1
    n_test = test_sizes(i)
    nbdirs = n_test
...
contains
  subroutine run_test_for_size(n, passed, nbdirs)
    ...
    write(*,*) 'Testing STRSM (Vector Reverse, n =', n, ')'
...
end program test_strsm_vector_reverse