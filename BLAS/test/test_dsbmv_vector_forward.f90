...
program test_dsbmv_vector_forward
  ...
  test_sizes = (/ 4 /)
  write(*,*) 'Testing DSBMV (Vector Forward, multi-size: n = 4)'
  all_passed = .true.
  do itest = 1, 1
    n = test_sizes(itest)
    write(*,*) 'Testing DSBMV (Vector Forward, n =', n, ')'
...
contains
  ...
  subroutine run_test_for_size(n, passed)
    ...
    call dsbmv_dv(uplo, nsize, ksize, alpha, alpha_dv, a, a_dv, lda_val, x, x_dv, incx_val, beta, beta_dv, y, y_dv, incy_val, nbdirs)
