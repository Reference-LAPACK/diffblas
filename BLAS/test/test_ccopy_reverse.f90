...
contains
  ...
  subroutine run_test_for_size(n, passed)
    ...
    call check_vjp_numerically(n, nsize, incx_val, incy_val, cx_orig, cy_orig, cyb_orig, cxb, cyb, passed)

  end subroutine run_test_for_size

  subroutine check_vjp_numerically(n, nsize, incx_val, incy_val, cx_orig, cy_orig, cyb_orig, cxb, cyb, passed)
    implicit none
    integer, intent(in) :: n
