! Test program for ZHEMV differentiation
...
program test_zhemv
  ...
  complex(8) :: beta_d
  complex(8), dimension(max_size) :: y_d
  ...
  call zhemv_d(uplo, nsize, alpha, alpha_d, a, a_d, lda_val, x, x_d, incx_val, beta, beta_d, y, y_d, incy_val)
