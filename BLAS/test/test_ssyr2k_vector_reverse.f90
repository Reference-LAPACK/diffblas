! Test program for SSYR2K vector reverse mode differentiation
...
program test_ssyr2k_vector_reverse
  ...
  test_sizes = (/ 4 /)
  write(*,*) 'Testing SSYR2K (Vector Reverse, multi-size: n = 4)'
  all_passed = .true.
  do itest = 1, 1
    n = test_sizes(itest)
  ...
  call ssyr2k_bv(uplo, trans, nsize, ksize, alpha, alphab, a, ab, lda_val, b, bb, ldb_val, beta, betab, c, cb, ldc_val, nbdirs)
