! Test program for ZSYMM vector reverse mode differentiation
...
program test_zsymm_vector_reverse
  ...
  call zsymm_bv(side, uplo, msize, nsize, alpha, alphab, a, ab, lda_val, b, bb, ldb_val, beta, betab, c, cb, ldc_val, nbdirsmax)
