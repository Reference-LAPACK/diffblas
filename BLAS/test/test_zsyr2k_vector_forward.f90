! Test program for ZSYR2K vector forward mode differentiation
...
program test_zsyr2k_vector_forward
  ...
  write(*,*) 'Testing ZSYR2K (Vector Forward Mode)'
  ...
  call zsyr2k_dv(uplo, trans, nsize, ksize, alpha, alpha_dv, a, a_dv, lda_val, b, b_dv, ldb_val, beta, beta_dv, c, c_dv, ldc_val, nbdirs)
