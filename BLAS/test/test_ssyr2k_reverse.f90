! Test program for SSYR2K reverse (BLAS3 outlined)
program test_ssyr2k_reverse
  ...
  test_sizes = (/ 4 /)
  write(*,*) 'Testing SSYR2K (multi-size: n =', test_sizes(1), ')'
  all_passed = .true.
  do i = 1, 1
...
contains
  subroutine run_test_for_size(n, passed)
    ...
    call ssyr2k_b(uplo, transa, nsize, ksize, alpha, alphab, a, ab, lda_val, b, bb, ldb_val, beta, betab, c, cb, ldc_val)
    ...
    c_plus = c
    call ssyr2k(uplo, transa, nsize, ksize, alpha + h*alphab, a + h*ab, lda_val, b + h*bb, ldb_val, beta + h*betab, c_plus, ldc_val)
    c_minus = c
    call ssyr2k(uplo, transa, nsize, ksize, alpha - h*alphab, a - h*ab, lda_val, b - h*bb, ldb_val, beta - h*betab, c_minus, ldc_val)
    vjp_fd = 0.0d0
    do jj = 1, n
      do ii = 1, n
