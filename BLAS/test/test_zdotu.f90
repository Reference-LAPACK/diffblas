...
program test_zdotu
  ...
  zdotu_result = zdotu(nsize, zx, incx_val, zy, incy_val)
  ...
  zdotu_d_result = zdotu_d(nsize, zx, zx_d, incx_val, zy, zy_d, incy_val, zdotu_result)
...
contains
  ...
  subroutine check_derivatives_numerically()
    ...
    ! zdotu_forward already captured above
    ...
    ! zdotu_backward already captured above
    
    ! Compute central differences and compare with AD results
    ! Check derivatives for function ZDOTU
    ...
    if (abs_error > error_bound) then
      ...
      write(*,*) 'Large error in function ZDOTU:'
