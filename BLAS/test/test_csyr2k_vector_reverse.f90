! Test program for CSYR2K vector reverse mode differentiation
...
program test_csyr2k_vector_reverse
  ...
  test_sizes = (/ 4 /)
  write(*,*) 'Testing CSYR2K (Vector Reverse, multi-size: n = 4)'
  all_passed = .true.
  do itest = 1, 1
    n = test_sizes(itest)
  ...
  call csyr2k_bv(uplo, trans, nsize, ksize, alpha, alphab, a, ab, lda_val, b, bb, ldb_val, beta, betab, c, cb, ldc_val, nbdirs)
