! Test program for ZSCAL reverse mode (adjoint) differentiation
! Generated automatically by run_tapenade_blas.py
! Using REAL*8 precision
! Multi-size test with outlined run_test_for_size(n) - arrays declared to size n

program test_zscal_reverse
  implicit none
  ...
  test_sizes = (/ 4 /)
  write(*,*) 'Testing ZSCAL (multi-size: n = 4)'
  all_passed = .true.
  do i = 1, 1
    n_test = test_sizes(i)
...
contains
  ...
  subroutine run_test_for_size(n, passed)
    ...
    call zscal_b(nsize, za, zab, zx, zxb, incx_val)

    call check_vjp_numerically(n, nsize, incx_val, za_orig, zx_orig, zxb_orig, zab, zxb, passed)

  end subroutine run_test_for_size

  subroutine check_vjp_numerically(n, nsize, incx_val, za_orig, zx_orig, zxb_orig, zab, zxb, passed)
    implicit none
    integer, intent(in) :: n
...
end program test_zscal_reverse