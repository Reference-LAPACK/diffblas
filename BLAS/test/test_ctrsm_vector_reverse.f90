! Test program for CTRSM vector reverse mode differentiation
...
program test_ctrsm_vector_reverse
  ...
  complex(4), dimension(nbdirs,max_size,max_size) :: bb_orig
  ...
  test_sizes = (/ 4 /)
  write(*,*) 'Testing CTRSM (Vector Reverse, multi-size: n = 4)'
  all_passed = .true.
  do itest = 1, 1
    n = test_sizes(itest)
