! Test program for SSPR differentiation
...
program test_sspr
  ...
  test_sizes = (/ 4, 10, 25 /)
  write(*,*) 'Testing SSPR (multi-size: n = 4)'
  all_passed = .true.
  do i = 1, 3
    n_test = test_sizes(i)
...
contains
  subroutine run_test_for_size(n, passed)
    ...
    ap_orig = ap
    ap_d_seed = ap_d
    write(*,*) 'Testing SSPR (n =', n, ')'
    call sspr_d(uplo, nsize, alpha, alpha_d, x, x_d, incx_val, ap, ap_d)
