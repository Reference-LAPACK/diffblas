...
program test_dsbmv_vector_reverse
  ...
  integer :: ksize
  real(8) :: alpha
  real(8), dimension(max_size,n) :: a  ! Band storage
  integer :: lda_val
  ...
  real(8), dimension(nbdirsmax,max_size,n) :: ab  ! Band storage
  ...
  call dsbmv_bv(uplo, nsize, ksize, alpha, alphab, a, ab, lda_val, x, xb, incx_val, beta, betab, y, yb, incy_val, nbdirsmax)
...
contains
  ...
  subroutine check_vjp_numerically()
    ...
    real(8) :: alpha_dir
    real(8), dimension(max_size,n) :: a_dir
