...
program test_dspr2
  ...
  real(8), dimension(max_size*(max_size+1)/2) :: ap_d

  ! Storage variables for inout parameters
  real(8), dimension(max_size*(max_size+1)/2) :: ap_output
  ...
  real(8), dimension(max_size*(max_size+1)/2) :: ap_d_orig
  ...
  write(*,*) 'Testing DSPR2 (multi-size: n = 1, 2, 3, 4)'
  do n_test = 1, 4
    n = n_test
