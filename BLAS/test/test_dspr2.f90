! Test program for DSPR2 differentiation
...
program test_dspr2
  ...
  test_sizes = (/ 4, 10, 25 /)
  write(*,*) 'Testing DSPR2 (multi-size: n = 4)'
  all_passed = .true.
  do i = 1, 3
    n_test = test_sizes(i)
...
contains
  subroutine run_test_for_size(n, passed)
    ...
    call dspr2_d(uplo, nsize, alpha, alpha_d, x, x_d, incx_val, y, y_d, incy_val, ap, ap_d)
