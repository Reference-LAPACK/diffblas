...
contains
  ...
  subroutine run_test_for_size(n, passed)
    ...
    call check_derivatives_numerically(n, nsize, cx_orig, cy_orig, cx_d_orig, cy_d_orig, cy_d, passed)

  end subroutine run_test_for_size

  subroutine check_derivatives_numerically(n, nsize, cx_orig, cy_orig, cx_d_orig, cy_d_orig, cy_d, passed)
    implicit none
    integer, intent(in) :: n
