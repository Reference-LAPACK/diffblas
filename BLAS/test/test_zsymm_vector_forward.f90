! Test program for ZSYMM vector forward mode differentiation
...
program test_zsymm_vector_forward
  ...
  call zsymm_dv(side, uplo, msize, nsize, alpha, alpha_dv, a, a_dv, lda_val, b, b_dv, ldb_val, beta, beta_dv, c, c_dv, ldc_val, nbdirsmax)
