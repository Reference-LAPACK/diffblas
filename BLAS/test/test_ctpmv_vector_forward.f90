...
program test_ctpmv_vector_forward
  ...
  complex(4), dimension(nbdirsmax,(n*(n+1))/2) :: ap_dv
  complex(4), dimension(nbdirsmax,max_size) :: x_dv
  ! Declare variables for storing original values
  complex(4), dimension((n*(n+1))/2) :: ap_orig
  complex(4), dimension(nbdirsmax,(n*(n+1))/2) :: ap_dv_orig
  ...
  call ctpmv_dv(uplo, trans, diag, nsize, ap, ap_dv, x, x_dv, incx_val, nbdirsmax)
