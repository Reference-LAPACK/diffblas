! Test program for CGERC vector reverse mode differentiation
! Generated automatically by run_tapenade_blas.py
! Using REAL*4 precision with nbdirsmax=4

program test_cgerc_vector_reverse
  implicit none
  ...
  complex(4), dimension(nbdirsmax,max_size,max_size) :: ab_orig
  ...
  call cgerc_bv(msize, nsize, alpha, alphab, x, xb, incx_val, y, yb, incy_val, a, ab, lda_val, nbdirsmax)
...
contains
  ...
  subroutine check_vjp_numerically()
    ...
    complex(4), dimension(max_size,max_size) :: a_plus, a_minus, a_central_diff
...
end program test_cgerc_vector_reverse