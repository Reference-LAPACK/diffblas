...
program test_cswap_vector_forward
  ...
  complex(4), dimension(nbdirsmax,max_size) :: cx_dv
  complex(4), dimension(nbdirsmax,max_size) :: cy_dv
  ! Declare variables for storing original values
  complex(4), dimension(max_size) :: cx_orig
  complex(4), dimension(nbdirsmax,max_size) :: cx_dv_orig
  ...
  call cswap_dv(nsize, cx, cx_dv, incx_val, cy, cy_dv, incy_val, nbdirsmax)
