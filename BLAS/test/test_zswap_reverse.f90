! Test program for ZSWAP reverse mode (adjoint) differentiation
! Generated automatically by run_tapenade_blas.py
! Using REAL*8 precision
! Multi-size test with outlined run_test_for_size(n) - arrays declared to size n

program test_zswap_reverse
  implicit none
...
contains
  ...
  subroutine run_test_for_size(n, passed)
    ...
    call zswap_b(nsize, zx, zxb, incx_val, zy, zyb, incy_val)

    call check_vjp_numerically(n, nsize, incx_val, incy_val, zx_orig, zy_orig, zxb_orig, zyb_orig, zxb, zyb, passed)

  end subroutine run_test_for_size

  subroutine check_vjp_numerically(n, nsize, incx_val, incy_val, zx_orig, zy_orig, zxb_orig, zyb_orig, zxb, zyb, passed)
    implicit none
    integer, intent(in) :: n
...
end program test_zswap_reverse