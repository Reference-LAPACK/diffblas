...
program test_zdotc
  ...
  zdotc_result = zdotc(nsize, zx, incx_val, zy, incy_val)
  ...
  zdotc_d_result = zdotc_d(nsize, zx, zx_d, incx_val, zy, zy_d, incy_val, zdotc_result)
...
contains
  ...
  subroutine check_derivatives_numerically()
    ...
    ! zdotc_forward already captured above
    ...
    ! zdotc_backward already captured above
    
    ! Compute central differences and compare with AD results
    ! Check derivatives for function ZDOTC
    ...
    if (abs_error > error_bound) then
      ...
      write(*,*) 'Large error in function ZDOTC:'
