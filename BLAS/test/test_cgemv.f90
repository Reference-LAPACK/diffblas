! Test program for CGEMV differentiation
...
program test_cgemv
  ...
  test_sizes = (/ 4, 10, 25 /)
  write(*,*) 'Testing CGEMV (multi-size: n = 4)'
  all_passed = .true.
  do i = 1, 3
    n_test = test_sizes(i)
...
contains
  ...
  subroutine run_test_for_size(n, passed)
    ...
    write(*,*) 'Testing CGEMV (n =', n, ')'
    y_orig = y

    ! Call the differentiated function
    call cgemv_d(trans, msize, nsize, alpha, alpha_d, a, a_d, lda_val, x, x_d, 1, beta, beta_d, y, y_d, 1)
    x_d = x_d_orig
    beta_d = beta_d_orig
    a_d = a_d_orig
    ...
    call check_derivatives_numerically(n, trans, msize, nsize, lda_val, x_orig, beta_orig, a_orig, alpha_orig, y_orig, x_d_orig, beta_d_orig, a_d_orig, alpha_d_orig, y_d_orig, y_d, passed)

  end subroutine run_test_for_size

  subroutine check_derivatives_numerically(n, trans, msize, nsize, lda_val, x_orig, beta_orig, a_orig, alpha_orig, y_orig, x_d_orig, beta_d_orig, a_d_orig, alpha_d_orig, y_d_orig, y_d, passed)
    implicit none
    integer, intent(in) :: n
    ...
    y = y_orig + h * y_d_orig
    call cgemv(trans, msize, nsize, alpha, a, lda_val, x, 1, beta, y, 1)
    y_forward = y
