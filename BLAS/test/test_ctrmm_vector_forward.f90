! Test program for CTRMM vector forward mode differentiation
...
program test_ctrmm_vector_forward
  ...
  call ctrmm_dv(side, uplo, transa, diag, msize, nsize, alpha, alpha_dv, a, a_dv, lda_val, b, b_dv, ldb_val, nbdirsmax)
