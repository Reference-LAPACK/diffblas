...
program test_chemv_reverse
  ...
  call chemv_b(uplo, nsize, alpha, alphab, a, ab, lda_val, x, xb, incx_val, beta, betab, y, yb, incy_val)
...
end program test_chemv_reverse