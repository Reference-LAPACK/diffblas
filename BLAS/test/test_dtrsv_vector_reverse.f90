...
program test_dtrsv_vector_reverse
  ...
  test_sizes = (/ 4 /)
  write(*,*) 'Testing DTRSV (Vector Reverse, multi-size: n =', test_sizes(1), ')'
  all_passed = .true.
  do i = 1, 1
    n_test = test_sizes(i)
    nbdirs = test_sizes(i)
...
contains
  ...
  subroutine run_test_for_size(n, passed, nbdirs)
    ...
    write(*,*) 'Testing DTRSV (Vector Reverse, n =', n, ')'

    call set_ISIZE2OFA(n)

    call dtrsv_bv(uplo, trans, diag, nsize, a, ab, lda_val, x, xb, incx_val, nbdirs)
...
end program test_dtrsv_vector_reverse