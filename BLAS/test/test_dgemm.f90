! Test program for DGEMM differentiation
...
contains
  ...
  subroutine run_test_for_size(n, passed)
    ...
    call dgemm_d(transa, transb, msize, nsize, ksize, alpha, alpha_d, a, a_d, lda_val, b, b_d, ldb_val, beta, beta_d, c, c_d, ldc_val)
