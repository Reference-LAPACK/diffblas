! Test program for DSYR2 differentiation
...
program test_dsyr2
  ...
  test_sizes = (/ 4, 10, 25 /)
  write(*,*) 'Testing DSYR2 (multi-size: n = 4)'
  all_passed = .true.
  do i = 1, 3
    n_test = test_sizes(i)
...
contains
  ...
  subroutine run_test_for_size(n, passed)
    ...
    write(*,*) 'Testing DSYR2 (n =', n, ')'
    a_orig = a

    ! Call the differentiated function
    call dsyr2_d(uplo, nsize, alpha, alpha_d, x, x_d, 1, y, y_d, 1, a, a_d, lda_val)
    x_d = x_d_orig
    ...
    call check_derivatives_numerically(n, uplo, nsize, lda_val, x_orig, a_orig, alpha_orig, y_orig, x_d_orig, a_d_orig, alpha_d_orig, y_d_orig, a_d, passed)

  end subroutine run_test_for_size

  subroutine check_derivatives_numerically(n, uplo, nsize, lda_val, x_orig, a_orig, alpha_orig, y_orig, x_d_orig, a_d_orig, alpha_d_orig, y_d_orig, a_d, passed)
    implicit none
    integer, intent(in) :: n
