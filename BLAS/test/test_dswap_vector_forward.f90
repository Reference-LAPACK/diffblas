! Test program for DSWAP vector forward mode differentiation
! Generated automatically by run_tapenade_blas.py
! Using REAL*8 precision with nbdirs=4

program test_dswap_vector_forward
  implicit none
  ...
  test_sizes = (/ 4 /)
  write(*,*) 'Testing DSWAP (Vector Forward, multi-size: n = 4)'
  all_passed = .true.
  do itest = 1, 1
    n = test_sizes(itest)
    write(*,*) 'Testing DSWAP (Vector Forward, n =', n, ')'
...
contains
  ...
  subroutine run_test_for_size(n, passed)
    ...
    write(*,*) 'Testing DSWAP (Vector Forward Mode)'
    ...
    call dswap_dv(nsize, dx, dx_dv, incx_val, dy, dy_dv, incy_val, nbdirs)
...
end program test_dswap_vector_forward