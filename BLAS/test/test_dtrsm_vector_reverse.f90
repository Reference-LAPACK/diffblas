! Test program for DTRSM vector reverse mode differentiation
...
program test_dtrsm_vector_reverse
  ...
  real(8), dimension(nbdirs,max_size,max_size) :: bb_orig
  ...
  test_sizes = (/ 4 /)
  write(*,*) 'Testing DTRSM (Vector Reverse, multi-size: n = 4)'
  all_passed = .true.
  do itest = 1, 1
    n = test_sizes(itest)
