! Test program for STRSV reverse mode (adjoint) differentiation
...
program test_strsv_reverse
  ...
  test_sizes = (/ 4 /)
  write(*,*) 'Testing STRSV (multi-size: n = 4)'
  all_passed = .true.
  do i = 1, 1
    n_test = test_sizes(i)
...
contains
  ...
  subroutine run_test_for_size(n, passed)
    ...
    write(*,*) 'Testing STRSV (n =', n, ')'

    call set_ISIZE2OFA(n)

    call strsv_b(uplo, trans, diag, nsize, a, ab, lda_val, x, xb, incx_val)
