! Test program for SSBMV vector reverse mode differentiation
...
program test_ssbmv_vector_reverse
  ...
  real(4), dimension(nbdirsmax,max_size,n) :: ab  ! Band storage
  ...
  call ssbmv_bv(uplo, nsize, ksize, alpha, alphab, a, ab, lda_val, x, xb, incx_val, beta, betab, y, yb, incy_val, nbdirsmax)
