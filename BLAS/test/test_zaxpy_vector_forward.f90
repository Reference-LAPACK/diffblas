! Test program for ZAXPY vector forward mode differentiation
! Generated automatically by run_tapenade_blas.py
! Using REAL*8 precision with nbdirsmax=4

program test_zaxpy_vector_forward
  implicit none
  ...
  complex(8), dimension(nbdirsmax) :: za_dv
  complex(8), dimension(nbdirsmax,4) :: zx_dv
  complex(8), dimension(nbdirsmax,max_size) :: zy_dv
  ! Declare variables for storing original values
  complex(8) :: za_orig
  complex(8), dimension(nbdirsmax) :: za_dv_orig
  complex(8), dimension(4) :: zx_orig
  complex(8), dimension(nbdirsmax,4) :: zx_dv_orig
  complex(8), dimension(max_size) :: zy_orig
  complex(8), dimension(nbdirsmax,max_size) :: zy_dv_orig
  ...
  write(*,*) 'Testing ZAXPY (Vector Forward Mode)'
  ...
  call zaxpy_dv(nsize, za, za_dv, zx, zx_dv, incx_val, zy, zy_dv, incy_val, nbdirsmax)
...
end program test_zaxpy_vector_forward