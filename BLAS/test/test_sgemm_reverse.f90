! Test program for SGEMM reverse mode (adjoint) differentiation
! Generated automatically by run_tapenade_blas.py
! Using REAL*4 precision
! Multi-size test with outlined run_test_for_size(n) - arrays declared to size n

program test_sgemm_reverse
  implicit none
...
contains
  ...
  subroutine run_test_for_size(n, passed)
    ...
    real(4) :: alphab, betab
    real(4), dimension(n,n) :: ab, bb, cb
    real(4) :: alpha_orig, beta_orig
    real(4), dimension(n,n) :: a_orig, b_orig, c_orig, cb_orig
    integer :: i, j
    ...
    call sgemm_b(transa, transb, msize, nsize, ksize, alpha, alphab, a, ab, lda_val, b, bb, ldb_val, beta, betab, c, cb, ldc_val)
  ...
  subroutine check_vjp_numerically(n, transa, transb, msize, nsize, ksize, lda_val, ldb_val, ldc_val, alpha_orig, a_orig, b_orig, beta_orig, c_orig, cb_orig, alphab, ab, bb, betab, cb, passed)
    ...
    real(4), intent(in) :: a_orig(n,n), b_orig(n,n), c_orig(n,n), cb_orig(n,n)
    real(4), intent(in) :: alphab, betab
    real(4), intent(in) :: ab(n,n), bb(n,n), cb(n,n)
    logical, intent(out) :: passed
...
end program test_sgemm_reverse