! Test program for SSBMV vector forward mode differentiation
...
program test_ssbmv_vector_forward
  ...
  write(*,*) 'Testing SSBMV (Vector Forward Mode)'
  ...
  call ssbmv_dv(uplo, nsize, ksize, alpha, alpha_dv, a, a_dv, lda_val, x, x_dv, incx_val, beta, beta_dv, y, y_dv, incy_val, nbdirsmax)
