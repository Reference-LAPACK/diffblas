! Test program for STRMV vector forward mode differentiation
! Generated automatically by run_tapenade_blas.py
! Using REAL*4 precision with nbdirs=4

program test_strmv_vector_forward
  implicit none
  ...
  test_sizes = (/ 4 /)
  write(*,*) 'Testing STRMV (Vector Forward, multi-size: n = 4)'
  all_passed = .true.
  do itest = 1, 1
    n = test_sizes(itest)
    write(*,*) 'Testing STRMV (Vector Forward, n =', n, ')'
...
contains
  ...
  subroutine run_test_for_size(n, passed)
    ...
    write(*,*) 'Testing STRMV (Vector Forward Mode)'
    ...
    call strmv_dv(uplo, trans, diag, nsize, a, a_dv, lda_val, x, x_dv, incx_val, nbdirs)
...
end program test_strmv_vector_forward