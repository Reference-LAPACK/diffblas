! Test program for SSBMV differentiation
...
program test_ssbmv
  ...
  write(*,*) 'Testing SSBMV (multi-size: n = 1, 2, 3, 4)'
  do n_test = 1, 4
    n = n_test
    ...
    call ssbmv_d(uplo, nsize, ksize, alpha, alpha_d, a, a_d, lda_val, x, x_d, incx_val, beta, beta_d, y, y_d, incy_val)
