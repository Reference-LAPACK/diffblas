...
contains
  ...
  subroutine run_test_for_size(n, passed)
    ...
    call check_derivatives_numerically(n, nsize, dy_orig, dx_orig, dy_d_orig, dx_d_orig, dy_d, dx_d, passed)

  end subroutine run_test_for_size

  subroutine check_derivatives_numerically(n, nsize, dy_orig, dx_orig, dy_d_orig, dx_d_orig, dy_d, dx_d, passed)
    implicit none
    integer, intent(in) :: n
