...
contains
  ...
  subroutine run_test_for_size(n, passed)
    ...
    call dswap_d(nsize, dx, dx_d, 1, dy, dy_d, 1)

    write(*,*) 'Function calls completed successfully'

    ! Numerical differentiation check
    call check_derivatives_numerically(n, nsize, dx_orig, dy_orig, dx_d_orig, dy_d_orig, dx_d, dy_d, passed)

  end subroutine run_test_for_size

  subroutine check_derivatives_numerically(n, nsize, dx_orig, dy_orig, dx_d_orig, dy_d_orig, dx_d, dy_d, passed)
    implicit none
    integer, intent(in) :: n
