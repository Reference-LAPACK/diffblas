! Test program for DSYMV vector forward mode differentiation
! Generated automatically by run_tapenade_blas.py
! Using REAL*8 precision with nbdirs=4

program test_dsymv_vector_forward
  implicit none
  ...
  test_sizes = (/ 4 /)
  write(*,*) 'Testing DSYMV (Vector Forward, multi-size: n = 4)'
  all_passed = .true.
  do itest = 1, 1
    n = test_sizes(itest)
    write(*,*) 'Testing DSYMV (Vector Forward, n =', n, ')'
  ...
  write(*,*) 'Testing DSYMV (Vector Forward Mode)'
  ...
  call dsymv_dv(uplo, nsize, alpha, alpha_dv, a, a_dv, lda_val, x, x_dv, incx_val, beta, beta_dv, y, y_dv, incy_val, nbdirs)
...
end program test_dsymv_vector_forward