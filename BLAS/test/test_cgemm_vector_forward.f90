...
program test_cgemm_vector_forward
  ...
  write(*,*) 'Testing CGEMM (Vector Forward Mode)'
  ...
  call cgemm_dv(transa, transb, msize, nsize, ksize, alpha, alpha_dv, a, a_dv, lda_val, b, b_dv, ldb_val, beta, beta_dv, c, c_dv, ldc_val, nbdirsmax)
