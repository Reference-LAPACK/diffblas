...
contains
  ...
  subroutine run_test_for_size(n, passed)
    ...
    za = cmplx(temp_re * 2.0 - 1.0, temp_im * 2.0 - 1.0, kind=8)
    do i = 1, n
      call random_number(temp_re)
      call random_number(temp_im)
    ...
    call check_derivatives_numerically(n, nsize, zx_orig, zy_orig, za_orig, zx_d_orig, zy_d_orig, za_d_orig, zy_d, passed)

  end subroutine run_test_for_size

  subroutine check_derivatives_numerically(n, nsize, zx_orig, zy_orig, za_orig, zx_d_orig, zy_d_orig, za_d_orig, zy_d, passed)
    implicit none
    integer, intent(in) :: n
