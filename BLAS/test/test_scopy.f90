! Test program for SCOPY differentiation
...
contains
  ...
  subroutine run_test_for_size(n, passed)
    ...
    call check_derivatives_numerically(n, nsize, sx_orig, sy_orig, sx_d_orig, sy_d_orig, sy_d, passed)

  end subroutine run_test_for_size

  subroutine check_derivatives_numerically(n, nsize, sx_orig, sy_orig, sx_d_orig, sy_d_orig, sy_d, passed)
    implicit none
    integer, intent(in) :: n
