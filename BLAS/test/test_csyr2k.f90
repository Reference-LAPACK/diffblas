...
contains
  ...
  subroutine run_test_for_size(n, passed)
    ...
    call check_derivatives_numerically(n, trans, uplo, nsize, ksize, lda_val, ldb_val, ldc_val, a_orig, b_orig, alpha_orig, c_orig, beta_orig, a_d_orig, b_d_orig, alpha_d_orig, c_d_orig, beta_d_orig, c_d, passed)

  end subroutine run_test_for_size

  subroutine check_derivatives_numerically(n, trans, uplo, nsize, ksize, lda_val, ldb_val, ldc_val, a_orig, b_orig, alpha_orig, c_orig, beta_orig, a_d_orig, b_d_orig, alpha_d_orig, c_d_orig, beta_d_orig, c_d, passed)
    implicit none
    integer, intent(in) :: n
