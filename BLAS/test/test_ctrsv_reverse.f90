! Test program for CTRSV reverse mode (adjoint) differentiation
...
program test_ctrsv_reverse
  ...
  test_sizes = (/ 4 /)
  write(*,*) 'Testing CTRSV (multi-size: n = 4)'
  all_passed = .true.
  do i = 1, 1
    n_test = test_sizes(i)
...
contains
  ...
  subroutine run_test_for_size(n, passed)
    ...
    write(*,*) 'Testing CTRSV (n =', n, ')'

    call set_ISIZE2OFA(n)

    call ctrsv_b(uplo, trans, diag, nsize, a, ab, lda_val, x, xb, incx_val)
