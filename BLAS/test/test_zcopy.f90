...
contains
  ...
  subroutine run_test_for_size(n, passed)
    ...
    call check_derivatives_numerically(n, nsize, zx_orig, zy_orig, zx_d_orig, zy_d_orig, zy_d, passed)

  end subroutine run_test_for_size

  subroutine check_derivatives_numerically(n, nsize, zx_orig, zy_orig, zx_d_orig, zy_d_orig, zy_d, passed)
    implicit none
    integer, intent(in) :: n
