...
contains
  subroutine run_test_for_size(n, passed)
    ...
    real(4) :: alpha, alphab, beta, betab, alpha_orig, beta_orig
    real(4), dimension(n) :: x, xb, y, yb, y_orig, yb_orig
    real(4), dimension(:), allocatable :: ap, apb, ap_orig, x_orig
    ...
    call sspmv_b(uplo, nsize, alpha, alphab, ap, apb, x, xb, incx_val, beta, betab, y, yb, incy_val)
  ...
  subroutine check_vjp_spmv(n, npack, uplo, nsize, incx_val, incy_val, alpha_orig, alphab, ap_orig, apb, x_orig, xb, beta_orig, betab, y_orig, yb_seed, yb, passed)
    ...
    real(4), intent(in) :: ap_orig(npack), x_orig(n), y_orig(n)
    ...
    call sspmv(uplo, nsize, alpha_t, ap_t, x_t, incx_val, beta_t, y_t, incy_val)
