! Test program for SSYRK vector forward mode differentiation
...
program test_ssyrk_vector_forward
  ...
  write(*,*) 'Testing SSYRK (Vector Forward Mode)'
  ...
  call ssyrk_dv(uplo, trans, nsize, ksize, alpha, alpha_dv, a, a_dv, lda_val, beta, beta_dv, c, c_dv, ldc_val, nbdirs)
