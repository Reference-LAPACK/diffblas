! Test program for DSYR vector reverse mode differentiation
...
program test_dsyr_vector_reverse
  ...
  call dsyr_bv(uplo, nsize, alpha, alphab, x, xb, incx_val, a, ab, lda_val, nbdirsmax)
...
end program test_dsyr_vector_reverse