! Test program for SSYR differentiation
...
contains
  ...
  subroutine run_test_for_size(n, passed)
    ...
    call ssyr_d(uplo, nsize, alpha, alpha_d, x, x_d, 1, a, a_d, lda_val)
    x_d = x_d_orig
    ...
    call check_derivatives_numerically(n, uplo, nsize, lda_val, x_orig, a_orig, alpha_orig, x_d_orig, a_d_orig, alpha_d_orig, a_d, passed)

  end subroutine run_test_for_size

  subroutine check_derivatives_numerically(n, uplo, nsize, lda_val, x_orig, a_orig, alpha_orig, x_d_orig, a_d_orig, alpha_d_orig, a_d, passed)
    implicit none
    integer, intent(in) :: n
    ...
    call ssyr(uplo, nsize, alpha, x, 1, a, lda_val)
    a_forward = a
