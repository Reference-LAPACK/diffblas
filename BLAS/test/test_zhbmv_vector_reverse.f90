! Test program for ZHBMV vector reverse mode differentiation
...
program test_zhbmv_vector_reverse
  ...
  integer :: ksize
  complex(8) :: alpha
  complex(8), dimension(max_size,n) :: a  ! Band storage
  integer :: lda_val
  ...
  complex(8), dimension(nbdirsmax,max_size,n) :: ab  ! Band storage
  ...
  complex(8), dimension(nbdirsmax,max_size) :: yb_orig
  ...
  call zhbmv_bv(uplo, nsize, ksize, alpha, alphab, a, ab, lda_val, x, xb, incx_val, beta, betab, y, yb, incy_val, nbdirsmax)
...
contains
  ...
  subroutine check_vjp_numerically()
    ...
    complex(8) :: alpha_dir
    complex(8), dimension(max_size,n) :: a_dir
    complex(8), dimension(max_size) :: x_dir
    complex(8) :: beta_dir
    complex(8), dimension(max_size) :: y_dir
    complex(8), dimension(max_size) :: y_plus, y_minus, y_central_diff
