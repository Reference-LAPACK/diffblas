! Test program for DSCAL reverse mode (adjoint) differentiation
! Generated automatically by run_tapenade_blas.py
! Using REAL*8 precision
! Multi-size test with outlined run_test_for_size(n) - arrays declared to size n

program test_dscal_reverse
  implicit none
...
contains
  ...
  subroutine run_test_for_size(n, passed)
    ...
    call dscal_b(nsize, da, dab, dx, dxb, incx_val)

    call check_vjp_numerically(n, nsize, incx_val, da_orig, dx_orig, dxb_orig, dab, dxb, passed)

  end subroutine run_test_for_size

  subroutine check_vjp_numerically(n, nsize, incx_val, da_orig, dx_orig, dxb_orig, dab, dxb, passed)
    implicit none
    integer, intent(in) :: n
...
end program test_dscal_reverse