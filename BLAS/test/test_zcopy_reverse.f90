...
contains
  ...
  subroutine run_test_for_size(n, passed)
    ...
    call check_vjp_numerically(n, nsize, incx_val, incy_val, zx_orig, zy_orig, zyb_orig, zxb, zyb, passed)

  end subroutine run_test_for_size

  subroutine check_vjp_numerically(n, nsize, incx_val, incy_val, zx_orig, zy_orig, zyb_orig, zxb, zyb, passed)
    implicit none
    integer, intent(in) :: n
