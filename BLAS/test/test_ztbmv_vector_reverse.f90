! Test program for ZTBMV vector reverse mode differentiation
...
program test_ztbmv_vector_reverse
  ...
  complex(8), dimension(nbdirsmax,max_size) :: xb_orig
  ...
  call ztbmv_bv(uplo, trans, diag, nsize, ksize, a, ab, lda_val, x, xb, incx_val, nbdirsmax)
