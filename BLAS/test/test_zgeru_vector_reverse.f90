...
program test_zgeru_vector_reverse
  ...
  complex(8), dimension(nbdirs,max_size,max_size) :: ab_orig
  ...
  test_sizes = (/ 4 /)
  write(*,*) 'Testing ZGERU (Vector Reverse, multi-size: n = 4)'
  all_passed = .true.
  do itest = 1, 1
    n = test_sizes(itest)
    write(*,*) 'Testing ZGERU (Vector Reverse, n =', n, ')'
...
contains
  ...
  subroutine run_test_for_size(n, passed)
    ...
    call zgeru_bv(msize, nsize, alpha, alphab, x, xb, incx_val, y, yb, incy_val, a, ab, lda_val, nbdirs)
