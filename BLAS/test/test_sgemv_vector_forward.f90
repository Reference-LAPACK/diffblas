...
program test_sgemv_vector_forward
  ...
  write(*,*) 'Testing SGEMV (Vector Forward Mode)'
  ...
  call sgemv_dv(trans, msize, nsize, alpha, alpha_dv, a, a_dv, lda_val, x, x_dv, incx_val, beta, beta_dv, y, y_dv, incy_val, nbdirsmax)
