! Test program for SGBMV vector reverse mode differentiation
...
program test_sgbmv_vector_reverse
  ...
  call sgbmv_bv(trans, msize, nsize, kl, ku, alpha, alphab, a, ab, lda_val, x, xb, incx_val, beta, betab, y, yb, incy_val, nbdirsmax)
