! Test program for DSYRK vector reverse mode differentiation
...
program test_dsyrk_vector_reverse
  ...
  test_sizes = (/ 4 /)
  write(*,*) 'Testing DSYRK (Vector Reverse, multi-size: n = 4)'
  all_passed = .true.
  do itest = 1, 1
    n = test_sizes(itest)
...
contains
  ...
  subroutine run_test_for_size(n, passed)
    ...
    call dsyrk_bv(uplo, trans, nsize, ksize, alpha, alphab, a, ab, lda_val, beta, betab, c, cb, ldc_val, nbdirs)
