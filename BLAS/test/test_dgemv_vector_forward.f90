! Test program for DGEMV vector forward mode differentiation
! Generated automatically by run_tapenade_blas.py
! Using REAL*8 precision with nbdirs=4

program test_dgemv_vector_forward
  implicit none
  ...
  test_sizes = (/ 4 /)
  write(*,*) 'Testing DGEMV (Vector Forward, multi-size: n = 4)'
  all_passed = .true.
  do itest = 1, 1
    n = test_sizes(itest)
    write(*,*) 'Testing DGEMV (Vector Forward, n =', n, ')'
...
contains
  ...
  subroutine run_test_for_size(n, passed)
    ...
    write(*,*) 'Testing DGEMV (Vector Forward Mode)'
    ...
    call dgemv_dv(trans, msize, nsize, alpha, alpha_dv, a, a_dv, lda_val, x, x_dv, incx_val, beta, beta_dv, y, y_dv, incy_val, nbdirs)
  ...
  subroutine check_derivatives_numerically(passed)
    ...
    do idir = 1, nbdirs
      ...
      call dgemv(trans, msize, nsize, alpha, a, lda_val, x, incx_val, beta, y, incy_val)
      y_forward = y
...
end program test_dgemv_vector_forward