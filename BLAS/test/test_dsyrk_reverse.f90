! Test program for DSYRK reverse mode (adjoint) differentiation
...
program test_dsyrk_reverse
  ...
  test_sizes = (/ 4 /)
  write(*,*) 'Testing DSYRK (multi-size: n = 4)'
  all_passed = .true.
  do i = 1, 1
    n_test = test_sizes(i)
...
contains
  ...
  subroutine run_test_for_size(n, passed)
    ...
    call dsyrk_b(uplo, trans, nsize, ksize, alpha, alphab, a, ab, lda_val, beta, betab, c, cb, ldc_val)
