! Test program for ZHEMM differentiation
...
program test_zhemm
  ...
  complex(8) :: alpha_d
  complex(8), dimension(max_size,max_size) :: a_d
  complex(8), dimension(max_size,max_size) :: b_d
  complex(8) :: beta_d
  complex(8), dimension(max_size,max_size) :: c_d
  ...
  call zhemm_d(side, uplo, msize, nsize, alpha, alpha_d, a, a_d, lda_val, b, b_d, ldb_val, beta, beta_d, c, c_d, ldc_val)
