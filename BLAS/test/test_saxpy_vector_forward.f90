! Test program for SAXPY vector forward mode differentiation
! Generated automatically by run_tapenade_blas.py
! Using REAL*4 precision with nbdirs=4

program test_saxpy_vector_forward
  implicit none
  ...
  test_sizes = (/ 4 /)
  write(*,*) 'Testing SAXPY (Vector Forward, multi-size: n = 4)'
  all_passed = .true.
  do itest = 1, 1
    n = test_sizes(itest)
    write(*,*) 'Testing SAXPY (Vector Forward, n =', n, ')'
...
contains
  ...
  subroutine run_test_for_size(n, passed)
    ...
    write(*,*) 'Testing SAXPY (Vector Forward Mode)'
    ...
    call saxpy_dv(nsize, sa, sa_dv, sx, sx_dv, incx_val, sy, sy_dv, incy_val, nbdirs)
...
end program test_saxpy_vector_forward