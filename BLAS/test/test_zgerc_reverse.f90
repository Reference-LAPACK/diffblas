! Test program for ZGERC reverse mode (adjoint) differentiation
! Generated automatically by run_tapenade_blas.py
! Using REAL*8 precision
! Multi-size test with outlined run_test_for_size(n) - arrays declared to size n

program test_zgerc_reverse
  implicit none
...
contains
  ...
  subroutine run_test_for_size(n, passed)
    ...
    complex(8), dimension(n,n) :: ab_orig
    ...
    call zgerc_b(msize, nsize, alpha, alphab, x, xb, incx_val, y, yb, incy_val, a, ab, lda_val)
  ...
  subroutine check_vjp_numerically(n, msize, nsize, incx_val, incy_val, lda_val, alpha_orig, x_orig, y_orig, a_orig, ab_orig, alphab, xb, yb, ab, passed)
    ...
    complex(8), intent(in) :: ab_orig(n,n)
    ...
    complex(8), dimension(n,n) :: a_plus, a_minus, a_central_diff
...
end program test_zgerc_reverse