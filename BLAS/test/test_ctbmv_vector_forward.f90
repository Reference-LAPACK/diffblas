! Test program for CTBMV vector forward mode differentiation
...
program test_ctbmv_vector_forward
  ...
  test_sizes = (/ 4 /)
  write(*,*) 'Testing CTBMV (Vector Forward, multi-size: n = 4)'
  all_passed = .true.
  do itest = 1, 1
    n = test_sizes(itest)
    write(*,*) 'Testing CTBMV (Vector Forward, n =', n, ')'
  ...
  write(*,*) 'Testing CTBMV (Vector Forward Mode)'
