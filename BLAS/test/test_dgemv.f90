! Test program for DGEMV differentiation
...
program test_dgemv
  ...
  test_sizes = (/ 4, 10, 25 /)
  write(*,*) 'Testing DGEMV (multi-size: n = 4)'
  all_passed = .true.
  do i = 1, 3
    n_test = test_sizes(i)
...
contains
  ...
  subroutine run_test_for_size(n, passed)
    ...
    call dgemv_d(trans, msize, nsize, alpha, alpha_d, a, a_d, lda_val, x, x_d, 1, beta, beta_d, y, y_d, 1)
    x_d = x_d_orig
    beta_d = beta_d_orig
    a_d = a_d_orig
