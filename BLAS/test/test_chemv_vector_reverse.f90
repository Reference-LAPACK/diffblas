! Test program for CHEMV vector reverse mode differentiation
! Generated automatically by run_tapenade_blas.py
! Using REAL*4 precision with nbdirs=4

program test_chemv_vector_reverse
  implicit none
  ...
  test_sizes = (/ 4 /)
  write(*,*) 'Testing CHEMV (Vector Reverse, multi-size: n = 4)'
  all_passed = .true.
  do itest = 1, 1
    n = test_sizes(itest)
    write(*,*) 'Testing CHEMV (Vector Reverse, n =', n, ')'
...
contains
  ...
  subroutine run_test_for_size(n, passed)
    ...
    call chemv_bv(uplo, nsize, alpha, alphab, a, ab, lda_val, x, xb, incx_val, beta, betab, y, yb, incy_val, nbdirs)
...
end program test_chemv_vector_reverse