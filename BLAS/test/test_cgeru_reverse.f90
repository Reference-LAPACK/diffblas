...
program test_cgeru_reverse
  ...
  complex(4), dimension(max_size,max_size) :: a_plus, a_minus

  ! Saved cotangents (output adjoints) for VJP verification
  complex(4), dimension(max_size,max_size) :: ab_orig
  ...
  call cgeru_b(msize, nsize, alpha, alphab, x, xb, incx_val, y, yb, incy_val, a, ab, lda_val)
...
contains
  ...
  subroutine check_vjp_numerically()
    ...
    complex(4), dimension(max_size,max_size) :: a_central_diff
...
end program test_cgeru_reverse