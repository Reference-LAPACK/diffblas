...
program test_zscal_vector_reverse
  ...
  test_sizes = (/ 4 /)
  write(*,*) 'Testing ZSCAL (Vector Reverse, multi-size: n =', test_sizes(1), ')'
  all_passed = .true.
  do i = 1, 1
    n_test = test_sizes(i)
    nbdirs = test_sizes(i)
...
contains
  ...
  subroutine run_test_for_size(n, passed, nbdirs)
    ...
    call zscal_bv(nsize, alpha, alphab, x, xb, incx_val, nbdirs)
...
end program test_zscal_vector_reverse