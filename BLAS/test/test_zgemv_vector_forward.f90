! Test program for ZGEMV vector forward mode differentiation
! Generated automatically by run_tapenade_blas.py
! Using REAL*8 precision with nbdirs=4

program test_zgemv_vector_forward
  implicit none
  ...
  test_sizes = (/ 4 /)
  write(*,*) 'Testing ZGEMV (Vector Forward, multi-size: n = 4)'
  all_passed = .true.
  do itest = 1, 1
    n = test_sizes(itest)
    write(*,*) 'Testing ZGEMV (Vector Forward, n =', n, ')'
  ...
  write(*,*) 'Testing ZGEMV (Vector Forward Mode)'
  ...
  call zgemv_dv(trans, msize, nsize, alpha, alpha_dv, a, a_dv, lda_val, x, x_dv, incx_val, beta, beta_dv, y, y_dv, incy_val, nbdirs)
...
end program test_zgemv_vector_forward