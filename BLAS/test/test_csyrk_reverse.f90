...
program test_csyrk_reverse
  ...
  call csyrk_b(uplo, trans, nsize, ksize, alpha, alphab, a, ab, lda_val, beta, betab, c, cb, ldc_val)
...
contains
  ...
  subroutine check_vjp_numerically()
    ...
    call csyrk(uplo, trans, nsize, ksize, alpha, a, lda_val, beta, c, ldc_val)
    c_plus = c
...
end program test_csyrk_reverse