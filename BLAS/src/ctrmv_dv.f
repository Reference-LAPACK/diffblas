...
C
C  Differentiation of ctrmv in forward (tangent) mode (with options multiDirectional):
...
C>
C  =====================================================================
      SUBROUTINE CTRMV_DV(uplo, trans, diag, n, a, ad, lda, x, xd, incx
     +                    , nbdirs)
      IMPLICIT NONE
     ...
     +                xd(nd, i)
              ...
              ELSE
                IF (nounit) THEN
                  temp0 = CONJG(a(j, j))
                  DO nd=1,nbdirs
                    tempd(nd) = temp0*tempd(nd) + temp*CONJG(ad(nd, j, j
     +                ))
                  ENDDO
                  temp = temp*temp0
                END IF
