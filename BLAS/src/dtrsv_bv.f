...
C
C  Differentiation of dtrsv in reverse (adjoint) mode (with options multiDirectional):
...
C
C  =====================================================================
C      SUBROUTINE DTRSV_BV(uplo, trans, diag, n, a, ab, lda, x, xb, incx
C     +                    , nbdirs)
C      IMPLICIT NONE
...
CC     .. Array Arguments ..
C      DOUBLE PRECISION a(lda, *), x(*)
C      DOUBLE PRECISION ab(nbdirsmax, lda, *), xb(nbdirsmax, *)
CC     ..
CC
CC  =====================================================================
CC     ..
...
C
      ...
      DOUBLE PRECISION X(*), XB(NBDIRSMAX,*)

      DOUBLE PRECISION BLOC(N), S(N), YB(N), AB_SLICE(LDA,LDA)
      CHARACTER TRANS_T
