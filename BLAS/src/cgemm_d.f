...
C
C  Differentiation of cgemm in forward (tangent) mode:
...
C>
C  =====================================================================
      SUBROUTINE CGEMM_D(transa, transb, m, n, k, alpha, alphad, a, ad, 
...
C
            DO j=1,n
              DO i=1,m
                ...
                DO l=1,k
                  temp0 = CONJG(a(l, i))
                  tempd = tempd + b(l, j)*CONJG(ad(l, i)) + temp0*bd(l, 
     +              j)
...
C
            DO j=1,n
              ...
              DO l=1,k
                temp0 = CONJG(b(j, l))
                tempd = temp0*alphad + alpha*CONJG(bd(j, l))
                temp = alpha*temp0
                DO i=1,m
                  cd(i, j) = cd(i, j) + a(i, l)*tempd + temp*ad(i, l)
                  c(i, j) = c(i, j) + temp*a(i, l)
            ...
            DO j=1,n
              DO i=1,m
                ...
                DO l=1,k
                  temp0 = CONJG(b(j, l))
                  temp1 = CONJG(a(l, i))
                  tempd = tempd + temp0*CONJG(ad(l, i)) + temp1*CONJG(bd
     +              (j, l))
...
C
            DO j=1,n
              DO i=1,m
                ...
                DO l=1,k
                  temp1 = CONJG(a(l, i))
                  tempd = tempd + b(j, l)*CONJG(ad(l, i)) + temp1*bd(j, 
     +              l)
...
C
          DO j=1,n
            DO i=1,m
              ...
              DO l=1,k
                temp1 = CONJG(b(j, l))
                tempd = tempd + temp1*ad(l, i) + a(l, i)*CONJG(bd(j, l))
