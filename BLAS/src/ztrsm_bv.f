...
C     .. Array Arguments ..
      ...
      COMPLEX*16 ab(nbdirs, lda, *), bb(nbdirs, ldb, *)
      EXTERNAL LSAME
C     ..
C
C  =====================================================================
...
C     .. Parameters ..
      ...
      INTEGER max2
      INTEGER nd
      COMPLEX*16 tempb0(nbdirs)
      COMPLEX*16 tmp
      COMPLEX*16 tmpb(nbdirs)
      COMPLEX*16 tmp0
      COMPLEX*16 tmpb0(nbdirs)
      DOUBLE COMPLEX temp0
      COMPLEX*16 tmp1
      COMPLEX*16 tmpb1(nbdirs)
      COMPLEX*16 tmp2
      COMPLEX*16 tmpb2(nbdirs)
      COMPLEX*16 tmp3
      COMPLEX*16 tmpb3(nbdirs)
      COMPLEX*16 tmp4
      COMPLEX*16 tmpb4(nbdirs)
      INTEGER ad_to
      INTEGER*4 branch
      INTEGER ad_from
      INTEGER ad_to0
