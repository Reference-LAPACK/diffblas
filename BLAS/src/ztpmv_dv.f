...
C
C  Differentiation of ztpmv in forward (tangent) mode (with options multiDirectional):
...
C>
C  =====================================================================
      SUBROUTINE ZTPMV_DV(uplo, trans, diag, n, ap, apd, x, xd, incx, 
     +                    nbdirs)
      IMPLICIT NONE
...
C     .. Array Arguments ..
      COMPLEX*16 ap(*), x(*)
      COMPLEX*16 apd(nbdirsmax, *), xd(nbdirsmax, *)
C     ..
C
C  =====================================================================
C
...
C
     ...
     +                nd, i)
              ...
              ELSE
                IF (nounit) THEN
                  temp0 = DCONJG(ap(kk))
                  DO nd=1,nbdirs
                    tempd(nd) = temp0*tempd(nd) + temp*DCONJG(apd(nd, kk
     +                ))
                  ENDDO
                  temp = temp*temp0
                END IF
                DO i=j-1,1,-1
                  temp0 = DCONJG(ap(k))
                  DO nd=1,nbdirs
                    tempd(nd) = tempd(nd) + x(i)*DCONJG(apd(nd, k)) + 
     +                temp0*xd(nd, i)
                  ENDDO
                  temp = temp + temp0*x(i)
                  k = k - 1
     ...
     +                ))
                ...
                DO k=kk-1,kk-j+1,-1
                  ...
                  temp0 = DCONJG(ap(k))
                  DO nd=1,nbdirs
                    tempd(nd) = tempd(nd) + x(ix)*DCONJG(apd(nd, k)) + 
     +                temp0*xd(nd, ix)
                  ENDDO
