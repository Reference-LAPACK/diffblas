...
C
C  Differentiation of zgbmv in reverse (adjoint) mode:
...
C>
C  =====================================================================
      SUBROUTINE ZGBMV_B(trans, m, n, kl, ku, alpha, alphab, a, ab, lda
                ...
                DO j=n,1,-1
                  ...
                  ELSE
                    ...
                    DO i=ad_to2,ad_from2,-1
                      ab(k+i, j) = ab(k+i, j) + DCONJG(CONJG(x(i))*tempb
     +                  )
                      xb(i) = xb(i) + CONJG(DCONJG(a(k+i, j)))*tempb
                    ENDDO
                  END IF
                ...
                DO j=n,1,-1
                  ...
                  ELSE
                    ...
                    DO i=ad_to4,ad_from4,-1
                      CALL POPINTEGER4(ix)
                      ab(k+i, j) = ab(k+i, j) + DCONJG(CONJG(x(ix))*
     +                  tempb)
                      xb(ix) = xb(ix) + CONJG(DCONJG(a(k+i, j)))*tempb
                    ENDDO
                  END IF
                  CALL POPCOMPLEX16(temp)
                ENDDO
