...
C
C  Differentiation of chbmv in reverse (adjoint) mode:
...
C>
C  =====================================================================
      SUBROUTINE CHBMV_B(uplo, n, k, alpha, alphab, a, ab, lda, x, xb, 
            ...
            IF (incx .EQ. 1 .AND. incy .EQ. 1) THEN
              ...
              DO j=n,1,-1
                ...
                DO i=ad_to,ad_from,-1
                  ab(l+i, j) = ab(l+i, j) + CONJG(CONJG(x(i))*temp2b) + 
     +              CONJG(temp1)*yb(i)
                  xb(i) = xb(i) + CONJG(CONJG(a(l+i, j)))*temp2b
            ...
            ELSE
              ...
              DO j=n,1,-1
                ...
                DO i=ad_to0,ad_from0,-1
                  CALL POPINTEGER4(iy)
                  CALL POPINTEGER4(ix)
                  ab(l+i, j) = ab(l+i, j) + CONJG(CONJG(x(ix))*temp2b) +
     +              CONJG(temp1)*yb(iy)
                  xb(ix) = xb(ix) + CONJG(CONJG(a(l+i, j)))*temp2b
...
C
     ...
     +            CONJG(temp1)*yb(iy)
              ...
              CALL POPINTEGER4(iy)
              CALL POPINTEGER4(ix)
              temp1b = temp1b + REAL(a(1, j))*yb(jy)
