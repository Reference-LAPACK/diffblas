...
C
C  Differentiation of dsbmv in reverse (adjoint) mode (with options multiDirectional):
...
C  ===========
C
C       SUBROUTINE DSBMV(UPLO,N,K,ALPHA,A,LDA,X,INCX,BETA,Y,INCY)
C
C       .. Scalar Arguments ..
...
C>
C  =====================================================================
      SUBROUTINE DSBMV_BV(uplo, n, k, alpha, alphab, a, ab, lda, x, xb, 
