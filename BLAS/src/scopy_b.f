...
C
C  Differentiation of scopy in reverse (adjoint) mode:
...
C>
C  =====================================================================
      SUBROUTINE SCOPY_B(n, sx, sxb, incx, sy, syb, incy)
      IMPLICIT NONE
...
C
        ...
        DO i=n-MOD(n-mp1, 7),mp1,-7
          sxb(i+6) = sxb(i+6) + syb(i+6)
          syb(i+6) = 0.0
          sxb(i+5) = sxb(i+5) + syb(i+5)
          syb(i+5) = 0.0
          sxb(i+4) = sxb(i+4) + syb(i+4)
          syb(i+4) = 0.0
          sxb(i+3) = sxb(i+3) + syb(i+3)
          syb(i+3) = 0.0
          sxb(i+2) = sxb(i+2) + syb(i+2)
          syb(i+2) = 0.0
          sxb(i+1) = sxb(i+1) + syb(i+1)
          syb(i+1) = 0.0
          sxb(i) = sxb(i) + syb(i)
          syb(i) = 0.0
        ENDDO
