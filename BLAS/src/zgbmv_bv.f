...
C
C  Differentiation of zgbmv in reverse (adjoint) mode (with options multiDirectional):
...
C>
C  =====================================================================
      SUBROUTINE ZGBMV_BV(trans, m, n, kl, ku, alpha, alphab, a, ab, lda
     ...
     +                    nd)
                  ...
                  ELSE
                    ...
                    DO i=ad_to2,ad_from2,-1
                      DO nd=1,nbdirs
                        ab(nd, k+i, j) = ab(nd, k+i, j) + DCONJG(CONJG(x
     +                    (i))*tempb(nd))
                        xb(nd, i) = xb(nd, i) + CONJG(DCONJG(a(k+i, j)))
     +                    *tempb(nd)
                      ENDDO
                    ENDDO
                  END IF
                  ...
                  ELSE
                    ...
                    DO i=ad_to4,ad_from4,-1
                      ...
                      DO nd=1,nbdirs
                        ab(nd, k+i, j) = ab(nd, k+i, j) + DCONJG(CONJG(x
     +                    (ix))*tempb(nd))
                        xb(nd, ix) = xb(nd, ix) + CONJG(DCONJG(a(k+i, j)
     +                    ))*tempb(nd)
                      ENDDO
                    ENDDO
                  END IF
