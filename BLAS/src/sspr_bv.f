...
C
C  Differentiation of sspr in reverse (adjoint) mode (with options multiDirectional):
...
C  ===========
C
C       SUBROUTINE SSPR(UPLO,N,ALPHA,X,INCX,AP)
C
C       .. Scalar Arguments ..
C       REAL ALPHA
C       INTEGER INCX,N
...
C>
C  =====================================================================
      SUBROUTINE SSPR_BV(uplo, n, alpha, alphab, x, xb, incx, ap, apb, 
     +                   nbdirs)
      IMPLICIT NONE
