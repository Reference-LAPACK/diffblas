...
C
C  Differentiation of dspr in reverse (adjoint) mode:
...
C>
C  =====================================================================
      SUBROUTINE DSPR_B(uplo, n, alpha, alphab, x, xb, incx, ap, apb)
      IMPLICIT NONE
            ...
            IF (incx .EQ. 1) THEN
              ...
              DO j=n,1,-1
                ...
                IF (branch .EQ. 0) THEN
                  ...
                  DO i=ad_to,1,-1
                    CALL POPINTEGER4(k)
                    xb(i) = xb(i) + temp*apb(k)
                    tempb = tempb + x(i)*apb(k)
                  ENDDO
                  CALL POPREAL8(temp)
              ...
              DO j=n,1,-1
                ...
                IF (branch .EQ. 0) THEN
                  ...
                  DO k=ad_to0,ad_from,-1
                    CALL POPINTEGER4(ix)
                    xb(ix) = xb(ix) + temp*apb(k)
                    tempb = tempb + x(ix)*apb(k)
                  ENDDO
                  CALL POPREAL8(temp)
