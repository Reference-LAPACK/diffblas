...
C
C  Differentiation of zhemv in reverse (adjoint) mode (with options multiDirectional):
...
C>
C  =====================================================================
      SUBROUTINE ZHEMV_BV(uplo, n, alpha, alphab, a, ab, lda, x, xb, 
...
C     .. Scalar Arguments ..
      ...
      COMPLEX*16 alphab(nbdirs), betab(nbdirs)
      INTEGER incx, incy, lda, n
      CHARACTER uplo
C     ..
C     .. Array Arguments ..
      COMPLEX*16 a(lda, *), x(*), y(*)
      COMPLEX*16 ab(nbdirs, lda, *), xb(nbdirs, *), yb(nbdirs, 
     +           *)
C     ..
C
C  =====================================================================
...
C     .. Local Scalars ..
      ...
      COMPLEX*16 temp1b(nbdirs), temp2b(nbdirs)
...
C
            IF (incx .EQ. 1 .AND. incy .EQ. 1) THEN
              ...
              DO j=n,1,-1
                ...
                DO i=ad_to,1,-1
                  DO nd=1,nbdirs
                    ab(nd, i, j) = ab(nd, i, j) + DCONJG(CONJG(x(i))*
     +                temp2b(nd)) + CONJG(temp1)*yb(nd, i)
                    xb(nd, i) = xb(nd, i) + CONJG(DCONJG(a(i, j)))*
     +                temp2b(nd)
            ...
            ELSE
              ...
              DO j=n,1,-1
                ...
                DO i=ad_to0,1,-1
                  ...
                  CALL POPINTEGER4(ix)
                  DO nd=1,nbdirs
                    ab(nd, i, j) = ab(nd, i, j) + DCONJG(CONJG(x(ix))*
     +                temp2b(nd)) + CONJG(temp1)*yb(nd, iy)
                    xb(nd, ix) = xb(nd, ix) + CONJG(DCONJG(a(i, j)))*
     +                temp2b(nd)
...
C
            ...
            DO j=n,1,-1
              ...
              DO i=n,ad_from,-1
                DO nd=1,nbdirs
                  ab(nd, i, j) = ab(nd, i, j) + DCONJG(CONJG(x(i))*
     +              temp2b(nd)) + CONJG(temp1)*yb(nd, i)
                  xb(nd, i) = xb(nd, i) + CONJG(DCONJG(a(i, j)))*temp2b(
     +              nd)
                  temp1b(nd) = temp1b(nd) + CONJG(a(i, j))*yb(nd, i)
                ENDDO
              ENDDO
              DO nd=1,nbdirs
                temp1b(nd) = temp1b(nd) + DBLE(a(j, j))*yb(nd, j)
                ab(nd, j, j) = ab(nd, j, j) + CONJG(temp1)*yb(nd, j)
                alphab(nd) = alphab(nd) + CONJG(x(j))*temp1b(nd)
                xb(nd, j) = xb(nd, j) + CONJG(alpha)*temp1b(nd)
              ENDDO
     ...
     +              temp2b(nd)
              ...
              CALL POPCOMPLEX16(temp2)
              DO nd=1,nbdirs
                temp1b(nd) = temp1b(nd) + DBLE(a(j, j))*yb(nd, jy)
                ab(nd, j, j) = ab(nd, j, j) + CONJG(temp1)*yb(nd, jy)
                alphab(nd) = alphab(nd) + CONJG(x(jx))*temp1b(nd)
                xb(nd, jx) = xb(nd, jx) + CONJG(alpha)*temp1b(nd)
              ENDDO
