...
C
C AD/BD store direction as the FASTEST-varying index (nbdirs, LDA/LDB, *),
...
C
      ...
      DOUBLE PRECISION ALPHAD(NBDIRS)
      DOUBLE PRECISION A(LDA,*), AD(NBDIRS,LDA,*)
      DOUBLE PRECISION B(LDB,*), BD(NBDIRS,LDB,*)
...
C     'N' not DIAG: unit A has a constant (unit) diagonal, so AD diag=0.
         CALL DTRMM(SIDE, UPLO, TRANSA, 'N', M, N, 1.0D0,
     +              AD_SLICE, LDA, T, M)
