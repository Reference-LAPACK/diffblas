...
C>
C  =====================================================================
      SUBROUTINE CTRSM_BV(side, uplo, transa, diag, m, n, alpha, alphab
...
C     .. Scalar Arguments ..
      COMPLEX alpha
      COMPLEX alphab(nbdirs)
      INTEGER lda, ldb, m, n
      CHARACTER diag, side, transa, uplo
C     ..
C     .. Array Arguments ..
      COMPLEX a(lda, *), b(ldb, *)
      COMPLEX ab(nbdirs, lda, *), bb(nbdirs, ldb, *)
      EXTERNAL LSAME
C     ..
C
C  =====================================================================
...
C     .. Parameters ..
      ...
      INTEGER nd
      COMPLEX temp0
      COMPLEX tempb0(nbdirs)
      COMPLEX tmp
      COMPLEX tmpb(nbdirs)
      COMPLEX tmp0
      COMPLEX tmpb0(nbdirs)
      COMPLEX tmp1
      COMPLEX tmpb1(nbdirs)
      COMPLEX tmp2
      COMPLEX tmpb2(nbdirs)
      COMPLEX tmp3
      COMPLEX tmpb3(nbdirs)
      COMPLEX tmp4
      COMPLEX tmpb4(nbdirs)
      INTEGER ad_to
      INTEGER*4 branch
      INTEGER ad_from
      INTEGER ad_to0
          ...
          DO k=1,n,1
            ...
            DO j=ad_to3,1,-1
              ...
              IF (branch .EQ. 0) THEN
                ...
                IF (branch .EQ. 0) THEN
                  CALL POPCOMPLEX8(temp)
                  DO nd=1,nbdirs
                    ab(nd, j, k) = ab(nd, j, k) + CONJG(tempb(nd))
                  ENDDO
                ELSE
                  CALL POPCOMPLEX8(temp)
                  DO nd=1,nbdirs
            ...
            IF (branch .NE. 0) THEN
              ...
              IF (branch .EQ. 0) THEN
                ...
                temp0 = CONJG(a(k, k))
                DO nd=1,nbdirs
                  ab(nd, k, k) = ab(nd, k, k) + CONJG(CONJG(-(one/temp0
     +              **2))*tempb(nd))
                ENDDO
              ELSE
                CALL POPCOMPLEX8(temp)
