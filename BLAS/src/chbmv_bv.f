...
C
C  Differentiation of chbmv in reverse (adjoint) mode (with options multiDirectional):
...
C  ===========
C
C       SUBROUTINE CHBMV(UPLO,N,K,ALPHA,A,LDA,X,INCX,BETA,Y,INCY)
C
C       .. Scalar Arguments ..
...
C>
C  =====================================================================
      SUBROUTINE CHBMV_BV(uplo, n, k, alpha, alphab, a, ab, lda, x, xb, 
...
C     .. Scalar Arguments ..
      COMPLEX alpha, beta
      COMPLEX alphab(nbdirs), betab(nbdirs)
      INTEGER incx, incy, k, lda, n
      CHARACTER uplo
C     ..
C     .. Array Arguments ..
      COMPLEX a(lda, *), x(*), y(*)
      COMPLEX ab(nbdirs, lda, *), xb(nbdirs, *), yb(nbdirs, *)
C     ..
C
C  =====================================================================
C
...
C     .. Local Scalars ..
      COMPLEX temp1, temp2
      COMPLEX temp1b(nbdirs), temp2b(nbdirs)
...
C
            ...
            IF (incx .EQ. 1 .AND. incy .EQ. 1) THEN
              ...
              DO j=n,1,-1
                ...
                l = kplus1 - j
                DO nd=1,nbdirs
                  temp1b(nd) = REAL(a(kplus1, j))*yb(nd, j)
     ...
     +              yb(nd, j)
                ...
                DO i=ad_to,ad_from,-1
                  DO nd=1,nbdirs
                    ab(nd, l+i, j) = ab(nd, l+i, j) + CONJG(CONJG(x(i))*
     +                temp2b(nd)) + CONJG(temp1)*yb(nd, i)
                    xb(nd, i) = xb(nd, i) + CONJG(CONJG(a(l+i, j)))*
     +                temp2b(nd)
            ...
            ELSE
              ...
              DO j=n,1,-1
                ...
                l = kplus1 - j
                DO nd=1,nbdirs
                  temp1b(nd) = REAL(a(kplus1, j))*yb(nd, jy)
                  ab(nd, kplus1, j) = ab(nd, kplus1, j) + CONJG(temp1)*
     +              yb(nd, jy)
                ...
                DO i=ad_to0,ad_from0,-1
                  ...
                  CALL POPINTEGER4(ix)
                  DO nd=1,nbdirs
                    ab(nd, l+i, j) = ab(nd, l+i, j) + CONJG(CONJG(x(ix))
     +                *temp2b(nd)) + CONJG(temp1)*yb(nd, iy)
                    xb(nd, ix) = xb(nd, ix) + CONJG(CONJG(a(l+i, j)))*
     +                temp2b(nd)
...
C
            ...
            DO j=n,1,-1
              ...
              DO i=ad_to1,ad_from1,-1
                DO nd=1,nbdirs
                  ab(nd, l+i, j) = ab(nd, l+i, j) + CONJG(CONJG(x(i))*
     +              temp2b(nd)) + CONJG(temp1)*yb(nd, i)
                  xb(nd, i) = xb(nd, i) + CONJG(CONJG(a(l+i, j)))*temp2b
     +              (nd)
                  temp1b(nd) = temp1b(nd) + CONJG(a(l+i, j))*yb(nd, i)
                ENDDO
              ENDDO
              DO nd=1,nbdirs
                temp1b(nd) = temp1b(nd) + REAL(a(1, j))*yb(nd, j)
     ...
     +              temp2b(nd)
              ...
              CALL POPCOMPLEX8(temp2)
              DO nd=1,nbdirs
                temp1b(nd) = temp1b(nd) + REAL(a(1, j))*yb(nd, jy)
