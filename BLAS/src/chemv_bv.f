...
C
C  Differentiation of chemv in reverse (adjoint) mode (with options multiDirectional):
...
C  ===========
C
C       SUBROUTINE CHEMV(UPLO,N,ALPHA,A,LDA,X,INCX,BETA,Y,INCY)
C
C       .. Scalar Arguments ..
...
C>
C  =====================================================================
      SUBROUTINE CHEMV_BV(uplo, n, alpha, alphab, a, ab, lda, x, xb, 
...
C
            IF (incx .EQ. 1 .AND. incy .EQ. 1) THEN
              ...
              DO j=n,1,-1
                temp1 = alpha*x(j)
                DO nd=1,nbdirs
                  temp1b(nd) = REAL(a(j, j))*yb(nd, j)
                  ab(nd, j, j) = ab(nd, j, j) + CONJG(temp1)*yb(nd, j)
     ...
     +                temp2b(nd)) + CONJG(temp1)*yb(nd, i)
                    xb(nd, i) = xb(nd, i) + CONJG(CONJG(a(i, j)))*temp2b
     +                (nd)
                    temp1b(nd) = temp1b(nd) + CONJG(a(i, j))*yb(nd, i)
                  ENDDO
                ENDDO
            ...
            ELSE
              ...
              DO j=n,1,-1
                ...
                temp1 = alpha*x(jx)
                DO nd=1,nbdirs
                  temp1b(nd) = REAL(a(j, j))*yb(nd, jy)
                  ab(nd, j, j) = ab(nd, j, j) + CONJG(temp1)*yb(nd, jy)
     ...
     +                temp2b(nd)
                    temp1b(nd) = temp1b(nd) + CONJG(a(i, j))*yb(nd, iy)
                  ENDDO
                ENDDO
                CALL POPCOMPLEX8(temp2)
                DO nd=1,nbdirs
...
C
            ...
            DO j=n,1,-1
              ...
              DO i=n,ad_from,-1
                DO nd=1,nbdirs
                  ab(nd, i, j) = ab(nd, i, j) + CONJG(CONJG(x(i))*temp2b
     +              (nd)) + CONJG(temp1)*yb(nd, i)
                  xb(nd, i) = xb(nd, i) + CONJG(CONJG(a(i, j)))*temp2b(
     +              nd)
                  temp1b(nd) = temp1b(nd) + CONJG(a(i, j))*yb(nd, i)
                ENDDO
              ENDDO
              DO nd=1,nbdirs
                temp1b(nd) = temp1b(nd) + REAL(a(j, j))*yb(nd, j)
                ab(nd, j, j) = ab(nd, j, j) + CONJG(temp1)*yb(nd, j)
                alphab(nd) = alphab(nd) + CONJG(x(j))*temp1b(nd)
                xb(nd, j) = xb(nd, j) + CONJG(alpha)*temp1b(nd)
              ENDDO
            ...
            DO j=n,1,-1
              ...
              DO i=n,ad_from0,-1
                DO nd=1,nbdirs
                  ab(nd, i, j) = ab(nd, i, j) + CONJG(CONJG(x(ix))*
     +              temp2b(nd)) + CONJG(temp1)*yb(nd, iy)
                  xb(nd, ix) = xb(nd, ix) + CONJG(CONJG(a(i, j)))*temp2b
     +              (nd)
                  temp1b(nd) = temp1b(nd) + CONJG(a(i, j))*yb(nd, iy)
                ENDDO
                CALL POPINTEGER4(iy)
              ...
              CALL POPCOMPLEX8(temp2)
              DO nd=1,nbdirs
                temp1b(nd) = temp1b(nd) + REAL(a(j, j))*yb(nd, jy)
                ab(nd, j, j) = ab(nd, j, j) + CONJG(temp1)*yb(nd, jy)
                alphab(nd) = alphab(nd) + CONJG(x(jx))*temp1b(nd)
                xb(nd, jx) = xb(nd, jx) + CONJG(alpha)*temp1b(nd)
              ENDDO
