...
C
C  Differentiation of ztbmv in forward (tangent) mode:
...
C>
C  =====================================================================
      SUBROUTINE ZTBMV_D(uplo, trans, diag, n, k, a, ad, lda, x, xd, 
     +                   incx)
      IMPLICIT NONE
C
            ...
            DO j=n,1,-1
              ...
              ELSE
                IF (nounit) THEN
                  ...
                  tempd = temp0*tempd + temp*DCONJG(ad(kplus1, j))
                  temp = temp*temp0
                END IF
                IF (1 .LT. j - k) THEN
                  max4 = j - k
                ...
                DO i=j-1,max4,-1
                  ...
                  tempd = tempd + x(i)*DCONJG(ad(l+i, j)) + temp0*xd(i)
                  temp = temp + temp0*x(i)
                ENDDO
              END IF
              xd(j) = tempd
          ...
          ELSE
            ...
            DO j=n,1,-1
              ...
              ELSE
                ...
                DO i=j-1,max6,-1
                  temp0 = DCONJG(a(l+i, j))
                  tempd = tempd + x(ix)*DCONJG(ad(l+i, j)) + temp0*xd(ix
     +              )
        ...
        ELSE IF (incx .EQ. 1) THEN
          DO j=1,n
            ...
            ELSE
              IF (nounit) THEN
                temp0 = DCONJG(a(1, j))
                tempd = temp0*tempd + temp*DCONJG(ad(1, j))
                temp = temp*temp0
              END IF
              IF (n .GT. j + k) THEN
                min4 = j + k
