...
!
!  Differentiation of snrm2 in reverse (adjoint) mode:
...
!>
!  =====================================================================
SUBROUTINE SNRM2_B(n, x, xb, incx, snrm2b)
  IMPLICIT NONE
  INTRINSIC KIND
...
!
    ...
    IF (sumsq .EQ. 0.0) THEN
      sumsqb = 0.0_4
    ELSE
      sumsqb = scl*snrm2b/(2.0*SQRT(sumsq))
    END IF
