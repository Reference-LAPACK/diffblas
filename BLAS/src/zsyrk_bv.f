...
C
C  Differentiation of zsyrk in reverse (adjoint) mode (with options multiDirectional):
...
C>
C  =====================================================================
      SUBROUTINE ZSYRK_BV(uplo, trans, n, k, alpha, alphab, a, ab, lda, 
...
C     .. Array Arguments ..
      ...
      COMPLEX*16 ab(nbdirs, lda, *), cb(nbdirs, ldc, *)
      EXTERNAL LSAME
C     ..
C
C  =====================================================================
