...
C
C  Differentiation of sspmv in reverse (adjoint) mode (with options multiDirectional):
...
C>
C  =====================================================================
      SUBROUTINE SSPMV_BV(uplo, n, alpha, alphab, ap, apb, x, xb, incx, 
...
C     .. Scalar Arguments ..
      REAL alpha, beta
      REAL alphab(nbdirs), betab(nbdirs)
      INTEGER incx, incy, n
      CHARACTER uplo
C     ..
C     .. Array Arguments ..
      REAL ap(*), x(*), y(*)
      REAL apb(nbdirs, *), xb(nbdirs, *), yb(nbdirs, *)
C     ..
C
C  =====================================================================
C
...
C     .. Local Scalars ..
      REAL temp1, temp2
      REAL temp1b(nbdirs), temp2b(nbdirs)
