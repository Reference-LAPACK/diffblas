...
C
C  Differentiation of dsyr2 in forward (tangent) mode (with options multiDirectional):
...
C>
C  =====================================================================
      SUBROUTINE DSYR2_DV(uplo, n, alpha, alphad, x, xd, incx, y, yd, 
     +                    incy, a, ad, lda, nbdirs)
      IMPLICIT NONE
          ...
          IF (incx .EQ. 1 .AND. incy .EQ. 1) THEN
            DO j=1,n
              IF (x(j) .NE. zero .OR. y(j) .NE. zero) THEN
                ...
                DO i=1,j
                  DO nd=1,nbdirs
                    ad(nd, i, j) = ad(nd, i, j) + temp1*xd(nd, i) + x(i)
          ...
          ELSE
            DO j=1,n
              IF (x(jx) .NE. zero .OR. y(jy) .NE. zero) THEN
                ...
                DO i=1,j
                  DO nd=1,nbdirs
                    ad(nd, i, j) = ad(nd, i, j) + temp1*xd(nd, ix) + x(
     +                ix)*temp1d(nd) + temp2*yd(nd, iy) + y(iy)*temp2d(
     +                nd)
                  ENDDO
        ...
        ELSE
          DO j=1,n
            IF (x(jx) .NE. zero .OR. y(jy) .NE. zero) THEN
              ...
              DO i=j,n
                DO nd=1,nbdirs
                  ad(nd, i, j) = ad(nd, i, j) + temp1*xd(nd, ix) + x(ix)
