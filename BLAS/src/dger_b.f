...
C
C  Differentiation of dger in reverse (adjoint) mode:
...
C>
C  =====================================================================
      SUBROUTINE DGER_B(m, n, alpha, alphab, x, xb, incx, y, yb, incy, a
     +                  , ab, lda)
      IMPLICIT NONE
          ...
          IF (incx .EQ. 1) THEN
            ...
            DO j=n,1,-1
              ...
              IF (branch .EQ. 0) THEN
                ...
                ENDDO
                CALL POPREAL8(temp)
                alphab = alphab + y(jy)*tempb
                yb(jy) = yb(jy) + alpha*tempb
              END IF
            ENDDO
          ELSE
            IF (incx .GT. 0) THEN
