...
C     .. Array Arguments ..
      ...
      DOUBLE PRECISION ab(nbdirs, lda, *), bb(nbdirs, ldb, *)
      EXTERNAL LSAME
C     ..
C
C  =====================================================================
...
C     .. Parameters ..
      ...
      DOUBLE PRECISION tmpb(nbdirs)
      DOUBLE PRECISION tmp0
      DOUBLE PRECISION tmpb0(nbdirs)
      DOUBLE PRECISION tmp1
      DOUBLE PRECISION tmpb1(nbdirs)
      DOUBLE PRECISION tmp2
      DOUBLE PRECISION tmpb2(nbdirs)
      DOUBLE PRECISION tmp3
      DOUBLE PRECISION tmpb3(nbdirs)
      DOUBLE PRECISION tmp4
      DOUBLE PRECISION tmpb4(nbdirs)
      INTEGER ad_to
      INTEGER*4 branch
      INTEGER ad_from
      INTEGER ad_to0
