...
C
C  Differentiation of sgemv in reverse (adjoint) mode (with options multiDirectional):
...
C>
C  =====================================================================
      SUBROUTINE SGEMV_BV(trans, m, n, alpha, alphab, a, ab, lda, x, xb
...
C
            ...
            IF (incy .EQ. 1) THEN
              ...
              DO j=n,1,-1
                ...
                DO i=m,1,-1
                  DO nd=1,nbdirs
                    tempb(nd) = tempb(nd) + a(i, j)*yb(nd, i)
                    ab(nd, i, j) = ab(nd, i, j) + temp*yb(nd, i)
                  ENDDO
                ENDDO
                DO nd=1,nbdirs
            ...
            ELSE
              ...
              DO j=n,1,-1
                ...
                DO i=m,1,-1
                  CALL POPINTEGER4(iy)
                  DO nd=1,nbdirs
                    tempb(nd) = tempb(nd) + a(i, j)*yb(nd, iy)
                    ab(nd, i, j) = ab(nd, i, j) + temp*yb(nd, iy)
                  ENDDO
                ENDDO
                DO nd=1,nbdirs
                  alphab(nd) = alphab(nd) + x(jx)*tempb(nd)
