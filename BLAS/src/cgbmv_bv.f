...
C
C  Differentiation of cgbmv in reverse (adjoint) mode (with options multiDirectional):
...
C  ===========
C
C       SUBROUTINE CGBMV(TRANS,M,N,KL,KU,ALPHA,A,LDA,X,INCX,BETA,Y,INCY)
C
C       .. Scalar Arguments ..
...
C>
C  =====================================================================
      SUBROUTINE CGBMV_BV(trans, m, n, kl, ku, alpha, alphab, a, ab, lda
              ...
              IF (incy .EQ. 1) THEN
                ...
                DO j=n,1,-1
                  ...
                  DO i=ad_to,ad_from,-1
                    DO nd=1,nbdirs
                      tempb(nd) = tempb(nd) + CONJG(a(k+i, j))*yb(nd, i)
                      ab(nd, k+i, j) = ab(nd, k+i, j) + CONJG(temp)*yb(
     +                  nd, i)
                    ENDDO
                  ENDDO
                  DO nd=1,nbdirs
              ...
              ELSE
                ...
                DO j=n,1,-1
                  ...
                  DO i=ad_to0,ad_from0,-1
                    CALL POPINTEGER4(iy)
                    DO nd=1,nbdirs
                      tempb(nd) = tempb(nd) + CONJG(a(k+i, j))*yb(nd, iy
     +                  )
                      ab(nd, k+i, j) = ab(nd, k+i, j) + CONJG(temp)*yb(
     +                  nd, iy)
                    ENDDO
                ...
                DO j=n,1,-1
                  ...
                  IF (branch .EQ. 0) THEN
                    ...
                    DO i=ad_to1,ad_from1,-1
                      DO nd=1,nbdirs
                        ab(nd, k+i, j) = ab(nd, k+i, j) + CONJG(x(i))*
     +                    tempb(nd)
                        xb(nd, i) = xb(nd, i) + CONJG(a(k+i, j))*tempb(
     +                    nd)
                      ENDDO
                    ENDDO
                  ELSE
                    ...
                    DO i=ad_to2,ad_from2,-1
                      DO nd=1,nbdirs
                        ab(nd, k+i, j) = ab(nd, k+i, j) + CONJG(CONJG(x(
     +                    i))*tempb(nd))
                        xb(nd, i) = xb(nd, i) + CONJG(CONJG(a(k+i, j)))*
     +                    tempb(nd)
                      ENDDO
                    ENDDO
                  END IF
                ...
                DO j=n,1,-1
                  ...
                  IF (branch .EQ. 0) THEN
                    ...
                    DO i=ad_to3,ad_from3,-1
                      CALL POPINTEGER4(ix)
                      DO nd=1,nbdirs
                        ab(nd, k+i, j) = ab(nd, k+i, j) + CONJG(x(ix))*
     +                    tempb(nd)
                        xb(nd, ix) = xb(nd, ix) + CONJG(a(k+i, j))*tempb
     +                    (nd)
                      ENDDO
                    ENDDO
                  ELSE
                    ...
                    DO i=ad_to4,ad_from4,-1
                      ...
                      DO nd=1,nbdirs
                        ab(nd, k+i, j) = ab(nd, k+i, j) + CONJG(CONJG(x(
     +                    ix))*tempb(nd))
                        xb(nd, ix) = xb(nd, ix) + CONJG(CONJG(a(k+i, j))
     +                    )*tempb(nd)
                      ENDDO
                    ENDDO
                  END IF
