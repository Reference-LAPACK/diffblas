...
!
!  Differentiation of snrm2 in forward (tangent) mode (with options multiDirectional):
...
!>
!  =====================================================================
SUBROUTINE SNRM2_DV(n, x, xd, incx, snrm2, snrm2d, nbdirs)
  USE DIFFSIZES
!  Hint: nbdirsmax should be the maximum number of differentiation directions
  ...
  REAL(wp) :: snrm2
  REAL(wp), DIMENSION(nbdirsmax) :: snrm2d
!
...
!
    ...
    DO nd=1,nbdirs
      ...
      END IF
      snrm2d(nd) = scl*result1d(nd)
    END DO
    result1 = temp
    snrm2 = scl*result1
    RETURN
  END IF
END SUBROUTINE SNRM2_DV
