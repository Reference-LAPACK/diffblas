...
C
C  Differentiation of cgemm in reverse (adjoint) mode (with options multiDirectional):
...
C>
C  =====================================================================
      SUBROUTINE CGEMM_BV(transa, transb, m, n, k, alpha, alphab, a, ab
...
C
            ...
            DO j=n,1,-1
              DO i=m,1,-1
                ...
                DO l=k,1,-1
                  DO nd=1,nbdirs
                    ab(nd, l, i) = ab(nd, l, i) + CONJG(CONJG(b(l, j))*
     +                tempb(nd))
                    bb(nd, l, j) = bb(nd, l, j) + CONJG(CONJG(a(l, i)))*
     +                tempb(nd)
                  ENDDO
                ENDDO
...
C
     ...
     +                j)
                ...
                CALL POPCOMPLEX8(temp)
                DO nd=1,nbdirs
                  alphab(nd) = alphab(nd) + CONJG(CONJG(b(j, l)))*tempb(
     +              nd)
                  bb(nd, j, l) = bb(nd, j, l) + CONJG(CONJG(alpha)*tempb
     +              (nd))
                ENDDO
              ENDDO
              CALL POPCONTROL2B(branch)
...
C
            ...
            DO j=n,1,-1
              DO i=m,1,-1
                ...
                DO l=k,1,-1
                  DO nd=1,nbdirs
                    ab(nd, l, i) = ab(nd, l, i) + CONJG(CONJG(CONJG(b(j
     +                , l)))*tempb(nd))
                    bb(nd, j, l) = bb(nd, j, l) + CONJG(CONJG(CONJG(a(l
     +                , i)))*tempb(nd))
                  ENDDO
                ENDDO
                CALL POPCOMPLEX8(temp)
...
C
            ...
            DO j=n,1,-1
              DO i=m,1,-1
                ...
                DO l=k,1,-1
                  DO nd=1,nbdirs
                    ab(nd, l, i) = ab(nd, l, i) + CONJG(CONJG(b(j, l))*
     +                tempb(nd))
                    bb(nd, j, l) = bb(nd, j, l) + CONJG(CONJG(a(l, i)))*
     +                tempb(nd)
                  ENDDO
                ENDDO
                CALL POPCOMPLEX8(temp)
