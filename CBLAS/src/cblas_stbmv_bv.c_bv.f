...
C
C  Differentiation of stbmv in reverse (adjoint) mode (with options multiDirectional):
...
C  ===========
C
C       SUBROUTINE STBMV(UPLO,TRANS,DIAG,N,K,A,LDA,X,INCX)
C
C       .. Scalar Arguments ..
...
C>
C  =====================================================================
      SUBROUTINE STBMV_BV(uplo, trans, diag, n, k, a, ab, lda, x, xb, 
     +                    incx, nbdirs)
      IMPLICIT NONE
              ...
              IF (incx .EQ. 1) THEN
                ...
                DO 100 j=n,1,-1
                  ...
                  IF (branch .EQ. 0) THEN
                    CALL POPREAL4(x(j))
                    DO nd=1,nbdirs
                      ab(nd, kplus1, j) = ab(nd, kplus1, j) + x(j)*xb(nd
     +                  , j)
                      xb(nd, j) = a(kplus1, j)*xb(nd, j)
                    ENDDO
                  ...
                  DO i=ad_to,ad_from,-1
                    CALL POPREAL4(x(i))
                    DO nd=1,nbdirs
                      tempb(nd) = tempb(nd) + a(l+i, j)*xb(nd, i)
                      ab(nd, l+i, j) = ab(nd, l+i, j) + temp*xb(nd, i)
                    ENDDO
                  ENDDO
                  CALL POPREAL4(temp)
                  DO nd=1,nbdirs
              ...
              ELSE
                ...
                DO 110 j=n,1,-1
                  ...
                  IF (branch .EQ. 0) THEN
                    CALL POPREAL4(x(jx))
                    DO nd=1,nbdirs
                      ab(nd, kplus1, j) = ab(nd, kplus1, j) + x(jx)*xb(
     +                  nd, jx)
                      xb(nd, jx) = a(kplus1, j)*xb(nd, jx)
                    ENDDO
                  ELSE IF (branch .NE. 1) THEN
                    GOTO 110
                  END IF
                  ...
                  DO i=ad_to0,ad_from0,-1
                    ...
                    CALL POPREAL4(x(ix))
                    DO nd=1,nbdirs
                      tempb(nd) = tempb(nd) + a(l+i, j)*xb(nd, ix)
                      ab(nd, l+i, j) = ab(nd, l+i, j) + temp*xb(nd, ix)
                    ENDDO
                  ENDDO
                  CALL POPREAL4(temp)
                  DO nd=1,nbdirs
            ...
            ELSE IF (incx .EQ. 1) THEN
              ...
              DO 120 j=1,n,1
                ...
                IF (branch .EQ. 0) THEN
                  CALL POPREAL4(x(j))
                  DO nd=1,nbdirs
                    ab(nd, 1, j) = ab(nd, 1, j) + x(j)*xb(nd, j)
                    xb(nd, j) = a(1, j)*xb(nd, j)
                  ENDDO
                ELSE IF (branch .NE. 1) THEN
                  GOTO 120
                END IF
            ...
            ELSE
              ...
              DO 130 j=1,n,1
                ...
                IF (branch .EQ. 0) THEN
                  CALL POPREAL4(x(jx))
                  DO nd=1,nbdirs
                    ab(nd, 1, j) = ab(nd, 1, j) + x(jx)*xb(nd, jx)
                    xb(nd, jx) = a(1, j)*xb(nd, jx)
                  ENDDO
                ELSE IF (branch .NE. 1) THEN
                  GOTO 130
                END IF
            ...
            IF (incx .EQ. 1) THEN
              ...
              DO j=1,n,1
                ...
                DO i=ad_to3,ad_from3,1
                  DO nd=1,nbdirs
                    ab(nd, l+i, j) = ab(nd, l+i, j) + x(i)*tempb(nd)
                    xb(nd, i) = xb(nd, i) + a(l+i, j)*tempb(nd)
                  ENDDO
                ENDDO
                CALL POPCONTROL1B(branch)
                IF (branch .NE. 0) THEN
                  CALL POPREAL4(temp)
                  DO nd=1,nbdirs
                    ab(nd, kplus1, j) = ab(nd, kplus1, j) + temp*tempb(
     +                nd)
                    tempb(nd) = a(kplus1, j)*tempb(nd)
                  ENDDO
                END IF
                DO nd=1,nbdirs
                  xb(nd, j) = xb(nd, j) + tempb(nd)
            ...
            ELSE
              ...
              DO j=1,n,1
                ...
                DO i=ad_to4,ad_from4,1
                  CALL POPINTEGER4(ix)
                  DO nd=1,nbdirs
                    ab(nd, l+i, j) = ab(nd, l+i, j) + x(ix)*tempb(nd)
                    xb(nd, ix) = xb(nd, ix) + a(l+i, j)*tempb(nd)
                  ENDDO
                ENDDO
                CALL POPCONTROL1B(branch)
                IF (branch .NE. 0) THEN
          ...
          ELSE IF (incx .EQ. 1) THEN
            ...
            DO j=n,1,-1
              ...
              IF (branch .NE. 0) THEN
                CALL POPREAL4(temp)
                DO nd=1,nbdirs
                  ab(nd, 1, j) = ab(nd, 1, j) + temp*tempb(nd)
                  tempb(nd) = a(1, j)*tempb(nd)
                ENDDO
              END IF
              DO nd=1,nbdirs
                xb(nd, j) = xb(nd, j) + tempb(nd)
