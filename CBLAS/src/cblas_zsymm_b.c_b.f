...
C
C  Differentiation of zsymm in reverse (adjoint) mode:
...
C>
C  =====================================================================
      SUBROUTINE ZSYMM_B(side, uplo, m, n, alpha, alphab, a, ab, lda, b
          ...
          IF (upper) THEN
            ...
            DO j=n,1,-1
              DO i=m,1,-1
                ...
                DO k=ad_to,1,-1
                  bb(k, j) = bb(k, j) + CONJG(a(k, i))*temp2b
                  ab(k, i) = ab(k, i) + CONJG(b(k, j))*temp2b + CONJG(
     +              temp1)*cb(k, j)
...
C
          ...
          DO j=n,1,-1
            ...
            DO k=n,ad_from0,-1
              ...
              ELSE
                CALL POPCOMPLEX16(temp1)
                alphab = alphab + CONJG(a(j, k))*temp1b
                ab(j, k) = ab(j, k) + CONJG(alpha)*temp1b
              END IF
            ENDDO
            ...
            END IF
            CALL POPCOMPLEX16(temp1)
            alphab = alphab + CONJG(a(j, j))*temp1b
