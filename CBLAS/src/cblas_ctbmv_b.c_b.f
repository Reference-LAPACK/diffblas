...
C
C  Differentiation of ctbmv in reverse (adjoint) mode:
...
C  ===========
C
C       SUBROUTINE CTBMV(UPLO,TRANS,DIAG,N,K,A,LDA,X,INCX)
C
C       .. Scalar Arguments ..
...
C>
C  =====================================================================
      SUBROUTINE CTBMV_B(uplo, trans, diag, n, k, a, ab, lda, x, xb, 
     +                   incx)
      IMPLICIT NONE
              ...
              IF (incx .EQ. 1) THEN
                ...
                DO 100 j=n,1,-1
                  ...
                  IF (branch .EQ. 0) THEN
                    ...
                    ab(kplus1, j) = ab(kplus1, j) + CONJG(x(j))*xb(j)
                    xb(j) = CONJG(a(kplus1, j))*xb(j)
                  ...
                  DO i=ad_to,ad_from,-1
                    ...
                    tempb = tempb + CONJG(a(l+i, j))*xb(i)
                    ab(l+i, j) = ab(l+i, j) + CONJG(temp)*xb(i)
                  ENDDO
              ...
              ELSE
                ...
                DO 110 j=n,1,-1
                  ...
                  IF (branch .EQ. 0) THEN
                    ...
                    ab(kplus1, j) = ab(kplus1, j) + CONJG(x(jx))*xb(jx)
                    xb(jx) = CONJG(a(kplus1, j))*xb(jx)
                  ELSE IF (branch .NE. 1) THEN
                    GOTO 110
                  END IF
                  l = kplus1 - j
                  ...
                  DO i=ad_to0,ad_from0,-1
                    ...
                    tempb = tempb + CONJG(a(l+i, j))*xb(ix)
                    ab(l+i, j) = ab(l+i, j) + CONJG(temp)*xb(ix)
                  ENDDO
                  CALL POPCOMPLEX8(temp)
                  xb(jx) = xb(jx) + tempb
 110            CONTINUE
            ...
            ELSE IF (incx .EQ. 1) THEN
              ...
              DO 120 j=1,n,1
                ...
                IF (branch .EQ. 0) THEN
                  CALL POPCOMPLEX8(x(j))
                  ab(1, j) = ab(1, j) + CONJG(x(j))*xb(j)
                  xb(j) = CONJG(a(1, j))*xb(j)
                ELSE IF (branch .NE. 1) THEN
                  GOTO 120
                END IF
                l = 1 - j
 ...
 120          CONTINUE
            ELSE
              ...
              DO 130 j=1,n,1
                ...
                IF (branch .EQ. 0) THEN
                  CALL POPCOMPLEX8(x(jx))
                  ab(1, j) = ab(1, j) + CONJG(x(jx))*xb(jx)
                  xb(jx) = CONJG(a(1, j))*xb(jx)
                ELSE IF (branch .NE. 1) THEN
                  GOTO 130
                END IF
                l = 1 - j
              ...
              DO j=1,n,1
                ...
                IF (branch .EQ. 0) THEN
                  ...
                  DO i=ad_to3,ad_from3,1
                    ab(l+i, j) = ab(l+i, j) + CONJG(x(i))*tempb
                    xb(i) = xb(i) + CONJG(a(l+i, j))*tempb
                  ENDDO
                  CALL POPCONTROL1B(branch)
                  IF (branch .NE. 0) THEN
                    CALL POPCOMPLEX8(temp)
                    ab(kplus1, j) = ab(kplus1, j) + CONJG(temp)*tempb
                    tempb = CONJG(a(kplus1, j))*tempb
                  END IF
                ELSE
                  CALL POPINTEGER4(ad_from4)
                  CALL POPINTEGER4(ad_to4)
                  DO i=ad_to4,ad_from4,1
                    ab(l+i, j) = ab(l+i, j) + CONJG(CONJG(x(i))*tempb)
                    xb(i) = xb(i) + CONJG(CONJG(a(l+i, j)))*tempb
                  ENDDO
                  CALL POPCONTROL1B(branch)
                  IF (branch .NE. 0) THEN
                    CALL POPCOMPLEX8(temp)
                    ab(kplus1, j) = ab(kplus1, j) + CONJG(CONJG(temp)*
     +                tempb)
                    tempb = CONJG(CONJG(a(kplus1, j)))*tempb
                  END IF
                END IF
                xb(j) = xb(j) + tempb
              ENDDO
              ...
              DO j=1,n,1
                ...
                IF (branch .EQ. 0) THEN
                  ...
                  DO i=ad_to5,ad_from5,1
                    CALL POPINTEGER4(ix)
                    ab(l+i, j) = ab(l+i, j) + CONJG(x(ix))*tempb
                    xb(ix) = xb(ix) + CONJG(a(l+i, j))*tempb
                  ENDDO
                  CALL POPCONTROL1B(branch)
                  IF (branch .NE. 0) THEN
                    CALL POPCOMPLEX8(temp)
                ...
                ELSE
                  ...
                  DO i=ad_to6,ad_from6,1
                    CALL POPINTEGER4(ix)
                    ab(l+i, j) = ab(l+i, j) + CONJG(CONJG(x(ix))*tempb)
                    xb(ix) = xb(ix) + CONJG(CONJG(a(l+i, j)))*tempb
                  ENDDO
                  CALL POPCONTROL1B(branch)
                  IF (branch .NE. 0) THEN
                    CALL POPCOMPLEX8(temp)
          ...
          ELSE IF (incx .EQ. 1) THEN
            ...
            DO j=n,1,-1
              ...
              IF (branch .EQ. 0) THEN
                ...
                IF (branch .NE. 0) THEN
                  CALL POPCOMPLEX8(temp)
                  ab(1, j) = ab(1, j) + CONJG(temp)*tempb
                  tempb = CONJG(a(1, j))*tempb
                END IF
              ELSE
                ...
                IF (branch .NE. 0) THEN
                  CALL POPCOMPLEX8(temp)
                  ab(1, j) = ab(1, j) + CONJG(CONJG(temp)*tempb)
                  tempb = CONJG(CONJG(a(1, j)))*tempb
                END IF
              END IF
              xb(j) = xb(j) + tempb
            ENDDO
