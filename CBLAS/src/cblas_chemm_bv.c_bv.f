...
C
C  Differentiation of chemm in reverse (adjoint) mode (with options multiDirectional):
...
C>
C  =====================================================================
      SUBROUTINE CHEMM_BV(side, uplo, m, n, alpha, alphab, a, ab, lda, b
            ...
            DO j=n,1,-1
              DO i=m,1,-1
                ...
                IF (branch .EQ. 0) THEN
                  ...
                  DO nd=1,nbdirs
                    temp1b(nd) = REAL(a(i, i))*cb(nd, i, j)
...
C
     ...
     +              )
              ...
              ELSE
                CALL POPCOMPLEX8(temp1)
                DO nd=1,nbdirs
                  alphab(nd) = alphab(nd) + CONJG(CONJG(a(j, k)))*temp1b
     +              (nd)
     ...
     +              )
            ...
            CALL POPCOMPLEX8(temp1)
            DO nd=1,nbdirs
              alphab(nd) = alphab(nd) + REAL(a(j, j))*temp1b(nd)
