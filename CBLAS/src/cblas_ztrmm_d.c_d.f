...
C
C  Differentiation of ztrmm in forward (tangent) mode:
...
C>
C  =====================================================================
      SUBROUTINE ZTRMM_D(side, uplo, transa, diag, m, n, alpha, alphad, 
     +                   a, ad, lda, b, bd, ldb)
      IMPLICIT NONE
C
            ...
            DO j=1,n
              DO i=m,1,-1
                ...
                ELSE
                  IF (nounit) THEN
                    temp0 = DCONJG(a(i, i))
                    tempd = temp0*tempd + temp*DCONJG(ad(i, i))
                    temp = temp*temp0
                  END IF
                  DO k=1,i-1
                    temp0 = DCONJG(a(k, i))
                    tempd = tempd + b(k, j)*DCONJG(ad(k, i)) + temp0*bd(
     +                k, j)
          ...
          DO k=1,n
            DO j=1,k-1
              IF (a(j, k) .NE. zero) THEN
                ...
                ELSE
                  temp0 = DCONJG(a(j, k))
                  tempd = temp0*alphad + alpha*DCONJG(ad(j, k))
                  temp = alpha*temp0
                END IF
                DO i=1,m
                  bd(i, j) = bd(i, j) + b(i, k)*tempd + temp*bd(i, k)
            ...
            IF (nounit) THEN
              ...
              ELSE
                temp0 = DCONJG(a(k, k))
                tempd = temp0*tempd + temp*DCONJG(ad(k, k))
                temp = temp*temp0
              END IF
            END IF
            IF (temp .NE. one) THEN
