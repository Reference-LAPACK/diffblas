...
C
C  Differentiation of ssymv in forward (tangent) mode (with options multiDirectional):
...
C
     ...
     +                ad(nd, i, j)
                    temp2d(nd) = temp2d(nd) + x(i)*ad(nd, i, j) + a(i, j
     +                )*xd(nd, i)
                  ENDDO
                  y(i) = y(i) + temp1*a(i, j)
                ...
                ENDDO
                DO nd=1,nbdirs
                  yd(nd, j) = yd(nd, j) + a(j, j)*temp1d(nd) + temp1*ad(
     +              nd, j, j) + temp2*alphad(nd) + alpha*temp2d(nd)
                ENDDO
     ...
     +                *ad(nd, i, j)
                    temp2d(nd) = temp2d(nd) + x(ix)*ad(nd, i, j) + a(i, 
     +                j)*xd(nd, ix)
                  ENDDO
                ...
                ENDDO
                DO nd=1,nbdirs
                  yd(nd, jy) = yd(nd, jy) + a(j, j)*temp1d(nd) + temp1*
...
C
            DO j=1,n
              ...
              DO nd=1,nbdirs
                temp1d(nd) = x(j)*alphad(nd) + alpha*xd(nd, j)
                yd(nd, j) = yd(nd, j) + a(j, j)*temp1d(nd) + temp1*ad(nd
     +            , j, j)
              ENDDO
              temp2 = zero
              y(j) = y(j) + temp1*a(j, j)
     ...
     +            nd)
          ...
          ELSE
            ...
            DO j=1,n
              ...
              DO nd=1,nbdirs
                temp1d(nd) = x(jx)*alphad(nd) + alpha*xd(nd, jx)
                yd(nd, jy) = yd(nd, jy) + a(j, j)*temp1d(nd) + temp1*ad(
     +            nd, j, j)
              ENDDO
              temp2 = zero
              ...
              DO i=j+1,n
                ...
                DO nd=1,nbdirs
                  yd(nd, iy) = yd(nd, iy) + a(i, j)*temp1d(nd) + temp1*
     +              ad(nd, i, j)
                  temp2d(nd) = temp2d(nd) + x(ix)*ad(nd, i, j) + a(i, j)
     +              *xd(nd, ix)
                ENDDO
                y(iy) = y(iy) + temp1*a(i, j)
                temp2 = temp2 + a(i, j)*x(ix)
