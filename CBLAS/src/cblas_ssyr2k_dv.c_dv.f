...
C
C  Differentiation of ssyr2k in forward (tangent) mode (with options multiDirectional):
...
C>
C  =====================================================================
      SUBROUTINE SSYR2K_DV(uplo, trans, n, k, alpha, alphad, a, ad, lda
...
C     FIXED: Removed zeroing of cd - should accumulate from input seed
              ...
              DO l=1,k
                IF (a(j, l) .NE. zero .OR. b(j, l) .NE. zero) THEN
                  DO nd=1,nbdirs
                    temp1d(nd) = b(j, l)*alphad(nd) + alpha*bd(nd, j, l)
                    temp2d(nd) = a(j, l)*alphad(nd) + alpha*ad(nd, j, l)
                  ENDDO
                  temp1 = alpha*b(j, l)
                  temp2 = alpha*a(j, l)
                  DO i=1,j
                    DO nd=1,nbdirs
                      cd(nd, i, j) = cd(nd, i, j) + temp1*ad(nd, i, l) +
     +                  a(i, l)*temp1d(nd) + temp2*bd(nd, i, l) + b(i, l
     +                  )*temp2d(nd)
                    ENDDO
...
C
          DO j=1,n
            DO i=1,j
              ...
              DO l=1,k
                DO nd=1,nbdirs
                  temp1d(nd) = temp1d(nd) + b(l, j)*ad(nd, l, i) + a(l, 
     +              i)*bd(nd, l, j)
                  temp2d(nd) = temp2d(nd) + a(l, j)*bd(nd, l, i) + b(l, 
     +              i)*ad(nd, l, j)
                ENDDO
              ...
              IF (beta .EQ. zero) THEN
                DO nd=1,nbdirs
                  cd(nd, i, j) = (temp1+temp2)*alphad(nd) + alpha*temp1d
     +              (nd) + alpha*temp2d(nd)
                ENDDO
              ...
              ELSE
                DO nd=1,nbdirs
                  cd(nd, i, j) = c(i, j)*betad(nd) + beta*cd(nd, i, j) +
     +              (temp1+temp2)*alphad(nd) + alpha*temp1d(nd) + alpha*
     +              temp2d(nd)
                ENDDO
