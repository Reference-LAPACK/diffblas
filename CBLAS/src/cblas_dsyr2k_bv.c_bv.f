...
C
C  Differentiation of dsyr2k in reverse (adjoint) mode (with options multiDirectional):
...
C  ===========
C
C       SUBROUTINE DSYR2K(UPLO,TRANS,N,K,ALPHA,A,LDA,B,LDB,BETA,C,LDC)
C
C       .. Scalar Arguments ..
...
C>
C  =====================================================================
      SUBROUTINE DSYR2K_BV(uplo, trans, n, k, alpha, alphab, a, ab, lda
