...
C
C  Differentiation of sspmv in forward (tangent) mode (with options multiDirectional):
...
C>
C  =====================================================================
      SUBROUTINE SSPMV_DV(uplo, n, alpha, alphad, ap, apd, x, xd, incx, 
...
C     .. Array Arguments ..
      REAL ap(*), x(*), y(*)
      REAL apd(nbdirsmax, *), xd(nbdirsmax, *), yd(nbdirsmax, *)
C     ..
C
C  =====================================================================
C
