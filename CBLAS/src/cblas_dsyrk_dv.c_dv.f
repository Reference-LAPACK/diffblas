...
C
C  Differentiation of dsyrk in forward (tangent) mode (with options multiDirectional):
...
C>
C  =====================================================================
      SUBROUTINE DSYRK_DV(uplo, trans, n, k, alpha, alphad, a, ad, lda, 
...
C     .. Array Arguments ..
      ...
      DOUBLE PRECISION ad(nbdirsmax, lda, *), cd(nbdirsmax, ldc, n)
      EXTERNAL LSAME
C     ..
C
C  =====================================================================
