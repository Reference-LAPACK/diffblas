...
C
C  Differentiation of ssyrk in forward (tangent) mode (with options multiDirectional):
...
C>
C  =====================================================================
      SUBROUTINE SSYRK_DV(uplo, trans, n, k, alpha, alphad, a, ad, lda, 
...
C     .. Array Arguments ..
      REAL a(lda, *), c(ldc, *)
      REAL ad(nbdirsmax, lda, *), cd(nbdirsmax, ldc, n)
      EXTERNAL LSAME
C     ..
C
C  =====================================================================
...
C     FIXED: Removed zeroing of cd - should accumulate from input seed
              ...
              DO l=1,k
                IF (a(j, l) .NE. zero) THEN
                  DO nd=1,nbdirs
                    tempd(nd) = a(j, l)*alphad(nd) + alpha*ad(nd, j, l)
                  ENDDO
                  temp = alpha*a(j, l)
                  DO i=1,j
                    DO nd=1,nbdirs
...
C
          DO j=1,n
            DO i=1,j
              ...
              DO l=1,k
                DO nd=1,nbdirs
                  tempd(nd) = tempd(nd) + a(l, j)*ad(nd, l, i) + a(l, i)
     +              *ad(nd, l, j)
                ENDDO
