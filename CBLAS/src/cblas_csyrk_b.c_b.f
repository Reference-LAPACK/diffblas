...
C
C  Differentiation of csyrk in reverse (adjoint) mode:
...
C>
C  =====================================================================
      SUBROUTINE CSYRK_B(uplo, trans, n, k, alpha, alphab, a, ab, lda, 
     +                   beta, betab, c, cb, ldc)
      IMPLICIT NONE
            ...
            DO j=n,1,-1
              DO l=k,1,-1
                ...
                IF (branch .EQ. 0) THEN
                  ...
                  alphab = alphab + CONJG(a(j, l))*tempb
                  ab(j, l) = ab(j, l) + CONJG(alpha)*tempb
                END IF
              ENDDO
...
C
          ...
          DO j=n,1,-1
            ...
            DO i=ad_to4,1,-1
              ...
              END IF
              DO l=k,1,-1
                ab(l, i) = ab(l, i) + CONJG(a(l, j))*tempb
                ab(l, j) = ab(l, j) + CONJG(a(l, i))*tempb
              ENDDO
              CALL POPCOMPLEX8(temp)
            ENDDO
          ENDDO
