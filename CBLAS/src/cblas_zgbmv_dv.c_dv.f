...
C
C  Differentiation of zgbmv in forward (tangent) mode (with options multiDirectional):
...
C>
C  =====================================================================
      SUBROUTINE ZGBMV_DV(trans, m, n, kl, ku, alpha, alphad, a, ad, lda
...
C
     ...
     +                  i, j)*xd(nd, i)
                ...
                ELSE
                  ...
                  END IF
                  DO i=max4,min4
                    temp0 = DCONJG(a(k+i, j))
                    DO nd=1,nbdirs
                      tempd(nd) = tempd(nd) + x(i)*DCONJG(ad(nd, k+i, j)
     +                  ) + temp0*xd(nd, i)
                    ENDDO
                    temp = temp + temp0*x(i)
                  ENDDO
     ...
     +                  +i, j)*xd(nd, ix)
                ...
                ELSE
                  ...
                  DO i=max6,min6
                    temp0 = DCONJG(a(k+i, j))
                    DO nd=1,nbdirs
                      tempd(nd) = tempd(nd) + x(ix)*DCONJG(ad(nd, k+i, j
     +                  )) + temp0*xd(nd, ix)
                    ENDDO
