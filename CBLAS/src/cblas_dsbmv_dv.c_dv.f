...
C
C  Differentiation of dsbmv in forward (tangent) mode (with options multiDirectional):
...
C       FIXED: Commented out WRITE statement to avoid linking issues
        info = 6
...
C
     ...
     +                *ad(nd, l+i, j)
                    temp2d(nd) = temp2d(nd) + x(i)*ad(nd, l+i, j) + a(l+
     +                i, j)*xd(nd, i)
                  ENDDO
                ...
                ENDDO
                DO nd=1,nbdirs
                  yd(nd, j) = yd(nd, j) + a(kplus1, j)*temp1d(nd) + 
     +              temp1*ad(nd, kplus1, j) + temp2*alphad(nd) + alpha*
     +              temp2d(nd)
                ENDDO
     ...
     +                temp1*ad(nd, l+i, j)
                    temp2d(nd) = temp2d(nd) + x(ix)*ad(nd, l+i, j) + a(l
     +                +i, j)*xd(nd, ix)
                  ENDDO
                ...
                ENDDO
                DO nd=1,nbdirs
                  yd(nd, jy) = yd(nd, jy) + a(kplus1, j)*temp1d(nd) + 
     +              temp1*ad(nd, kplus1, j) + temp2*alphad(nd) + alpha*
     +              temp2d(nd)
                ENDDO
...
C
            DO j=1,n
              ...
              DO nd=1,nbdirs
                temp1d(nd) = x(j)*alphad(nd) + alpha*xd(nd, j)
                yd(nd, j) = yd(nd, j) + a(1, j)*temp1d(nd) + temp1*ad(nd
     +            , 1, j)
              ENDDO
              temp2 = zero
              y(j) = y(j) + temp1*a(1, j)
              ...
              DO i=j+1,min1
                DO nd=1,nbdirs
                  yd(nd, i) = yd(nd, i) + a(l+i, j)*temp1d(nd) + temp1*
     +              ad(nd, l+i, j)
                  temp2d(nd) = temp2d(nd) + x(i)*ad(nd, l+i, j) + a(l+i
     +              , j)*xd(nd, i)
                ENDDO
                y(i) = y(i) + temp1*a(l+i, j)
                temp2 = temp2 + a(l+i, j)*x(i)
     ...
     +            nd)
          ...
          ELSE
            ...
            DO j=1,n
              ...
              DO nd=1,nbdirs
                temp1d(nd) = x(jx)*alphad(nd) + alpha*xd(nd, jx)
                yd(nd, jy) = yd(nd, jy) + a(1, j)*temp1d(nd) + temp1*ad(
     +            nd, 1, j)
              ENDDO
              temp2 = zero
     ...
     +              *ad(nd, l+i, j)
                  temp2d(nd) = temp2d(nd) + x(ix)*ad(nd, l+i, j) + a(l+i
     +              , j)*xd(nd, ix)
                ENDDO
                y(iy) = y(iy) + temp1*a(l+i, j)
                temp2 = temp2 + a(l+i, j)*x(ix)
