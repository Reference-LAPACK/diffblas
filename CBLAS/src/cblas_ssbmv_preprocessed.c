# 0 "/gpfs/fs1/home/snarayan/difflapack/lapack-3.12.0-gfortran/CBLAS/src/cblas_ssbmv.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/gpfs/fs1/home/snarayan/difflapack/lapack-3.12.0-gfortran/CBLAS/src/cblas_ssbmv.c"
# 9 "/gpfs/fs1/home/snarayan/difflapack/lapack-3.12.0-gfortran/CBLAS/src/cblas_ssbmv.c"
...
# 10 "/gpfs/fs1/home/snarayan/difflapack/lapack-3.12.0-gfortran/CBLAS/src/cblas_ssbmv.c" 2
...
# 11 "/gpfs/fs1/home/snarayan/difflapack/lapack-3.12.0-gfortran/CBLAS/src/cblas_ssbmv.c" 2
           ...
           const float beta, float *Y, const int32_t incY)
{
   ...
   if (layout == CblasColMajor)
   {
      ...
      ssbmv_(&UL, &F77_N, &F77_K, &alpha, A, &F77_lda, X, &F77_incX, &beta, Y, &F77_incY)
                                     ;
