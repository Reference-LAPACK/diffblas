...
C
C  Differentiation of csymm in reverse (adjoint) mode (with options multiDirectional):
...
C  ===========
C
C       SUBROUTINE CSYMM(SIDE,UPLO,M,N,ALPHA,A,LDA,B,LDB,BETA,C,LDC)
C
C       .. Scalar Arguments ..
...
C>
C  =====================================================================
      SUBROUTINE CSYMM_BV(side, uplo, m, n, alpha, alphab, a, ab, lda, b
