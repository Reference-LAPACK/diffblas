...
C
C  Differentiation of csyrk in forward (tangent) mode (with options multiDirectional):
...
C  ===========
C
C       SUBROUTINE CSYRK(UPLO,TRANS,N,K,ALPHA,A,LDA,BETA,C,LDC)
C
C       .. Scalar Arguments ..
...
C>
C  =====================================================================
      SUBROUTINE CSYRK_DV(uplo, trans, n, k, alpha, alphad, a, ad, lda, 
...
C     .. Array Arguments ..
      COMPLEX a(lda, *), c(ldc, *)
      COMPLEX ad(nbdirsmax, lda, *), cd(nbdirsmax, ldc, n)
      EXTERNAL LSAME
C     ..
C
C  =====================================================================
