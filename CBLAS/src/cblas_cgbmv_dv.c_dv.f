...
C
C  Differentiation of cgbmv in forward (tangent) mode (with options multiDirectional):
...
C>
C  =====================================================================
      SUBROUTINE CGBMV_DV(trans, m, n, kl, ku, alpha, alphad, a, ad, lda
            ...
            IF (incx .EQ. 1) THEN
              DO j=1,n
                ...
                IF (noconj) THEN
                  ...
                  DO i=max3,min3
                    DO nd=1,nbdirs
                      tempd(nd) = tempd(nd) + x(i)*ad(nd, k+i, j) + a(k+
     +                  i, j)*xd(nd, i)
                    ENDDO
                ...
                ELSE
                  ...
                  DO i=max4,min4
                    temp0 = CONJG(a(k+i, j))
                    DO nd=1,nbdirs
                      tempd(nd) = tempd(nd) + x(i)*CONJG(ad(nd, k+i, j))
     +                  + temp0*xd(nd, i)
                    ENDDO
                    temp = temp + temp0*x(i)
                  ENDDO
            ...
            ELSE
              DO j=1,n
                ...
                IF (noconj) THEN
                  ...
                  DO i=max5,min5
                    DO nd=1,nbdirs
                      tempd(nd) = tempd(nd) + x(ix)*ad(nd, k+i, j) + a(k
     +                  +i, j)*xd(nd, ix)
                    ENDDO
                ...
                ELSE
                  ...
                  DO i=max6,min6
                    temp0 = CONJG(a(k+i, j))
                    DO nd=1,nbdirs
                      tempd(nd) = tempd(nd) + x(ix)*CONJG(ad(nd, k+i, j)
     +                  ) + temp0*xd(nd, ix)
                    ENDDO
