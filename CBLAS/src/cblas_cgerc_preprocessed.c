# 0 "/gpfs/fs1/home/snarayan/difflapack/lapack-3.12.0-gfortran/CBLAS/src/cblas_cgerc.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/gpfs/fs1/home/snarayan/difflapack/lapack-3.12.0-gfortran/CBLAS/src/cblas_cgerc.c"
...
# 9 "/gpfs/fs1/home/snarayan/difflapack/lapack-3.12.0-gfortran/CBLAS/src/cblas_cgerc.c" 2
...
# 10 "/gpfs/fs1/home/snarayan/difflapack/lapack-3.12.0-gfortran/CBLAS/src/cblas_cgerc.c" 2
...
# 11 "/gpfs/fs1/home/snarayan/difflapack/lapack-3.12.0-gfortran/CBLAS/src/cblas_cgerc.c" 2
...
# 12 "/gpfs/fs1/home/snarayan/difflapack/lapack-3.12.0-gfortran/CBLAS/src/cblas_cgerc.c" 2
void cblas_cgerc(const CBLAS_LAYOUT layout, const int32_t M, const int32_t N,
                 const void *alpha, const void *X, const int32_t incX,
                 const void *Y, const int32_t incY, void *A, const int32_t lda)
{

   int32_t F77_M=M, F77_N=N, F77_lda=lda, F77_incX=incX, F77_incY=incY;
# 26 "/gpfs/fs1/home/snarayan/difflapack/lapack-3.12.0-gfortran/CBLAS/src/cblas_cgerc.c"
   int32_t n, i, tincy, incy=incY;
   ...
   {
      cgerc_(&F77_M, &F77_N, alpha, X, &F77_incX, Y, &F77_incY, A, &F77_lda)
                               ;
   } else if (layout == CblasRowMajor)
   {
      ...
      cgeru_(&F77_N, &F77_M, alpha, y, &F77_incY, X, &F77_incX, A, &F77_lda)
                               ;
      if(Y!=y)
         free(y);
