...
C  Differentiation of ddotsub in forward (tangent) mode:
...
C
      SUBROUTINE DDOTSUB_D(n, x, xd, incx, y, yd, incy, dot, dotd)
      IMPLICIT NONE
C
      EXTERNAL DDOT
      EXTERNAL DDOT_D
      DOUBLE PRECISION DDOT
      DOUBLE PRECISION DDOT_D
      INTEGER n, incx, incy
      DOUBLE PRECISION x(*), y(*), dot
      DOUBLE PRECISION xd(*), yd(*), dotd
C
      dotd = DDOT_D(n, x, xd, incx, y, yd, incy, dot)
      RETURN
      END
