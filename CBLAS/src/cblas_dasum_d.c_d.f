...
C  Differentiation of dasumsub in forward (tangent) mode:
...
C
      SUBROUTINE DASUMSUB_D(n, x, xd, incx, asum, asumd)
      IMPLICIT NONE
C
      EXTERNAL DASUM
      EXTERNAL DASUM_D
      DOUBLE PRECISION DASUM, asum
      DOUBLE PRECISION DASUM_D, asumd
      INTEGER n, incx
      DOUBLE PRECISION x(*)
      DOUBLE PRECISION xd(*)
C
      asumd = DASUM_D(n, x, xd, incx, asum)
      RETURN
      END
