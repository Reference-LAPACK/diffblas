...
/*
  Differentiation of cblas_cgerc in reverse (adjoint) mode:
...
*/
void cblas_cgerc_b(const CBLAS_LAYOUT layout, const __int32_t M, const 
    ...
    if (layout == CblasColMajor)
        F77_cgerc_b(&F77_M, &F77_N, alpha, alphab, X, Xb, &F77_incX, Y, Yb, &
