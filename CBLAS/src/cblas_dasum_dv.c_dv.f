...
C  Differentiation of dasumsub in forward (tangent) mode (with options multiDirectional):
C   variations   of useful results: asum
...
C
      SUBROUTINE DASUMSUB_DV(n, x, xd, incx, asum, asumd, nbdirs)
      IMPLICIT NONE
      INCLUDE 'DIFFSIZESF.inc'
C  Hint: nbdirsmax should be the maximum number of differentiation directions
C
      ...
      DOUBLE PRECISION asumd(nbdirsmax)
      INTEGER n, incx
      DOUBLE PRECISION x(*)
      DOUBLE PRECISION xd(nbdirsmax, *)
      INTEGER nbdirs
C
      CALL DASUM_DV(n, x, xd, incx, asum, asumd, nbdirs)
      RETURN
      END
