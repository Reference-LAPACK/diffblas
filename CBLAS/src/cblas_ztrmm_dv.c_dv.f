...
C
C  Differentiation of ztrmm in forward (tangent) mode (with options multiDirectional):
     ...
     +                  , i)*bd(nd, k, j)
                ...
                ELSE
                  IF (nounit) THEN
                    temp0 = DCONJG(a(i, i))
                    DO nd=1,nbdirs
                      tempd(nd) = temp0*tempd(nd) + temp*DCONJG(ad(nd, i
     +                  , i))
                    ENDDO
                    temp = temp*temp0
                  END IF
            ...
            DO j=1,k-1
              IF (a(j, k) .NE. zero) THEN
                ...
                ELSE
                  temp0 = DCONJG(a(j, k))
                  DO nd=1,nbdirs
                    tempd(nd) = temp0*alphad(nd) + alpha*DCONJG(ad(nd, j
     +                , k))
                  ENDDO
                  temp = alpha*temp0
                END IF
     ...
     +                temp*bd(nd, i, k)
            ...
            IF (nounit) THEN
              ...
              ELSE
                temp0 = DCONJG(a(k, k))
                DO nd=1,nbdirs
                  tempd(nd) = temp0*tempd(nd) + temp*DCONJG(ad(nd, k, k)
     +              )
                ENDDO
                temp = temp*temp0
              END IF
