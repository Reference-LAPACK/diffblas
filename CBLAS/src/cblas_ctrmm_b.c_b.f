...
C
C  Differentiation of ctrmm in reverse (adjoint) mode:
...
C>
C  =====================================================================
      SUBROUTINE CTRMM_B(side, uplo, transa, diag, m, n, alpha, alphab, 
     +                   a, ab, lda, b, bb, ldb)
      IMPLICIT NONE
            ...
            DO j=n,1,-1
              DO i=1,m,1
                ...
                ELSE
                  ...
                  IF (branch .NE. 0) THEN
                    CALL POPCOMPLEX8(temp)
                    ab(i, i) = ab(i, i) + CONJG(CONJG(temp)*tempb)
                    tempb = CONJG(CONJG(a(i, i)))*tempb
                  END IF
                END IF
                CALL POPCOMPLEX8(temp)
                bb(i, j) = bb(i, j) + tempb
...
C
          ...
          DO k=n,1,-1
            ...
            ELSE IF (branch .EQ. 1) THEN
              CALL POPCOMPLEX8(temp)
              ab(k, k) = ab(k, k) + CONJG(CONJG(temp)*tempb)
              tempb = CONJG(CONJG(a(k, k)))*tempb
            END IF
            CALL POPCOMPLEX8(temp)
            alphab = alphab + tempb
            ...
            DO j=ad_to3,1,-1
              ...
              IF (branch .EQ. 0) THEN
                ...
                IF (branch .EQ. 0) THEN
                  CALL POPCOMPLEX8(temp)
                  alphab = alphab + CONJG(CONJG(a(j, k)))*tempb
                  ab(j, k) = ab(j, k) + CONJG(CONJG(alpha)*tempb)
                ELSE
                  CALL POPCOMPLEX8(temp)
