...
C
C  Differentiation of zsyrk in forward (tangent) mode (with options multiDirectional):
...
C     .. Array Arguments ..
      ...
      COMPLEX*16 ad(nbdirsmax, lda, *), cd(nbdirsmax, ldc, n)
      EXTERNAL LSAME
C     ..
C
C  =====================================================================
