...
C
C  Differentiation of zhemm in reverse (adjoint) mode:
...
C>
C  =====================================================================
      SUBROUTINE ZHEMM_B(side, uplo, m, n, alpha, alphab, a, ab, lda, b
     ...
     +              temp2
            ...
            DO j=n,1,-1
              DO i=m,1,-1
                ...
                DO k=ad_to,1,-1
                  bb(k, j) = bb(k, j) + CONJG(DCONJG(a(k, i)))*temp2b
                  ab(k, i) = ab(k, i) + DCONJG(CONJG(b(k, j))*temp2b) + 
     +              CONJG(temp1)*cb(k, j)
...
C
          ...
          DO j=n,1,-1
            ...
            DO k=n,ad_from0,-1
              ...
              ELSE
                CALL POPCOMPLEX16(temp1)
                alphab = alphab + CONJG(DCONJG(a(j, k)))*temp1b
                ab(j, k) = ab(j, k) + DCONJG(CONJG(alpha)*temp1b)
              END IF
            ENDDO
            ...
            END IF
            CALL POPCOMPLEX16(temp1)
            alphab = alphab + DBLE(a(j, j))*temp1b
