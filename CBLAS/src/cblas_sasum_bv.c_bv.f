...
C   gradient     of useful results: sx sasum
...
C  Differentiation of sasumsub in reverse (adjoint) mode (with options multiDirectional):
...
C
      SUBROUTINE SASUMSUB_BV(n, x, xb, incx, asum, asumb, nbdirs)
      IMPLICIT NONE
      INCLUDE 'DIFFSIZESF.inc'
C  Hint: nbdirsmax should be the maximum number of differentiation directions
C
