...
C
C  Differentiation of dsyrk in reverse (adjoint) mode (with options multiDirectional):
...
C>
C  =====================================================================
      SUBROUTINE DSYRK_BV(uplo, trans, n, k, alpha, alphab, a, ab, lda, 
...
C     .. Array Arguments ..
      ...
      DOUBLE PRECISION ab(nbdirsmax, lda, *), cb(nbdirsmax, ldc, *)
      EXTERNAL LSAME
C     ..
C
C  =====================================================================
