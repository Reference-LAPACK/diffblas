...
C   gradient     of useful results: dx dy ddot
...
C  Differentiation of ddotsub in reverse (adjoint) mode (with options multiDirectional):
...
C
      SUBROUTINE DDOTSUB_BV(n, x, xb, incx, y, yb, incy, dot, dotb, 
     +                      nbdirs)
      IMPLICIT NONE
      INCLUDE 'DIFFSIZESF.inc'
C  Hint: nbdirsmax should be the maximum number of differentiation directions
