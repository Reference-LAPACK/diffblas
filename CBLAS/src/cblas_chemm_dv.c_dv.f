...
C
C  Differentiation of chemm in forward (tangent) mode (with options multiDirectional):
...
C>
C  =====================================================================
      SUBROUTINE CHEMM_DV(side, uplo, m, n, alpha, alphad, a, ad, lda, b
...
C
     ...
     +                )*CONJG(ad(nd, k, i))
                ...
                IF (beta .EQ. zero) THEN
                  temp0 = REAL(a(i, i))
                  DO nd=1,nbdirs
                    cd(nd, i, j) = temp0*temp1d(nd) + temp1*REAL(ad(nd, 
     +                i, i)) + temp2*alphad(nd) + alpha*temp2d(nd)
                ...
                ELSE
                  ...
                  DO nd=1,nbdirs
                    cd(nd, i, j) = c(i, j)*betad(nd) + beta*cd(nd, i, j)
     +                + temp0*temp1d(nd) + temp1*REAL(ad(nd, i, i)) + 
...
C
          DO j=1,n
            temp0 = REAL(a(j, j))
            DO nd=1,nbdirs
              temp1d(nd) = temp0*alphad(nd) + alpha*REAL(ad(nd, j, j))
            ENDDO
            temp1 = alpha*temp0
            IF (beta .EQ. zero) THEN
              DO i=1,m
     ...
     +              b(i, j)*temp1d(nd) + temp1*bd(nd, i, j)
            ...
            DO k=1,j-1
              ...
              ELSE
                temp = CONJG(a(j, k))
                DO nd=1,nbdirs
                  temp1d(nd) = temp*alphad(nd) + alpha*CONJG(ad(nd, j, k
     +              ))
                ENDDO
                temp1 = alpha*temp
              END IF
