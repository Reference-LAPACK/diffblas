...
C
C  Differentiation of zgbmv in forward (tangent) mode:
...
C>
C  =====================================================================
      SUBROUTINE ZGBMV_D(trans, m, n, kl, ku, alpha, alphad, a, ad, lda
              ...
              DO j=1,n
                ...
                ELSE
                  ...
                  DO i=max4,min4
                    ...
                    tempd = tempd + x(i)*DCONJG(ad(k+i, j)) + temp0*xd(i
     +                )
                    temp = temp + temp0*x(i)
                  ENDDO
                END IF
            ...
            ELSE
              DO j=1,n
                ...
                ELSE
                  ...
                  DO i=max6,min6
                    temp0 = DCONJG(a(k+i, j))
                    tempd = tempd + x(ix)*DCONJG(ad(k+i, j)) + temp0*xd(
     +                ix)
