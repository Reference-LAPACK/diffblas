# 0 "/gpfs/fs1/home/snarayan/difflapack/lapack-3.12.0-gfortran/CBLAS/src/cblas_zsymm.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/gpfs/fs1/home/snarayan/difflapack/lapack-3.12.0-gfortran/CBLAS/src/cblas_zsymm.c"
# 10 "/gpfs/fs1/home/snarayan/difflapack/lapack-3.12.0-gfortran/CBLAS/src/cblas_zsymm.c"
...
# 11 "/gpfs/fs1/home/snarayan/difflapack/lapack-3.12.0-gfortran/CBLAS/src/cblas_zsymm.c" 2
...
# 12 "/gpfs/fs1/home/snarayan/difflapack/lapack-3.12.0-gfortran/CBLAS/src/cblas_zsymm.c" 2
void cblas_zsymm(const CBLAS_LAYOUT layout, const CBLAS_SIDE Side,
                 const CBLAS_UPLO Uplo, const int32_t M, const int32_t N,
                 const void *alpha, const void *A, const int32_t lda,
                 const void *B, const int32_t ldb, const void *beta,
                 void *C, const int32_t ldc)
{
   char SD, UL;
# 27 "/gpfs/fs1/home/snarayan/difflapack/lapack-3.12.0-gfortran/CBLAS/src/cblas_zsymm.c"
   int32_t F77_M=M, F77_N=N, F77_lda=lda, F77_ldb=ldb;
   int32_t F77_ldc=ldc;
# 37 "/gpfs/fs1/home/snarayan/difflapack/lapack-3.12.0-gfortran/CBLAS/src/cblas_zsymm.c"
   ...
   if( layout == CblasColMajor )
   {
      ...
      zsymm_(&SD, &UL, &F77_M, &F77_N, alpha, A, &F77_lda, B, &F77_ldb, beta, C, &F77_ldc)
                                                     ;
   } else if (layout == CblasRowMajor)
   {
      ...
      zsymm_(&SD, &UL, &F77_N, &F77_M, alpha, A, &F77_lda, B, &F77_ldb, beta, C, &F77_ldc)
                                                    ;
   }
