...
C
C  Differentiation of cgbmv in forward (tangent) mode:
...
C>
C  =====================================================================
      SUBROUTINE CGBMV_D(trans, m, n, kl, ku, alpha, alphad, a, ad, lda
            ...
            IF (incx .EQ. 1) THEN
              DO j=1,n
                ...
                ELSE
                  ...
                  DO i=max4,min4
                    temp0 = CONJG(a(k+i, j))
                    tempd = tempd + x(i)*CONJG(ad(k+i, j)) + temp0*xd(i)
                    temp = temp + temp0*x(i)
                  ENDDO
                END IF
            ...
            ELSE
              DO j=1,n
                ...
                ELSE
                  ...
                  DO i=max6,min6
                    temp0 = CONJG(a(k+i, j))
                    tempd = tempd + x(ix)*CONJG(ad(k+i, j)) + temp0*xd(
     +                ix)
