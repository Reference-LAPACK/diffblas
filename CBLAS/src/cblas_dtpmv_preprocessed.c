# 0 "/gpfs/fs1/home/snarayan/difflapack/lapack-3.12.0-gfortran/CBLAS/src/cblas_dtpmv.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/gpfs/fs1/home/snarayan/difflapack/lapack-3.12.0-gfortran/CBLAS/src/cblas_dtpmv.c"
...
# 9 "/gpfs/fs1/home/snarayan/difflapack/lapack-3.12.0-gfortran/CBLAS/src/cblas_dtpmv.c" 2
...
# 10 "/gpfs/fs1/home/snarayan/difflapack/lapack-3.12.0-gfortran/CBLAS/src/cblas_dtpmv.c" 2
                 ...
                 const int32_t N, const double *Ap, double *X, const int32_t incX)
{
   ...
   char UL;
   char DI;
# 25 "/gpfs/fs1/home/snarayan/difflapack/lapack-3.12.0-gfortran/CBLAS/src/cblas_dtpmv.c"
   ...
   if (layout == CblasColMajor)
   {
      ...
      dtpmv_(&UL, &TA, &DI, &F77_N, Ap, X, &F77_incX);
   }
