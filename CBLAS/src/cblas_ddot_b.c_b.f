...
C  Differentiation of ddotsub in reverse (adjoint) mode:
...
C
      SUBROUTINE DDOTSUB_B(n, x, xb, incx, y, yb, incy, dot, dotb)
      IMPLICIT NONE
C
      EXTERNAL DDOT
      EXTERNAL DDOT_B
      ...
      DOUBLE PRECISION xb(*), yb(*), dotb
C
      CALL DDOT_B(n, x, xb, incx, y, yb, incy, dotb)
      END
