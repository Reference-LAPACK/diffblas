...
C
C  Differentiation of cgemm in forward (tangent) mode (with options multiDirectional):
...
C>
C  =====================================================================
      SUBROUTINE CGEMM_DV(transa, transb, m, n, k, alpha, alphad, a, ad
...
C     .. Array Arguments ..
      ...
      COMPLEX ad(nbdirsmax, lda, *), bd(nbdirsmax, ldb, *), cd(nbdirsmax
     +        , ldc, *)
      EXTERNAL LSAME
C     ..
C
...
C
        IF (beta .EQ. zero) THEN
          DO j=1,n
            DO i=1,m
              DO nd=1,nbdirs
C     FIXED: Removed zeroing of cd - should accumulate from input seed
              ENDDO
              c(i, j) = zero
            ENDDO
          ENDDO
            ...
            DO j=1,n
              DO i=1,m
                ...
                DO l=1,k
                  temp0 = CONJG(a(l, i))
                  DO nd=1,nbdirs
                    tempd(nd) = tempd(nd) + b(l, j)*CONJG(ad(nd, l, i)) 
     +                + temp0*bd(nd, l, j)
                  ENDDO
...
C     FIXED: Removed zeroing of cd - should accumulate from input seed
              ...
              DO l=1,k
                temp0 = CONJG(b(j, l))
                DO nd=1,nbdirs
                  tempd(nd) = temp0*alphad(nd) + alpha*CONJG(bd(nd, j, l
     +              ))
                ENDDO
                temp = alpha*temp0
                DO i=1,m
            ...
            DO j=1,n
              DO i=1,m
                ...
                DO l=1,k
                  ...
                  temp1 = CONJG(a(l, i))
                  DO nd=1,nbdirs
                    tempd(nd) = tempd(nd) + temp0*CONJG(ad(nd, l, i)) + 
     +                temp1*CONJG(bd(nd, j, l))
                  ENDDO
            ...
            DO j=1,n
              DO i=1,m
                ...
                DO l=1,k
                  temp1 = CONJG(a(l, i))
                  DO nd=1,nbdirs
                    tempd(nd) = tempd(nd) + b(j, l)*CONJG(ad(nd, l, i)) 
     +                + temp1*bd(nd, j, l)
                  ENDDO
