...
C>
C  =====================================================================
      SUBROUTINE ZTRSM_D(side, uplo, transa, diag, m, n, alpha, alphad, 
     +                   a, ad, lda, b, bd, ldb)
      IMPLICIT NONE
C
            ...
            DO j=1,n
              DO i=1,m
                ...
                ELSE
                  DO k=1,i-1
                    temp1 = DCONJG(a(k, i))
                    tempd = tempd - b(k, j)*DCONJG(ad(k, i)) - temp1*bd(
     +                k, j)
                    temp = temp - temp1*b(k, j)
                  ENDDO
                  IF (nounit) THEN
                    temp1 = DCONJG(a(i, i))
                    tempd = (tempd-temp*DCONJG(ad(i, i))/temp1)/temp1
                    temp = temp/temp1
                  END IF
                END IF
                bd(i, j) = tempd
          ...
          DO k=n,1,-1
            IF (nounit) THEN
              ...
              ELSE
                ...
                tempd = -(temp0*DCONJG(ad(k, k))/DCONJG(a(k, k)))
                temp = temp0
              END IF
              DO i=1,m
