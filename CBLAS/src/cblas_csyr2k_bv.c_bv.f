...
C
C  Differentiation of csyr2k in reverse (adjoint) mode (with options multiDirectional):
...
C  ===========
C
C       SUBROUTINE CSYR2K(UPLO,TRANS,N,K,ALPHA,A,LDA,B,LDB,BETA,C,LDC)
C
C       .. Scalar Arguments ..
...
C>
C  =====================================================================
      SUBROUTINE CSYR2K_BV(uplo, trans, n, k, alpha, alphab, a, ab, lda
...
C     .. Array Arguments ..
      ...
      COMPLEX ab(nbdirsmax, lda, *), bb(nbdirsmax, ldb, *), cb(nbdirsmax
     +        , ldc, *)
      EXTERNAL LSAME
C     ..
C
