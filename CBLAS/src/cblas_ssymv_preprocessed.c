# 0 "/gpfs/fs1/home/snarayan/difflapack/lapack-3.12.0-gfortran/CBLAS/src/cblas_ssymv.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/gpfs/fs1/home/snarayan/difflapack/lapack-3.12.0-gfortran/CBLAS/src/cblas_ssymv.c"
# 10 "/gpfs/fs1/home/snarayan/difflapack/lapack-3.12.0-gfortran/CBLAS/src/cblas_ssymv.c"
...
# 11 "/gpfs/fs1/home/snarayan/difflapack/lapack-3.12.0-gfortran/CBLAS/src/cblas_ssymv.c" 2
...
# 12 "/gpfs/fs1/home/snarayan/difflapack/lapack-3.12.0-gfortran/CBLAS/src/cblas_ssymv.c" 2
void cblas_ssymv(const CBLAS_LAYOUT layout,
                 const CBLAS_UPLO Uplo, const int32_t N,
                 const float alpha, const float *A, const int32_t lda,
                 const float *X, const int32_t incX, const float beta,
                 float *Y, const int32_t incY)
{
   ...
   int32_t F77_N=N, F77_lda=lda, F77_incX=incX, F77_incY=incY;
   ...
   if (layout == CblasColMajor)
   {
      ...
      ssymv_(&UL, &F77_N, &alpha, A, &F77_lda, X, &F77_incX, &beta, Y, &F77_incY)
                                                    ;
   }
