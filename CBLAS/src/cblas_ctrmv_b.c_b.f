...
C
C  Differentiation of ctrmv in reverse (adjoint) mode:
...
C>
C  =====================================================================
      SUBROUTINE CTRMV_B(uplo, trans, diag, n, a, ab, lda, x, xb, incx)
      IMPLICIT NONE
            ...
            IF (incx .EQ. 1) THEN
              ...
              DO j=1,n,1
                ...
                ELSE
                  ...
                  IF (branch .NE. 0) THEN
                    CALL POPCOMPLEX8(temp)
                    ab(j, j) = ab(j, j) + CONJG(CONJG(temp)*tempb)
                    tempb = CONJG(CONJG(a(j, j)))*tempb
                  END IF
                END IF
                xb(j) = xb(j) + tempb
              ENDDO
