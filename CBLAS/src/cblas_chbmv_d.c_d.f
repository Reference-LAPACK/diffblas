...
C
C  Differentiation of chbmv in forward (tangent) mode:
...
C>
C  =====================================================================
      SUBROUTINE CHBMV_D(uplo, n, k, alpha, alphad, a, ad, lda, x, xd, 
            ...
            IF (incx .EQ. 1 .AND. incy .EQ. 1) THEN
              DO j=1,n
                ...
                DO i=max1,j-1
                  ...
                  temp = CONJG(a(l+i, j))
                  temp2d = temp2d + x(i)*CONJG(ad(l+i, j)) + temp*xd(i)
                  temp2 = temp2 + temp*x(i)
                ENDDO
                temp0 = REAL(a(kplus1, j))
                yd(j) = yd(j) + temp0*temp1d + temp1*REAL(ad(kplus1, j))
            ...
            ELSE
              ...
              DO j=1,n
                ...
                DO i=max2,j-1
                  ...
                  temp = CONJG(a(l+i, j))
                  temp2d = temp2d + x(ix)*CONJG(ad(l+i, j)) + temp*xd(ix
     +              )
                ...
                ENDDO
                temp0 = REAL(a(kplus1, j))
                yd(jy) = yd(jy) + temp0*temp1d + temp1*REAL(ad(kplus1, j
     +            )) + temp2*alphad + alpha*temp2d
...
C
            DO j=1,n
              ...
              temp2 = zero
              temp0 = REAL(a(1, j))
              yd(j) = yd(j) + temp0*temp1d + temp1*REAL(ad(1, j))
              y(j) = y(j) + temp1*temp0
              l = 1 - j
              IF (n .GT. j + k) THEN
                min1 = j + k
          ...
          ELSE
            ...
            DO j=1,n
              ...
              temp2 = zero
              temp0 = REAL(a(1, j))
              yd(jy) = yd(jy) + temp0*temp1d + temp1*REAL(ad(1, j))
