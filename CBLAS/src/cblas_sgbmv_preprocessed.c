# 0 "/gpfs/fs1/home/snarayan/difflapack/lapack-3.12.0-gfortran/CBLAS/src/cblas_sgbmv.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/gpfs/fs1/home/snarayan/difflapack/lapack-3.12.0-gfortran/CBLAS/src/cblas_sgbmv.c"
# 10 "/gpfs/fs1/home/snarayan/difflapack/lapack-3.12.0-gfortran/CBLAS/src/cblas_sgbmv.c"
...
# 11 "/gpfs/fs1/home/snarayan/difflapack/lapack-3.12.0-gfortran/CBLAS/src/cblas_sgbmv.c" 2
...
# 12 "/gpfs/fs1/home/snarayan/difflapack/lapack-3.12.0-gfortran/CBLAS/src/cblas_sgbmv.c" 2
void cblas_sgbmv(const CBLAS_LAYOUT layout,
                 const CBLAS_TRANSPOSE TransA, const int32_t M, const int32_t N,
                 const int32_t KL, const int32_t KU,
                 const float alpha, const float *A, const int32_t lda,
                 const float *X, const int32_t incX, const float beta,
                 float *Y, const int32_t incY)
{
   ...
   int32_t F77_KL=KL,F77_KU=KU;
# 37 "/gpfs/fs1/home/snarayan/difflapack/lapack-3.12.0-gfortran/CBLAS/src/cblas_sgbmv.c"
   ...
   if (layout == CblasColMajor)
   {
      ...
      sgbmv_(&TA, &F77_M, &F77_N, &F77_KL, &F77_KU, &alpha, A, &F77_lda, X, &F77_incX, &beta, Y, &F77_incY)
                                                                    ;
   }
   else if (layout == CblasRowMajor)
   {
      ...
      sgbmv_(&TA, &F77_N, &F77_M, &F77_KU, &F77_KL, &alpha, A ,&F77_lda, X, &F77_incX, &beta, Y, &F77_incY)
                                                                    ;
   }
