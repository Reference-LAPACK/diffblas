...
C
C  Differentiation of zgemm in reverse (adjoint) mode:
...
C>
C  =====================================================================
      SUBROUTINE ZGEMM_B(transa, transb, m, n, k, alpha, alphab, a, ab, 
...
C
            ...
            DO j=n,1,-1
              DO i=m,1,-1
                ...
                END IF
                DO l=k,1,-1
                  ab(l, i) = ab(l, i) + DCONJG(CONJG(b(l, j))*tempb)
                  bb(l, j) = bb(l, j) + CONJG(DCONJG(a(l, i)))*tempb
                ENDDO
...
C
            ...
            DO j=n,1,-1
              DO l=k,1,-1
                ...
                ENDDO
                CALL POPCOMPLEX16(temp)
                alphab = alphab + CONJG(DCONJG(b(j, l)))*tempb
                bb(j, l) = bb(j, l) + DCONJG(CONJG(alpha)*tempb)
              ENDDO
              CALL POPCONTROL2B(branch)
              IF (branch .NE. 0) THEN
                IF (branch .EQ. 1) THEN
...
C
            ...
            DO j=n,1,-1
              DO i=m,1,-1
                ...
                END IF
                DO l=k,1,-1
                  ab(l, i) = ab(l, i) + DCONJG(CONJG(DCONJG(b(j, l)))*
     +              tempb)
                  bb(j, l) = bb(j, l) + DCONJG(CONJG(DCONJG(a(l, i)))*
     +              tempb)
                ENDDO
                CALL POPCOMPLEX16(temp)
              ENDDO
...
C
            ...
            DO j=n,1,-1
              DO i=m,1,-1
                ...
                END IF
                DO l=k,1,-1
                  ab(l, i) = ab(l, i) + DCONJG(CONJG(b(j, l))*tempb)
                  bb(j, l) = bb(j, l) + CONJG(DCONJG(a(l, i)))*tempb
                ENDDO
                CALL POPCOMPLEX16(temp)
              ENDDO
            ENDDO
...
C
          ...
          DO j=n,1,-1
            DO i=m,1,-1
              ...
              END IF
              DO l=k,1,-1
                ab(l, i) = ab(l, i) + CONJG(DCONJG(b(j, l)))*tempb
                bb(j, l) = bb(j, l) + DCONJG(CONJG(a(l, i))*tempb)
              ENDDO
              CALL POPCOMPLEX16(temp)
            ENDDO
          ENDDO
