# 0 "/gpfs/fs1/home/snarayan/difflapack/lapack-3.12.0-gfortran/CBLAS/src/cblas_zgbmv.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/gpfs/fs1/home/snarayan/difflapack/lapack-3.12.0-gfortran/CBLAS/src/cblas_zgbmv.c"
...
# 9 "/gpfs/fs1/home/snarayan/difflapack/lapack-3.12.0-gfortran/CBLAS/src/cblas_zgbmv.c" 2
...
# 10 "/gpfs/fs1/home/snarayan/difflapack/lapack-3.12.0-gfortran/CBLAS/src/cblas_zgbmv.c" 2
...
# 11 "/gpfs/fs1/home/snarayan/difflapack/lapack-3.12.0-gfortran/CBLAS/src/cblas_zgbmv.c" 2
...
# 12 "/gpfs/fs1/home/snarayan/difflapack/lapack-3.12.0-gfortran/CBLAS/src/cblas_zgbmv.c" 2
...
# 37 "/gpfs/fs1/home/snarayan/difflapack/lapack-3.12.0-gfortran/CBLAS/src/cblas_zgbmv.c"
   ...
   if (layout == CblasColMajor)
   {
      ...
      zgbmv_(&TA, &F77_M, &F77_N, &F77_KL, &F77_KU, alpha, A, &F77_lda, X, &F77_incX, beta, Y, &F77_incY)
                                                                   ;
   }
   else if (layout == CblasRowMajor)
   {
      ...
      if (TransA == CblasConjTrans)
         zgbmv_(&TA, &F77_N, &F77_M, &F77_KU, &F77_KL, ALPHA, A ,&F77_lda, x,&F77_incX, BETA, Y, &F77_incY)
                                                                     ;
      else
         zgbmv_(&TA, &F77_N, &F77_M, &F77_KU, &F77_KL, alpha, A ,&F77_lda, x,&F77_incX, beta, Y, &F77_incY)
                                                                     ;
