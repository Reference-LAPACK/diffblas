...
C
C  Differentiation of sgemm in forward (tangent) mode (with options multiDirectional):
...
C>
C  =====================================================================
      SUBROUTINE SGEMM_DV(transa, transb, m, n, k, alpha, alphad, a, ad
...
C     FIXED: Removed zeroing of cd - should accumulate from input seed
            ...
            DO l=1,k
              ...
              DO i=1,m
                DO nd=1,nbdirs
                  cd(nd, i, j) = cd(nd, i, j) + a(i, l)*tempd(nd) + temp
     +              *ad(nd, i, l)
                ENDDO
                c(i, j) = c(i, j) + temp*a(i, l)
              ENDDO
