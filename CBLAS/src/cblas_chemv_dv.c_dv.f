...
C
C  Differentiation of chemv in forward (tangent) mode (with options multiDirectional):
...
C>
C  =====================================================================
      SUBROUTINE CHEMV_DV(uplo, n, alpha, alphad, a, ad, lda, x, xd, 
...
C
     ...
     +                ad(nd, i, j)
                    temp2d(nd) = temp2d(nd) + x(i)*CONJG(ad(nd, i, j)) +
     +                temp*xd(nd, i)
                  ENDDO
                  y(i) = y(i) + temp1*a(i, j)
     ...
     +                *ad(nd, i, j)
                    temp2d(nd) = temp2d(nd) + x(ix)*CONJG(ad(nd, i, j)) 
     +                + temp*xd(nd, ix)
                  ENDDO
     ...
     +              REAL(ad(nd, j, j)) + temp2*alphad(nd) + alpha*temp2d
     +              (nd)
                ENDDO
