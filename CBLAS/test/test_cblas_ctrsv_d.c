/* Test program for cblas_ctrsv differentiation */
...
extern void cblas_ctrsv_d(const CBLAS_LAYOUT layout, const CBLAS_UPLO Uplo, const CBLAS_TRANSPOSE TransA, const CBLAS_DIAG Diag, const CBLAS_INT N, const void *A, void *A_d, const CBLAS_INT lda, void *X, void *X_d, const CBLAS_INT incX);
