/* Test program for cblas_ccopy forward vector (dv) differentiation */
...
extern void cblas_ccopy_dv(CBLAS_INT N, const void *X, void *Xd, CBLAS_INT incX, void *Y, void *Yd, CBLAS_INT incY, int nbdirs);
