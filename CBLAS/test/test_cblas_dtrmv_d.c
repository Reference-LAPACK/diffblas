/* Test program for cblas_dtrmv differentiation */
...
extern void cblas_dtrmv_d(const CBLAS_LAYOUT layout, const CBLAS_UPLO Uplo, const CBLAS_TRANSPOSE TransA, const CBLAS_DIAG Diag, const CBLAS_INT N, const double *A, double *A_d, const CBLAS_INT lda, double *X, double *X_d, const CBLAS_INT incX);
