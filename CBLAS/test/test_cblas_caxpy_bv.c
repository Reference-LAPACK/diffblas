/* Test program for cblas_caxpy vector reverse mode (VJP verification, generic, loop over directions) */
...
extern void cblas_caxpy(const CBLAS_INT N, const void *alpha, const void *X, const CBLAS_INT incX, void *Y, const CBLAS_INT incY);
...
int main(void) {
    ...
    cblas_caxpy_bv(n, &alpha, (void*)&alpha_b, X, (void*)X_b, incX, Y, (void*)Y_b, incY, nbdirs);
