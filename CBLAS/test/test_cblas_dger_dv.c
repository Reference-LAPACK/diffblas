/* Test program for cblas_dger forward vector (dv) differentiation */
...
extern void cblas_dger_dv(CBLAS_LAYOUT layout, CBLAS_INT M, CBLAS_INT N, double alpha, double alphad[NBDirsMax], const double *X, double (*Xd)[NBDirsMax], CBLAS_INT incX, const double *Y, double (*Yd)[NBDirsMax], CBLAS_INT incY, double *A, double (*Ad)[NBDirsMax], CBLAS_INT lda, int nbdirs);
