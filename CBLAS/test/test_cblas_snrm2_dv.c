/* Test program for cblas_snrm2 forward vector (dv) differentiation */
...
extern void cblas_snrm2_dv(CBLAS_INT N, const float *X, float (*Xd)[NBDirsMax], CBLAS_INT incX, float *result, float resultd[NBDirsMax], int nbdirs);
