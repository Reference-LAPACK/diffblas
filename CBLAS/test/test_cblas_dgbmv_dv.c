/* Test program for cblas_dgbmv forward vector (dv) differentiation */
...
extern void cblas_dgbmv_dv(CBLAS_LAYOUT layout, CBLAS_TRANSPOSE TransA, CBLAS_INT M, CBLAS_INT N, CBLAS_INT KL, CBLAS_INT KU, double alpha, double alphad[NBDirsMax], const double *A, double (*Ad)[NBDirsMax], CBLAS_INT lda, const double *X, double (*Xd)[NBDirsMax], CBLAS_INT incX, double beta, double betad[NBDirsMax], double *Y, double (*Yd)[NBDirsMax], CBLAS_INT incY, int nbdirs);
