/* Test program for cblas_saxpy differentiation */
...
extern void cblas_saxpy_d(const CBLAS_INT N, const float alpha, float alpha_d, const float *X, float *X_d, const CBLAS_INT incX, float *Y, float *Y_d, const CBLAS_INT incY);
