/* Test program for cblas_ztbmv reverse mode (VJP verification, generic) */
...
extern void cblas_ztbmv_b(const CBLAS_LAYOUT layout, const CBLAS_UPLO Uplo, const CBLAS_TRANSPOSE TransA, const CBLAS_DIAG Diag, const CBLAS_INT N, const CBLAS_INT K, const void *A, void *A_b, const CBLAS_INT lda, void *X, void *X_b, const CBLAS_INT incX);
...
int main(void) {
    ...
    cblas_ztbmv_b(layout, uplo, transa, diag, n, k, A, A_b, lda, X, X_b, incX);
