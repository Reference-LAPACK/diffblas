/* Test program for cblas_cgerc vector reverse mode (VJP verification, generic, loop over directions) */
...
extern void cblas_cgerc(const CBLAS_LAYOUT layout, const CBLAS_INT M, const CBLAS_INT N, const void *alpha, const void *X, const CBLAS_INT incX, const void *Y, const CBLAS_INT incY, void *A, const CBLAS_INT lda);
...
int main(void) {
    ...
    float complex A_plus[MAX_SIZE*MAX_SIZE], A_minus[MAX_SIZE*MAX_SIZE];
    ...
    cblas_cgerc_bv(layout, m, n, &alpha, (void*)&alpha_b, X, (void*)X_b, incX, Y, (void*)Y_b, incY, A, (void*)A_b, lda, nbdirs);
