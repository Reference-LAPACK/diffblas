/* Test program for cblas_dtrsv reverse mode (VJP verification, generic) */
...
extern void cblas_dtrsv(const CBLAS_LAYOUT layout, const CBLAS_UPLO Uplo, const CBLAS_TRANSPOSE TransA, const CBLAS_DIAG Diag, const CBLAS_INT N, const double *A, const CBLAS_INT lda, double *X, const CBLAS_INT incX);
extern void cblas_dtrsv_b(const CBLAS_LAYOUT layout, const CBLAS_UPLO Uplo, const CBLAS_TRANSPOSE TransA, const CBLAS_DIAG Diag, const CBLAS_INT N, const double *A, double *A_b, const CBLAS_INT lda, double *X, double *X_b, const CBLAS_INT incX);
...
int main(void) {
    ...
    double X_plus[MAX_SIZE], X_minus[MAX_SIZE], X_central_diff[MAX_SIZE], X_b_orig[MAX_SIZE];
    ...
    cblas_dtrsv_b(layout, uplo, transa, diag, n, A, A_b, lda, X, X_b, incX);
