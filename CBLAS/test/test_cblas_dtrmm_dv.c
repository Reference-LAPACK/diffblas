/* Test program for cblas_dtrmm forward vector (dv) differentiation */
...
extern void cblas_dtrmm_dv(CBLAS_LAYOUT layout, CBLAS_SIDE Side, CBLAS_UPLO Uplo, CBLAS_TRANSPOSE TransA, CBLAS_DIAG Diag, CBLAS_INT M, CBLAS_INT N, double alpha, double alphad[NBDirsMax], const double *A, double (*Ad)[NBDirsMax], CBLAS_INT lda, double *B, double (*Bd)[NBDirsMax], CBLAS_INT ldb, int nbdirs);
