/* Test program for cblas_zdscal vector reverse mode (VJP verification, generic, loop over directions) */
...
int main(void) {
    ...
    cblas_zdscal_bv(n, alpha, (void*)&alpha_b, X, (void*)X_b, incX, nbdirs);
