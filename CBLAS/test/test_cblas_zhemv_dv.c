/* Test program for cblas_zhemv forward vector (dv) differentiation */
...
extern void cblas_zhemv_dv(CBLAS_LAYOUT layout, CBLAS_UPLO Uplo, CBLAS_INT N, const void *alpha, const void *alphad, const void *A, void *Ad, CBLAS_INT lda, const void *X, void *Xd, CBLAS_INT incX, const void *beta, const void *betad, void *Y, void *Yd, CBLAS_INT incY, int nbdirs);
