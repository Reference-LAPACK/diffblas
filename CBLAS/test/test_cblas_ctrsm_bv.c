/* Test program for cblas_ctrsm vector reverse mode (VJP verification, generic, loop over directions) */
...
int main(void) {
    ...
    cblas_ctrsm_bv(layout, side, uplo, transa, diag, m, n, &alpha, (void*)&alpha_b, A, (void*)A_b, lda, B, (void*)B_b, ldb, nbdirs);
