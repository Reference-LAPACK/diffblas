/* Test program for cblas_strsm vector reverse mode (VJP verification, generic, loop over directions) */
...
int main(void) {
    ...
    float B_plus[MAX_SIZE*MAX_SIZE], B_minus[MAX_SIZE*MAX_SIZE];
    ...
    cblas_strsm_bv(layout, side, uplo, transa, diag, m, n, alpha, &alpha_b, A, &A_b[0][0], lda, B, &B_b[0][0], ldb, nbdirs);
