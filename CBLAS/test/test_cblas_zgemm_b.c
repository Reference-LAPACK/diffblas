/* Test program for cblas_zgemm reverse mode (VJP verification) */
...
extern void cblas_zgemm(const CBLAS_LAYOUT layout, const CBLAS_TRANSPOSE TransA, const CBLAS_TRANSPOSE TransB, const CBLAS_INT M, const CBLAS_INT N, const CBLAS_INT K, const void *alpha, const void *A, const CBLAS_INT lda, const void *B, const CBLAS_INT ldb, const void *beta, void *C, const CBLAS_INT ldc);
extern void cblas_zgemm_b(const CBLAS_LAYOUT layout, const CBLAS_TRANSPOSE TransA, const CBLAS_TRANSPOSE TransB, const CBLAS_INT M, const CBLAS_INT N, const CBLAS_INT K, const void *alpha, void *alpha_b, const void *A, void *A_b, const CBLAS_INT lda, const void *B, void *B_b, const CBLAS_INT ldb, const void *beta, void *beta_b, void *C, void *C_b, const CBLAS_INT ldc);
...
int main(void) {
    ...
    double complex alpha, alpha_b, alpha_dir;
    double complex beta, beta_b, beta_dir;
    double complex A[MAX_SIZE*MAX_SIZE], B[MAX_SIZE*MAX_SIZE], C[MAX_SIZE*MAX_SIZE];
    double complex A_b[MAX_SIZE*MAX_SIZE], B_b[MAX_SIZE*MAX_SIZE], C_b[MAX_SIZE*MAX_SIZE];
    double complex A_dir[MAX_SIZE*MAX_SIZE], B_dir[MAX_SIZE*MAX_SIZE], C_dir[MAX_SIZE*MAX_SIZE];
    double complex C_forward[MAX_SIZE*MAX_SIZE], C_backward[MAX_SIZE*MAX_SIZE];
    double complex C_b_orig[MAX_SIZE*MAX_SIZE];  /* save cotangent before _b overwrites */
    double complex alpha_orig, beta_orig, A_orig[MAX_SIZE*MAX_SIZE], B_orig[MAX_SIZE*MAX_SIZE], C_orig[MAX_SIZE*MAX_SIZE];  /* for restore like BLAS test */
    ...
    cblas_zgemm_b(CblasColMajor, CblasNoTrans, CblasNoTrans, m, n, k,
    ...
    cblas_zgemm(CblasColMajor, CblasNoTrans, CblasNoTrans, m, n, k, (const void*)&alpha, (const void*)A, lda, (const void*)B, ldb, (const void*)&beta, (void*)C, ldc);
