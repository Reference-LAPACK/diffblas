/* Test program for cblas_zsymm reverse mode (VJP verification, generic) */
...
extern void cblas_zsymm_b(const CBLAS_LAYOUT layout, const CBLAS_SIDE Side, const CBLAS_UPLO Uplo, const CBLAS_INT M, const CBLAS_INT N, const void *alpha, void *alpha_b, const void *A, void *A_b, const CBLAS_INT lda, const void *B, void *B_b, const CBLAS_INT ldb, const void *beta, void *beta_b, void *C, void *C_b, const CBLAS_INT ldc);
...
int main(void) {
    ...
    cblas_zsymm_b(layout, side, uplo, m, n, &alpha, alpha_b, A, A_b, lda, B, B_b, ldb, &beta, beta_b, C, C_b, ldc);
