/* Test program for cblas_ssymv reverse mode (VJP verification, generic) */
...
extern void cblas_ssymv_b(const CBLAS_LAYOUT layout, const CBLAS_UPLO Uplo, const CBLAS_INT N, const float alpha, float *alpha_b, const float *A, float *A_b, const CBLAS_INT lda, const float *X, float *X_b, const CBLAS_INT incX, const float beta, float *beta_b, float *Y, float *Y_b, const CBLAS_INT incY);
...
int main(void) {
    ...
    cblas_ssymv_b(layout, uplo, n, alpha, &alpha_b, A, A_b, lda, X, X_b, incX, beta, &beta_b, Y, Y_b, incY);
