/* Test program for cblas_zcopy vector reverse mode (VJP verification, generic, loop over directions) */
...
extern void cblas_zcopy(const CBLAS_INT N, const void *X, const CBLAS_INT incX, void *Y, const CBLAS_INT incY);
...
int main(void) {
    ...
    cblas_zcopy_bv(n, X, (void*)X_b, incX, Y, (void*)Y_b, incY, nbdirs);
