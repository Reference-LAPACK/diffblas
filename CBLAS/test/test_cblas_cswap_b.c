/* Test program for cblas_cswap reverse mode (VJP verification, generic) */
...
extern void cblas_cswap_b(const CBLAS_INT N, void *X, void *X_b, const CBLAS_INT incX, void *Y, void *Y_b, const CBLAS_INT incY);
...
int main(void) {
    ...
    cblas_cswap_b(n, X, X_b, incX, Y, Y_b, incY);
