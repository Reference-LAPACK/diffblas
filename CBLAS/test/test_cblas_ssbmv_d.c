/* Test program for cblas_ssbmv differentiation */
...
extern void cblas_ssbmv_d(const CBLAS_LAYOUT layout, const CBLAS_UPLO Uplo, const CBLAS_INT N, const CBLAS_INT K, const float alpha, float alpha_d, const float *A, float *A_d, const CBLAS_INT lda, const float *X, float *X_d, const CBLAS_INT incX, const float beta, float beta_d, float *Y, float *Y_d, const CBLAS_INT incY);
