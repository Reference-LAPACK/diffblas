/* Test program for cblas_dcopy differentiation */
...
extern void cblas_dcopy_d(const CBLAS_INT N, const double *X, double *X_d, const CBLAS_INT incX, double *Y, double *Y_d, const CBLAS_INT incY);
