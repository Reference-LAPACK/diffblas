/* Test program for cblas_sdot differentiation */
...
extern float cblas_sdot_d(const CBLAS_INT N, const float *X, float *X_d, const CBLAS_INT incX, const float *Y, float *Y_d, const CBLAS_INT incY, float *result);
