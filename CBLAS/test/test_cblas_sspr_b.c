/* Test program for cblas_sspr reverse mode (VJP verification, generic) */
...
extern void cblas_sspr(const CBLAS_LAYOUT layout, const CBLAS_UPLO Uplo, const CBLAS_INT N, const float alpha, const float *X, const CBLAS_INT incX, float *Ap);
extern void cblas_sspr_b(const CBLAS_LAYOUT layout, const CBLAS_UPLO Uplo, const CBLAS_INT N, const float alpha, float *alpha_b, const float *X, float *X_b, const CBLAS_INT incX, float *Ap, float *Ap_b);
...
int main(void) {
    ...
    float Ap_plus[PACKED_SIZE], Ap_minus[PACKED_SIZE], Ap_central_diff[PACKED_SIZE], Ap_b_orig[PACKED_SIZE];
    ...
    cblas_sspr_b(layout, uplo, n, alpha, &alpha_b, X, X_b, incX, Ap, Ap_b);
