/* Test program for cblas_dtrmv reverse mode (VJP verification, generic) */
...
extern void cblas_dtrmv(const CBLAS_LAYOUT layout, const CBLAS_UPLO Uplo, const CBLAS_TRANSPOSE TransA, const CBLAS_DIAG Diag, const CBLAS_INT N, const double *A, const CBLAS_INT lda, double *X, const CBLAS_INT incX);
extern void cblas_dtrmv_b(const CBLAS_LAYOUT layout, const CBLAS_UPLO Uplo, const CBLAS_TRANSPOSE TransA, const CBLAS_DIAG Diag, const CBLAS_INT N, const double *A, double *A_b, const CBLAS_INT lda, double *X, double *X_b, const CBLAS_INT incX);
...
int main(void) {
    ...
    cblas_dtrmv_b(layout, uplo, transa, diag, n, A, A_b, lda, X, X_b, incX);
