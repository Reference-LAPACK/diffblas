/* Test program for cblas_dgemv reverse mode (VJP verification, generic) */
...
extern void cblas_dgemv_b(const CBLAS_LAYOUT layout, const CBLAS_TRANSPOSE TransA, const CBLAS_INT M, const CBLAS_INT N, const double alpha, double *alpha_b, const double *A, double *A_b, const CBLAS_INT lda, const double *X, double *X_b, const CBLAS_INT incX, const double beta, double *beta_b, double *Y, double *Y_b, const CBLAS_INT incY);
...
int main(void) {
    ...
    cblas_dgemv_b(layout, transa, m, n, alpha, &alpha_b, A, A_b, lda, X, X_b, incX, beta, &beta_b, Y, Y_b, incY);
