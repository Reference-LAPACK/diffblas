...
extern void cblas_csyrk_d(const CBLAS_LAYOUT layout, const CBLAS_UPLO Uplo, const CBLAS_TRANSPOSE Trans, const CBLAS_INT N, const CBLAS_INT K, const void *alpha, void *alpha_d, const void *A, void *A_d, const CBLAS_INT lda, const void *beta, void *beta_d, void *C, void *C_d, const CBLAS_INT ldc);
