/* Test program for cblas_sswap reverse mode (VJP verification, generic) */
...
extern void cblas_sswap(const CBLAS_INT N, float *X, const CBLAS_INT incX, float *Y, const CBLAS_INT incY);
extern void cblas_sswap_b(const CBLAS_INT N, float *X, float *X_b, const CBLAS_INT incX, float *Y, float *Y_b, const CBLAS_INT incY);
...
int main(void) {
    ...
    cblas_sswap_b(n, X, X_b, incX, Y, Y_b, incY);
