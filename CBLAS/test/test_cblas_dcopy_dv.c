/* Test program for cblas_dcopy forward vector (dv) differentiation */
...
extern void cblas_dcopy_dv(CBLAS_INT N, const double *X, double (*Xd)[NBDirsMax], CBLAS_INT incX, double *Y, double (*Yd)[NBDirsMax], CBLAS_INT incY, int nbdirs);
