/* Test program for cblas_strmv vector reverse mode (VJP verification, generic, loop over directions) */
...
int main(void) {
    ...
    cblas_strmv_bv(layout, uplo, transa, diag, n, A, &A_b[0][0], lda, X, X_b, incX, nbdirs);
