/* Test program for cblas_zaxpy differentiation */
...
extern void cblas_zaxpy_d(const CBLAS_INT N, const void *alpha, void *alpha_d, const void *X, void *X_d, const CBLAS_INT incX, void *Y, void *Y_d, const CBLAS_INT incY);
