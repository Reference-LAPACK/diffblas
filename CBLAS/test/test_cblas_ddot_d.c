/* Test program for cblas_ddot differentiation */
...
extern double cblas_ddot_d(const CBLAS_INT N, const double *X, double *X_d, const CBLAS_INT incX, const double *Y, double *Y_d, const CBLAS_INT incY, double *result);
