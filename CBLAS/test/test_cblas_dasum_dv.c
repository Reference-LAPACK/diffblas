/* Test program for cblas_dasum forward vector (dv) differentiation */
...
extern void cblas_dasum_dv(CBLAS_INT N, const double *X, double (*Xd)[NBDirsMax], CBLAS_INT incX, double *result, double resultd[NBDirsMax], int nbdirs);
