/* Test program for cblas_ssyr2 reverse mode (VJP verification, generic) */
...
extern void cblas_ssyr2_b(const CBLAS_LAYOUT layout, const CBLAS_UPLO Uplo, const CBLAS_INT N, const float alpha, float *alpha_b, const float *X, float *X_b, const CBLAS_INT incX, const float *Y, float *Y_b, const CBLAS_INT incY, float *A, float *A_b, const CBLAS_INT lda);
...
int main(void) {
    ...
    cblas_ssyr2_b(layout, uplo, n, alpha, &alpha_b, X, X_b, incX, Y, Y_b, incY, A, A_b, lda);
