/* Test program for cblas_zscal differentiation */
...
extern void cblas_zscal_d(const CBLAS_INT N, const void *alpha, void *alpha_d, void *X, void *X_d, const CBLAS_INT incX);
