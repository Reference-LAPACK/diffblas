/* Test program for cblas_ztrsm forward vector (dv) differentiation */
...
extern void cblas_ztrsm_dv(CBLAS_LAYOUT layout, CBLAS_SIDE Side, CBLAS_UPLO Uplo, CBLAS_TRANSPOSE TransA, CBLAS_DIAG Diag, CBLAS_INT M, CBLAS_INT N, const void *alpha, const void *alphad, const void *A, void *Ad, CBLAS_INT lda, void *B, void *Bd, CBLAS_INT ldb, int nbdirs);
