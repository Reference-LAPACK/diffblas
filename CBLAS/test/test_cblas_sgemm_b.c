/* Test program for cblas_sgemm reverse mode (VJP verification) */
...
extern void cblas_sgemm(const CBLAS_LAYOUT layout, const CBLAS_TRANSPOSE TransA, const CBLAS_TRANSPOSE TransB, const CBLAS_INT M, const CBLAS_INT N, const CBLAS_INT K, const float alpha, const float *A, const CBLAS_INT lda, const float *B, const CBLAS_INT ldb, const float beta, float *C, const CBLAS_INT ldc);
extern void cblas_sgemm_b(const CBLAS_LAYOUT layout, const CBLAS_TRANSPOSE TransA, const CBLAS_TRANSPOSE TransB, const CBLAS_INT M, const CBLAS_INT N, const CBLAS_INT K, const float alpha, float *alpha_b, const float *A, float *A_b, const CBLAS_INT lda, const float *B, float *B_b, const CBLAS_INT ldb, const float beta, float *beta_b, float *C, float *C_b, const CBLAS_INT ldc);
...
int main(void) {
    ...
    float alpha, alpha_b, alpha_dir;
    float beta, beta_b, beta_dir;
    float A[MAX_SIZE*MAX_SIZE], B[MAX_SIZE*MAX_SIZE], C[MAX_SIZE*MAX_SIZE];
    float A_b[MAX_SIZE*MAX_SIZE], B_b[MAX_SIZE*MAX_SIZE], C_b[MAX_SIZE*MAX_SIZE];
    float A_dir[MAX_SIZE*MAX_SIZE], B_dir[MAX_SIZE*MAX_SIZE], C_dir[MAX_SIZE*MAX_SIZE];
    float C_forward[MAX_SIZE*MAX_SIZE], C_backward[MAX_SIZE*MAX_SIZE];
    float C_b_orig[MAX_SIZE*MAX_SIZE];  /* save cotangent before _b overwrites */
    float alpha_orig, beta_orig, A_orig[MAX_SIZE*MAX_SIZE], B_orig[MAX_SIZE*MAX_SIZE], C_orig[MAX_SIZE*MAX_SIZE];  /* for restore like BLAS test */
    ...
    cblas_sgemm_b(CblasColMajor, CblasNoTrans, CblasNoTrans, m, n, k,
