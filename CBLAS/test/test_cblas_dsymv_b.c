/* Test program for cblas_dsymv reverse mode (VJP verification, generic) */
...
extern void cblas_dsymv(const CBLAS_LAYOUT layout, const CBLAS_UPLO Uplo, const CBLAS_INT N, const double alpha, const double *A, const CBLAS_INT lda, const double *X, const CBLAS_INT incX, const double beta, double *Y, const CBLAS_INT incY);
extern void cblas_dsymv_b(const CBLAS_LAYOUT layout, const CBLAS_UPLO Uplo, const CBLAS_INT N, const double alpha, double *alpha_b, const double *A, double *A_b, const CBLAS_INT lda, const double *X, double *X_b, const CBLAS_INT incX, const double beta, double *beta_b, double *Y, double *Y_b, const CBLAS_INT incY);
...
int main(void) {
    ...
    cblas_dsymv_b(layout, uplo, n, alpha, &alpha_b, A, A_b, lda, X, X_b, incX, beta, &beta_b, Y, Y_b, incY);
