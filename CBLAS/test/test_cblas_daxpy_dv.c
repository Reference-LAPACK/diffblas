/* Test program for cblas_daxpy forward vector (dv) differentiation */
...
extern void cblas_daxpy_dv(CBLAS_INT N, double alpha, double alphad[NBDirsMax], const double *X, double (*Xd)[NBDirsMax], CBLAS_INT incX, double *Y, double (*Yd)[NBDirsMax], CBLAS_INT incY, int nbdirs);
