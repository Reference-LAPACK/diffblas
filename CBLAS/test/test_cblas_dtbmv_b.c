/* Test program for cblas_dtbmv reverse mode (VJP verification, generic) */
...
extern void cblas_dtbmv_b(const CBLAS_LAYOUT layout, const CBLAS_UPLO Uplo, const CBLAS_TRANSPOSE TransA, const CBLAS_DIAG Diag, const CBLAS_INT N, const CBLAS_INT K, const double *A, double *A_b, const CBLAS_INT lda, double *X, double *X_b, const CBLAS_INT incX);
...
int main(void) {
    ...
    cblas_dtbmv_b(layout, uplo, transa, diag, n, k, A, A_b, lda, X, X_b, incX);
