/* Test program for cblas_sger vector reverse mode (VJP verification, generic, loop over directions) */
...
int main(void) {
    ...
    cblas_sger_bv(layout, m, n, alpha, &alpha_b, X, X_b, incX, Y, Y_b, incY, A, &A_b[0][0], lda, nbdirs);
