/* Test program for cblas_zsyrk vector reverse mode (VJP verification, generic, loop over directions) */
...
int main(void) {
    ...
    cblas_zsyrk_bv(layout, uplo, trans, n, k, &alpha, (void*)&alpha_b, A, (void*)A_b, lda, &beta, (void*)&beta_b, C, (void*)C_b, ldc, nbdirs);
