/* Test program for cblas_ssymv vector reverse mode (VJP verification, generic, loop over directions) */
...
int main(void) {
    ...
    cblas_ssymv_bv(layout, uplo, n, alpha, &alpha_b, A, &A_b[0][0], lda, X, X_b, incX, beta, &beta_b, Y, Y_b, incY, nbdirs);
