/* Test program for cblas_dsyr2 reverse mode (VJP verification, generic) */
...
extern void cblas_dsyr2_b(const CBLAS_LAYOUT layout, const CBLAS_UPLO Uplo, const CBLAS_INT N, const double alpha, double *alpha_b, const double *X, double *X_b, const CBLAS_INT incX, const double *Y, double *Y_b, const CBLAS_INT incY, double *A, double *A_b, const CBLAS_INT lda);
...
int main(void) {
    ...
    cblas_dsyr2_b(layout, uplo, n, alpha, &alpha_b, X, X_b, incX, Y, Y_b, incY, A, A_b, lda);
