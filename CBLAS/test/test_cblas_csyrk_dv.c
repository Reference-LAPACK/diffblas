/* Test program for cblas_csyrk forward vector (dv) differentiation */
...
extern void cblas_csyrk_dv(CBLAS_LAYOUT layout, CBLAS_UPLO Uplo, CBLAS_TRANSPOSE Trans, CBLAS_INT N, CBLAS_INT K, const void *alpha, const void *alphad, const void *A, void *Ad, CBLAS_INT lda, const void *beta, const void *betad, void *C, void *Cd, CBLAS_INT ldc, int nbdirs);
