/* Test program for cblas_ssyrk vector reverse mode (VJP verification, generic, loop over directions) */
...
int main(void) {
    ...
    cblas_ssyrk_bv(layout, uplo, trans, n, k, alpha, &alpha_b, A, &A_b[0][0], lda, beta, &beta_b, C, &C_b[0][0], ldc, nbdirs);
