/* Test program for cblas_dtbmv vector reverse mode (VJP verification, generic, loop over directions) */
...
int main(void) {
    ...
    cblas_dtbmv_bv(layout, uplo, transa, diag, n, k, A, &A_b[0][0], lda, X, X_b, incX, nbdirs);
