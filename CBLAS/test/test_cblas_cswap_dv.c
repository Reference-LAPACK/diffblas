/* Test program for cblas_cswap forward vector (dv) differentiation */
...
extern void cblas_cswap_dv(CBLAS_INT N, void *X, void *Xd, CBLAS_INT incX, void *Y, void *Yd, CBLAS_INT incY, int nbdirs);
