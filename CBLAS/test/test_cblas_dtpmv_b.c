/* Test program for cblas_dtpmv reverse mode (VJP verification, generic) */
...
extern void cblas_dtpmv_b(const CBLAS_LAYOUT layout, const CBLAS_UPLO Uplo, const CBLAS_TRANSPOSE TransA, const CBLAS_DIAG Diag, const CBLAS_INT N, const double *Ap, double *Ap_b, double *X, double *X_b, const CBLAS_INT incX);
...
int main(void) {
    ...
    cblas_dtpmv_b(layout, uplo, transa, diag, n, Ap, Ap_b, X, X_b, incX);
