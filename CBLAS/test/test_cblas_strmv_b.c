/* Test program for cblas_strmv reverse mode (VJP verification, generic) */
...
extern void cblas_strmv_b(const CBLAS_LAYOUT layout, const CBLAS_UPLO Uplo, const CBLAS_TRANSPOSE TransA, const CBLAS_DIAG Diag, const CBLAS_INT N, const float *A, float *A_b, const CBLAS_INT lda, float *X, float *X_b, const CBLAS_INT incX);
...
int main(void) {
    ...
    cblas_strmv_b(layout, uplo, transa, diag, n, A, A_b, lda, X, X_b, incX);
