/* Test program for cblas_sspr differentiation */
...
extern void cblas_sspr_d(const CBLAS_LAYOUT layout, const CBLAS_UPLO Uplo, const CBLAS_INT N, const float alpha, float alpha_d, const float *X, float *X_d, const CBLAS_INT incX, float *Ap, float *Ap_d);
