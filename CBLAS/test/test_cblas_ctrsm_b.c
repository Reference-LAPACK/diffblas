/* Test program for cblas_ctrsm reverse mode (VJP verification, generic) */
...
extern void cblas_ctrsm(const CBLAS_LAYOUT layout, const CBLAS_SIDE Side, const CBLAS_UPLO Uplo, const CBLAS_TRANSPOSE TransA, const CBLAS_DIAG Diag, const CBLAS_INT M, const CBLAS_INT N, const void *alpha, const void *A, const CBLAS_INT lda, void *B, const CBLAS_INT ldb);
extern void cblas_ctrsm_b(const CBLAS_LAYOUT layout, const CBLAS_SIDE Side, const CBLAS_UPLO Uplo, const CBLAS_TRANSPOSE TransA, const CBLAS_DIAG Diag, const CBLAS_INT M, const CBLAS_INT N, const void *alpha, void *alpha_b, const void *A, void *A_b, const CBLAS_INT lda, void *B, void *B_b, const CBLAS_INT ldb);
...
int main(void) {
    ...
    float complex B_plus[MAX_SIZE*MAX_SIZE], B_minus[MAX_SIZE*MAX_SIZE], B_central_diff[MAX_SIZE*MAX_SIZE], B_b_orig[MAX_SIZE*MAX_SIZE];
    ...
    cblas_ctrsm_b(layout, side, uplo, transa, diag, m, n, &alpha, alpha_b, A, A_b, lda, B, B_b, ldb);
