/* Test program for cblas_caxpy reverse mode (VJP verification, generic) */
...
extern void cblas_caxpy_b(const CBLAS_INT N, const void *alpha, void *alpha_b, const void *X, void *X_b, const CBLAS_INT incX, void *Y, void *Y_b, const CBLAS_INT incY);
...
int main(void) {
    ...
    cblas_caxpy_b(n, &alpha, alpha_b, X, X_b, incX, Y, Y_b, incY);
