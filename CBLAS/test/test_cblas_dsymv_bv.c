/* Test program for cblas_dsymv vector reverse mode (VJP verification, generic, loop over directions) */
...
int main(void) {
    ...
    cblas_dsymv_bv(layout, uplo, n, alpha, &alpha_b, A, &A_b[0][0], lda, X, X_b, incX, beta, &beta_b, Y, Y_b, incY, nbdirs);
