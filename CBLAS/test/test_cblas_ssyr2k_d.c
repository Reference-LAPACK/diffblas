/* Test program for cblas_ssyr2k differentiation */
...
extern void cblas_ssyr2k_d(const CBLAS_LAYOUT layout, const CBLAS_UPLO Uplo, const CBLAS_TRANSPOSE Trans, const CBLAS_INT N, const CBLAS_INT K, const float alpha, float alpha_d, const float *A, float *A_d, const CBLAS_INT lda, const float *B, float *B_d, const CBLAS_INT ldb, const float beta, float beta_d, float *C, float *C_d, const CBLAS_INT ldc);
