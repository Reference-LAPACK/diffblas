/* Test program for cblas_sasum differentiation */
...
extern float cblas_sasum_d(const CBLAS_INT N, const float *X, float *X_d, const CBLAS_INT incX, float *result);
