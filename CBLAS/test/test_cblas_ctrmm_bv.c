/* Test program for cblas_ctrmm vector reverse mode (VJP verification, generic, loop over directions) */
...
int main(void) {
    ...
    float complex B_plus[MAX_SIZE*MAX_SIZE], B_minus[MAX_SIZE*MAX_SIZE];
    ...
    cblas_ctrmm_bv(layout, side, uplo, transa, diag, m, n, &alpha, (void*)&alpha_b, A, (void*)A_b, lda, B, (void*)B_b, ldb, nbdirs);
