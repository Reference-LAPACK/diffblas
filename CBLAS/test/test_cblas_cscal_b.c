/* Test program for cblas_cscal reverse mode (VJP verification, generic) */
...
extern void cblas_cscal_b(const CBLAS_INT N, const void *alpha, void *alpha_b, void *X, void *X_b, const CBLAS_INT incX);
...
int main(void) {
    ...
    cblas_cscal_b(n, &alpha, alpha_b, X, X_b, incX);
