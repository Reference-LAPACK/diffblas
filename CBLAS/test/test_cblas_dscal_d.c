/* Test program for cblas_dscal differentiation */
...
extern void cblas_dscal_d(const CBLAS_INT N, const double alpha, double alpha_d, double *X, double *X_d, const CBLAS_INT incX);
