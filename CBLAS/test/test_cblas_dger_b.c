/* Test program for cblas_dger reverse mode (VJP verification, generic) */
...
extern void cblas_dger(const CBLAS_LAYOUT layout, const CBLAS_INT M, const CBLAS_INT N, const double alpha, const double *X, const CBLAS_INT incX, const double *Y, const CBLAS_INT incY, double *A, const CBLAS_INT lda);
extern void cblas_dger_b(const CBLAS_LAYOUT layout, const CBLAS_INT M, const CBLAS_INT N, const double alpha, double *alpha_b, const double *X, double *X_b, const CBLAS_INT incX, const double *Y, double *Y_b, const CBLAS_INT incY, double *A, double *A_b, const CBLAS_INT lda);
...
int main(void) {
    ...
    double A_plus[MAX_SIZE*MAX_SIZE], A_minus[MAX_SIZE*MAX_SIZE], A_central_diff[MAX_SIZE*MAX_SIZE], A_b_orig[MAX_SIZE*MAX_SIZE];
    ...
    cblas_dger_b(layout, m, n, alpha, &alpha_b, X, X_b, incX, Y, Y_b, incY, A, A_b, lda);
