/* Test program for cblas_dtpmv vector reverse mode (VJP verification, generic, loop over directions) */
...
int main(void) {
    ...
    cblas_dtpmv_bv(layout, uplo, transa, diag, n, Ap, Ap_b, X, X_b, incX, nbdirs);
