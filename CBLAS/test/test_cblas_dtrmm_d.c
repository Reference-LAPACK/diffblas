/* Test program for cblas_dtrmm differentiation */
...
extern void cblas_dtrmm_d(const CBLAS_LAYOUT layout, const CBLAS_SIDE Side, const CBLAS_UPLO Uplo, const CBLAS_TRANSPOSE TransA, const CBLAS_DIAG Diag, const CBLAS_INT M, const CBLAS_INT N, const double alpha, double alpha_d, const double *A, double *A_d, const CBLAS_INT lda, double *B, double *B_d, const CBLAS_INT ldb);
