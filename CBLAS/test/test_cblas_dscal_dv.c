/* Test program for cblas_dscal forward vector (dv) differentiation */
...
extern void cblas_dscal_dv(CBLAS_INT N, double alpha, double alphad[NBDirsMax], double *X, double (*Xd)[NBDirsMax], CBLAS_INT incX, int nbdirs);
