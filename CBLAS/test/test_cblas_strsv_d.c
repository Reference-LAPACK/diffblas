/* Test program for cblas_strsv differentiation */
...
extern void cblas_strsv_d(const CBLAS_LAYOUT layout, const CBLAS_UPLO Uplo, const CBLAS_TRANSPOSE TransA, const CBLAS_DIAG Diag, const CBLAS_INT N, const float *A, float *A_d, const CBLAS_INT lda, float *X, float *X_d, const CBLAS_INT incX);
