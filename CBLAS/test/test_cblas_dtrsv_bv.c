/* Test program for cblas_dtrsv vector reverse mode (VJP verification, generic, loop over directions) */
...
int main(void) {
    ...
    double X_plus[MAX_SIZE], X_minus[MAX_SIZE];
    ...
    cblas_dtrsv_bv(layout, uplo, transa, diag, n, A, &A_b[0][0], lda, X, X_b, incX, nbdirs);
