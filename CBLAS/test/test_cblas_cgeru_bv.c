/* Test program for cblas_cgeru vector reverse mode (VJP verification, generic, loop over directions) */
...
int main(void) {
    ...
    cblas_cgeru_bv(layout, m, n, &alpha, (void*)&alpha_b, X, (void*)X_b, incX, Y, (void*)Y_b, incY, A, (void*)A_b, lda, nbdirs);
