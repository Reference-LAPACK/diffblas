/* Test program for cblas_dtrsv forward vector (dv) differentiation */
...
extern void cblas_dtrsv_dv(CBLAS_LAYOUT layout, CBLAS_UPLO Uplo, CBLAS_TRANSPOSE TransA, CBLAS_DIAG Diag, CBLAS_INT N, const double *A, double (*Ad)[NBDirsMax], CBLAS_INT lda, double *X, double (*Xd)[NBDirsMax], CBLAS_INT incX, int nbdirs);
