/* Test program for cblas_sasum reverse mode (VJP verification, generic) */
...
extern float cblas_sasum(const CBLAS_INT N, const float *X, const CBLAS_INT incX);
extern void cblas_sasum_b(const CBLAS_INT N, const float *X, float *X_b, const CBLAS_INT incX);
