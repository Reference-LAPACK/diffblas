/* Test program for cblas_ddot reverse mode (VJP verification, generic) */
...
extern double cblas_ddot(const CBLAS_INT N, const double *X, const CBLAS_INT incX, const double *Y, const CBLAS_INT incY);
extern void cblas_ddot_b(const CBLAS_INT N, const double *X, double *X_b, const CBLAS_INT incX, const double *Y, double *Y_b, const CBLAS_INT incY);
...
int main(void) {
    ...
    cblas_ddot_b(n, X, X_b, incX, Y, Y_b, incY);
