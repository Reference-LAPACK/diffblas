/* Test program for cblas_ssbmv vector reverse mode (VJP verification, generic, loop over directions) */
...
int main(void) {
    ...
    cblas_ssbmv_bv(layout, uplo, n, k, alpha, &alpha_b, A, &A_b[0][0], lda, X, X_b, incX, beta, &beta_b, Y, Y_b, incY, nbdirs);
