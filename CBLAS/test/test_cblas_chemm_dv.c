/* Test program for cblas_chemm forward vector (dv) differentiation */
...
extern void cblas_chemm_dv(CBLAS_LAYOUT layout, CBLAS_SIDE Side, CBLAS_UPLO Uplo, CBLAS_INT M, CBLAS_INT N, const void *alpha, const void *alphad, const void *A, void *Ad, CBLAS_INT lda, const void *B, void *Bd, CBLAS_INT ldb, const void *beta, const void *betad, void *C, void *Cd, CBLAS_INT ldc, int nbdirs);
...
int main(void) {
    ...
    float complex Cd[MAX_SIZE * MAX_SIZE][NBDirsMax];
    float complex C_orig[MAX_SIZE * MAX_SIZE];
    float complex Cd_orig[MAX_SIZE * MAX_SIZE][NBDirsMax];
