/* Test program for cblas_strsm reverse mode (VJP verification, generic) */
...
extern void cblas_strsm(const CBLAS_LAYOUT layout, const CBLAS_SIDE Side, const CBLAS_UPLO Uplo, const CBLAS_TRANSPOSE TransA, const CBLAS_DIAG Diag, const CBLAS_INT M, const CBLAS_INT N, const float alpha, const float *A, const CBLAS_INT lda, float *B, const CBLAS_INT ldb);
extern void cblas_strsm_b(const CBLAS_LAYOUT layout, const CBLAS_SIDE Side, const CBLAS_UPLO Uplo, const CBLAS_TRANSPOSE TransA, const CBLAS_DIAG Diag, const CBLAS_INT M, const CBLAS_INT N, const float alpha, float *alpha_b, const float *A, float *A_b, const CBLAS_INT lda, float *B, float *B_b, const CBLAS_INT ldb);
...
int main(void) {
    ...
    cblas_strsm_b(layout, side, uplo, transa, diag, m, n, alpha, &alpha_b, A, A_b, lda, B, B_b, ldb);
