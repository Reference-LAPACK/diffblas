/* Test program for cblas_dspr2 differentiation */
...
extern void cblas_dspr2_d(const CBLAS_LAYOUT layout, const CBLAS_UPLO Uplo, const CBLAS_INT N, const double alpha, double alpha_d, const double *X, double *X_d, const CBLAS_INT incX, const double *Y, double *Y_d, const CBLAS_INT incY, double *A, double *A_d);
...
int main(void) {
    ...
    double A_d[PACKED_SIZE];  /* Derivative seeds */
    double A_d_orig[PACKED_SIZE];
