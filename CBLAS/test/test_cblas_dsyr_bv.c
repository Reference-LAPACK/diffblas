/* Test program for cblas_dsyr vector reverse mode (VJP verification, generic, loop over directions) */
...
int main(void) {
    ...
    cblas_dsyr_bv(layout, uplo, n, alpha, &alpha_b, X, X_b, incX, A, &A_b[0][0], lda, nbdirs);
