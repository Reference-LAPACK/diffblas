/* Test program for cblas_ztrsv forward vector (dv) differentiation */
...
extern void cblas_ztrsv_dv(CBLAS_LAYOUT layout, CBLAS_UPLO Uplo, CBLAS_TRANSPOSE TransA, CBLAS_DIAG Diag, CBLAS_INT N, const void *A, void *Ad, CBLAS_INT lda, void *X, void *Xd, CBLAS_INT incX, int nbdirs);
