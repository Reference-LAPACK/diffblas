/* Test program for cblas_dtrmm reverse mode (VJP verification, generic) */
...
extern void cblas_dtrmm(const CBLAS_LAYOUT layout, const CBLAS_SIDE Side, const CBLAS_UPLO Uplo, const CBLAS_TRANSPOSE TransA, const CBLAS_DIAG Diag, const CBLAS_INT M, const CBLAS_INT N, const double alpha, const double *A, const CBLAS_INT lda, double *B, const CBLAS_INT ldb);
extern void cblas_dtrmm_b(const CBLAS_LAYOUT layout, const CBLAS_SIDE Side, const CBLAS_UPLO Uplo, const CBLAS_TRANSPOSE TransA, const CBLAS_DIAG Diag, const CBLAS_INT M, const CBLAS_INT N, const double alpha, double *alpha_b, const double *A, double *A_b, const CBLAS_INT lda, double *B, double *B_b, const CBLAS_INT ldb);
...
int main(void) {
    ...
    double B_plus[MAX_SIZE*MAX_SIZE], B_minus[MAX_SIZE*MAX_SIZE], B_central_diff[MAX_SIZE*MAX_SIZE], B_b_orig[MAX_SIZE*MAX_SIZE];
    ...
    cblas_dtrmm_b(layout, side, uplo, transa, diag, m, n, alpha, &alpha_b, A, A_b, lda, B, B_b, ldb);
