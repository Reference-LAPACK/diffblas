/* Test program for cblas_dsyr2 forward vector (dv) differentiation */
...
extern void cblas_dsyr2_dv(CBLAS_LAYOUT layout, CBLAS_UPLO Uplo, CBLAS_INT N, double alpha, double alphad[NBDirsMax], const double *X, double (*Xd)[NBDirsMax], CBLAS_INT incX, const double *Y, double (*Yd)[NBDirsMax], CBLAS_INT incY, double *A, double (*Ad)[NBDirsMax], CBLAS_INT lda, int nbdirs);
