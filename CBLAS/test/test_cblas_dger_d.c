/* Test program for cblas_dger differentiation */
...
extern void cblas_dger_d(const CBLAS_LAYOUT layout, const CBLAS_INT M, const CBLAS_INT N, const double alpha, double alpha_d, const double *X, double *X_d, const CBLAS_INT incX, const double *Y, double *Y_d, const CBLAS_INT incY, double *A, double *A_d, const CBLAS_INT lda);
