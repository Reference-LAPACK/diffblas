/* Test program for cblas_dscal reverse mode (VJP verification, generic) */
...
extern void cblas_dscal(const CBLAS_INT N, const double alpha, double *X, const CBLAS_INT incX);
extern void cblas_dscal_b(const CBLAS_INT N, const double alpha, double *alpha_b, double *X, double *X_b, const CBLAS_INT incX);
...
int main(void) {
    ...
    cblas_dscal_b(n, alpha, &alpha_b, X, X_b, incX);
