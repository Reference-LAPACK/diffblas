/* Test program for cblas_cscal forward vector (dv) differentiation */
...
extern void cblas_cscal_dv(CBLAS_INT N, const void *alpha, const void *alphad, void *X, void *Xd, CBLAS_INT incX, int nbdirs);
