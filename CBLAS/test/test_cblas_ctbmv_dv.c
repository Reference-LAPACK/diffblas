/* Test program for cblas_ctbmv forward vector (dv) differentiation */
...
extern void cblas_ctbmv_dv(CBLAS_LAYOUT layout, CBLAS_UPLO Uplo, CBLAS_TRANSPOSE TransA, CBLAS_DIAG Diag, CBLAS_INT N, CBLAS_INT K, const void *A, void *Ad, CBLAS_INT lda, void *X, void *Xd, CBLAS_INT incX, int nbdirs);
