/* Test program for cblas_ssymm reverse mode (VJP verification, generic) */
...
extern void cblas_ssymm(const CBLAS_LAYOUT layout, const CBLAS_SIDE Side, const CBLAS_UPLO Uplo, const CBLAS_INT M, const CBLAS_INT N, const float alpha, const float *A, const CBLAS_INT lda, const float *B, const CBLAS_INT ldb, const float beta, float *C, const CBLAS_INT ldc);
extern void cblas_ssymm_b(const CBLAS_LAYOUT layout, const CBLAS_SIDE Side, const CBLAS_UPLO Uplo, const CBLAS_INT M, const CBLAS_INT N, const float alpha, float *alpha_b, const float *A, float *A_b, const CBLAS_INT lda, const float *B, float *B_b, const CBLAS_INT ldb, const float beta, float *beta_b, float *C, float *C_b, const CBLAS_INT ldc);
...
int main(void) {
    ...
    float beta, beta_b, beta_orig, beta_dir;
    float C[MAX_SIZE*MAX_SIZE], C_b[MAX_SIZE*MAX_SIZE], C_orig[MAX_SIZE*MAX_SIZE], C_dir[MAX_SIZE*MAX_SIZE];
    float C_plus[MAX_SIZE*MAX_SIZE], C_minus[MAX_SIZE*MAX_SIZE], C_central_diff[MAX_SIZE*MAX_SIZE], C_b_orig[MAX_SIZE*MAX_SIZE];
    ...
    cblas_ssymm_b(layout, side, uplo, m, n, alpha, &alpha_b, A, A_b, lda, B, B_b, ldb, beta, &beta_b, C, C_b, ldc);
