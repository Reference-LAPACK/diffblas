/* Test program for cblas_csymm vector reverse mode (VJP verification, generic, loop over directions) */
...
int main(void) {
    ...
    cblas_csymm_bv(layout, side, uplo, m, n, &alpha, (void*)&alpha_b, A, (void*)A_b, lda, B, (void*)B_b, ldb, &beta, (void*)&beta_b, C, (void*)C_b, ldc, nbdirs);
