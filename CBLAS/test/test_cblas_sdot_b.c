/* Test program for cblas_sdot reverse mode (VJP verification, generic) */
...
extern float cblas_sdot(const CBLAS_INT N, const float *X, const CBLAS_INT incX, const float *Y, const CBLAS_INT incY);
extern void cblas_sdot_b(const CBLAS_INT N, const float *X, float *X_b, const CBLAS_INT incX, const float *Y, float *Y_b, const CBLAS_INT incY);
...
int main(void) {
    ...
    cblas_sdot_b(n, X, X_b, incX, Y, Y_b, incY);
