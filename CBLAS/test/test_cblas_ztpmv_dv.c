/* Test program for cblas_ztpmv forward vector (dv) differentiation */
...
extern void cblas_ztpmv_dv(CBLAS_LAYOUT layout, CBLAS_UPLO Uplo, CBLAS_TRANSPOSE TransA, CBLAS_DIAG Diag, CBLAS_INT N, const void *Ap, void *Apd, void *X, void *Xd, CBLAS_INT incX, int nbdirs);
...
int main(void) {
    ...
    double complex Apd[PACKED_SIZE][NBDirsMax];
    double complex Ap_orig[PACKED_SIZE];
    double complex Apd_orig[PACKED_SIZE][NBDirsMax];
