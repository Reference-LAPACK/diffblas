/* Test program for cblas_zcopy reverse mode (VJP verification, generic) */
...
extern void cblas_zcopy_b(const CBLAS_INT N, const void *X, void *X_b, const CBLAS_INT incX, void *Y, void *Y_b, const CBLAS_INT incY);
...
int main(void) {
    ...
    cblas_zcopy_b(n, X, X_b, incX, Y, Y_b, incY);
