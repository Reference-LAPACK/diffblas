/* Test program for cblas_dsymm reverse mode (VJP verification, generic) */
...
extern void cblas_dsymm_b(const CBLAS_LAYOUT layout, const CBLAS_SIDE Side, const CBLAS_UPLO Uplo, const CBLAS_INT M, const CBLAS_INT N, const double alpha, double *alpha_b, const double *A, double *A_b, const CBLAS_INT lda, const double *B, double *B_b, const CBLAS_INT ldb, const double beta, double *beta_b, double *C, double *C_b, const CBLAS_INT ldc);
...
int main(void) {
    ...
    cblas_dsymm_b(layout, side, uplo, m, n, alpha, &alpha_b, A, A_b, lda, B, B_b, ldb, beta, &beta_b, C, C_b, ldc);
