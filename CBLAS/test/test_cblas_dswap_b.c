/* Test program for cblas_dswap reverse mode (VJP verification, generic) */
...
extern void cblas_dswap_b(const CBLAS_INT N, double *X, double *X_b, const CBLAS_INT incX, double *Y, double *Y_b, const CBLAS_INT incY);
...
int main(void) {
    ...
    cblas_dswap_b(n, X, X_b, incX, Y, Y_b, incY);
