/* Test program for cblas_ssbmv reverse mode (VJP verification, generic) */
...
extern void cblas_ssbmv(const CBLAS_LAYOUT layout, const CBLAS_UPLO Uplo, const CBLAS_INT N, const CBLAS_INT K, const float alpha, const float *A, const CBLAS_INT lda, const float *X, const CBLAS_INT incX, const float beta, float *Y, const CBLAS_INT incY);
extern void cblas_ssbmv_b(const CBLAS_LAYOUT layout, const CBLAS_UPLO Uplo, const CBLAS_INT N, const CBLAS_INT K, const float alpha, float *alpha_b, const float *A, float *A_b, const CBLAS_INT lda, const float *X, float *X_b, const CBLAS_INT incX, const float beta, float *beta_b, float *Y, float *Y_b, const CBLAS_INT incY);
...
int main(void) {
    ...
    float Y_plus[MAX_SIZE], Y_minus[MAX_SIZE], Y_central_diff[MAX_SIZE], Y_b_orig[MAX_SIZE];
    ...
    cblas_ssbmv_b(layout, uplo, n, k, alpha, &alpha_b, A, A_b, lda, X, X_b, incX, beta, &beta_b, Y, Y_b, incY);
