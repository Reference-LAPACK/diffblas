/* Test program for cblas_dgemm forward vector (dv) differentiation */
...
extern void cblas_dgemm_dv(CBLAS_LAYOUT layout, CBLAS_TRANSPOSE TransA, CBLAS_TRANSPOSE TransB, CBLAS_INT M, CBLAS_INT N, CBLAS_INT K, double alpha, double alphad[NBDirsMax], const double *A, double (*Ad)[NBDirsMax], CBLAS_INT lda, const double *B, double (*Bd)[NBDirsMax], CBLAS_INT ldb, double beta, double betad[NBDirsMax], double *C, double (*Cd)[NBDirsMax], CBLAS_INT ldc, int nbdirs);
