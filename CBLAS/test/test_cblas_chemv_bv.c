/* Test program for cblas_chemv vector reverse mode (VJP verification, generic, loop over directions) */
...
extern void cblas_chemv(const CBLAS_LAYOUT layout, const CBLAS_UPLO Uplo, const CBLAS_INT N, const void *alpha, const void *A, const CBLAS_INT lda, const void *X, const CBLAS_INT incX, const void *beta, void *Y, const CBLAS_INT incY);
...
int main(void) {
    ...
    cblas_chemv_bv(layout, uplo, n, &alpha, (void*)&alpha_b, A, (void*)A_b, lda, X, (void*)X_b, incX, &beta, (void*)&beta_b, Y, (void*)Y_b, incY, nbdirs);
