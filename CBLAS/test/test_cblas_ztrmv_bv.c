/* Test program for cblas_ztrmv vector reverse mode (VJP verification, generic, loop over directions) */
...
int main(void) {
    ...
    cblas_ztrmv_bv(layout, uplo, transa, diag, n, A, (void*)A_b, lda, X, (void*)X_b, incX, nbdirs);
