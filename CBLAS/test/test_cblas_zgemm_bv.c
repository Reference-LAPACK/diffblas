/* Test program for cblas_zgemm vector reverse mode (VJP verification, loop over directions) */
...
int main(void) {
    ...
    double complex alpha_b[NBDirsMax], beta_b[NBDirsMax];
    double complex A[MAT_SIZE], B[MAT_SIZE], C[MAT_SIZE];
    double complex A_b[MAT_SIZE*NBDirsMax], B_b[MAT_SIZE*NBDirsMax], C_b[MAT_SIZE*NBDirsMax];  /* layout: element then direction */
    double complex A_dir[MAT_SIZE], B_dir[MAT_SIZE], C_dir[MAT_SIZE];
    double complex C_forward[MAT_SIZE], C_backward[MAT_SIZE];
    double complex C_b_orig[MAT_SIZE*NBDirsMax];  /* save cotangents for all directions (like BLAS cb_orig) */
    double complex alpha_orig, beta_orig, alpha_dir, beta_dir;
    double complex A_orig[MAT_SIZE], B_orig[MAT_SIZE], C_orig[MAT_SIZE];
    ...
    cblas_zgemm_bv(CblasColMajor, CblasNoTrans, CblasNoTrans, m, n, k,
