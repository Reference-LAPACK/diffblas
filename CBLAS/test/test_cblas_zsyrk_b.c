/* Test program for cblas_zsyrk reverse mode (VJP verification, generic) */
...
extern void cblas_zsyrk_b(const CBLAS_LAYOUT layout, const CBLAS_UPLO Uplo, const CBLAS_TRANSPOSE Trans, const CBLAS_INT N, const CBLAS_INT K, const void *alpha, void *alpha_b, const void *A, void *A_b, const CBLAS_INT lda, const void *beta, void *beta_b, void *C, void *C_b, const CBLAS_INT ldc);
...
int main(void) {
    ...
    cblas_zsyrk_b(layout, uplo, trans, n, k, &alpha, alpha_b, A, A_b, lda, &beta, beta_b, C, C_b, ldc);
