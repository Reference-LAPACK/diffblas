/* Test program for cblas_sscal differentiation */
...
extern void cblas_sscal_d(const CBLAS_INT N, const float alpha, float alpha_d, float *X, float *X_d, const CBLAS_INT incX);
