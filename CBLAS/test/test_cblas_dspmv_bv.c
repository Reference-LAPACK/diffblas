/* Test program for cblas_dspmv vector reverse mode (VJP verification, generic, loop over directions) */
...
int main(void) {
    ...
    cblas_dspmv_bv(layout, uplo, n, alpha, &alpha_b, AP, AP_b, X, X_b, incX, beta, &beta_b, Y, Y_b, incY, nbdirs);
