/* Test program for cblas_zhemm forward vector (dv) differentiation */
...
extern void cblas_zhemm_dv(CBLAS_LAYOUT layout, CBLAS_SIDE Side, CBLAS_UPLO Uplo, CBLAS_INT M, CBLAS_INT N, const void *alpha, const void *alphad, const void *A, void *Ad, CBLAS_INT lda, const void *B, void *Bd, CBLAS_INT ldb, const void *beta, const void *betad, void *C, void *Cd, CBLAS_INT ldc, int nbdirs);
...
int main(void) {
    ...
    double complex Bd[MAX_SIZE * MAX_SIZE][NBDirsMax];
    double complex B_orig[MAX_SIZE * MAX_SIZE];
    double complex Bd_orig[MAX_SIZE * MAX_SIZE][NBDirsMax];
