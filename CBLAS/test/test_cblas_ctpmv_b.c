/* Test program for cblas_ctpmv reverse mode (VJP verification, generic) */
...
extern void cblas_ctpmv_b(const CBLAS_LAYOUT layout, const CBLAS_UPLO Uplo, const CBLAS_TRANSPOSE TransA, const CBLAS_DIAG Diag, const CBLAS_INT N, const void *Ap, void *Ap_b, void *X, void *X_b, const CBLAS_INT incX);
...
int main(void) {
    ...
    float complex Ap[PACKED_SIZE], Ap_b[PACKED_SIZE], Ap_orig[PACKED_SIZE], Ap_dir[PACKED_SIZE];
    ...
    cblas_ctpmv_b(layout, uplo, transa, diag, n, Ap, Ap_b, X, X_b, incX);
