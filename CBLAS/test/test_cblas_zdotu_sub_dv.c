/* Test program for cblas_zdotu_sub forward vector (dv) differentiation */
...
extern void cblas_zdotu_sub_dv(CBLAS_INT N, const void *X, void *Xd, CBLAS_INT incX, const void *Y, void *Yd, CBLAS_INT incY, void *dot, void *dotd, int nbdirs);
