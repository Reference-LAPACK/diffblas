/* Test program for cblas_dsyrk vector reverse mode (VJP verification, generic, loop over directions) */
...
int main(void) {
    ...
    cblas_dsyrk_bv(layout, uplo, trans, n, k, alpha, &alpha_b, A, A_b, lda, beta, &beta_b, C, &C_b[0][0], ldc, nbdirs);
