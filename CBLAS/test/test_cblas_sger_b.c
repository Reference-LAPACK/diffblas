/* Test program for cblas_sger reverse mode (VJP verification, generic) */
...
extern void cblas_sger(const CBLAS_LAYOUT layout, const CBLAS_INT M, const CBLAS_INT N, const float alpha, const float *X, const CBLAS_INT incX, const float *Y, const CBLAS_INT incY, float *A, const CBLAS_INT lda);
extern void cblas_sger_b(const CBLAS_LAYOUT layout, const CBLAS_INT M, const CBLAS_INT N, const float alpha, float *alpha_b, const float *X, float *X_b, const CBLAS_INT incX, const float *Y, float *Y_b, const CBLAS_INT incY, float *A, float *A_b, const CBLAS_INT lda);
...
int main(void) {
    ...
    cblas_sger_b(layout, m, n, alpha, &alpha_b, X, X_b, incX, Y, Y_b, incY, A, A_b, lda);
