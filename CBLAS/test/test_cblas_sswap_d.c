/* Test program for cblas_sswap differentiation */
...
extern void cblas_sswap_d(const CBLAS_INT N, float *X, float *X_d, const CBLAS_INT incX, float *Y, float *Y_d, const CBLAS_INT incY);
