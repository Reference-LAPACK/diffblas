/* Test program for cblas_dsyr2k differentiation */
...
extern void cblas_dsyr2k_d(const CBLAS_LAYOUT layout, const CBLAS_UPLO Uplo, const CBLAS_TRANSPOSE Trans, const CBLAS_INT N, const CBLAS_INT K, const double alpha, double alpha_d, const double *A, double *A_d, const CBLAS_INT lda, const double *B, double *B_d, const CBLAS_INT ldb, const double beta, double beta_d, double *C, double *C_d, const CBLAS_INT ldc);
