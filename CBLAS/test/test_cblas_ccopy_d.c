/* Test program for cblas_ccopy differentiation */
...
extern void cblas_ccopy_d(const CBLAS_INT N, const void *X, void *X_d, const CBLAS_INT incX, void *Y, void *Y_d, const CBLAS_INT incY);
