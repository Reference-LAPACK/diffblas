/* Test program for cblas_dsyr reverse mode (VJP verification, generic) */
...
extern void cblas_dsyr(const CBLAS_LAYOUT layout, const CBLAS_UPLO Uplo, const CBLAS_INT N, const double alpha, const double *X, const CBLAS_INT incX, double *A, const CBLAS_INT lda);
extern void cblas_dsyr_b(const CBLAS_LAYOUT layout, const CBLAS_UPLO Uplo, const CBLAS_INT N, const double alpha, double *alpha_b, const double *X, double *X_b, const CBLAS_INT incX, double *A, double *A_b, const CBLAS_INT lda);
...
int main(void) {
    ...
    cblas_dsyr_b(layout, uplo, n, alpha, &alpha_b, X, X_b, incX, A, A_b, lda);
