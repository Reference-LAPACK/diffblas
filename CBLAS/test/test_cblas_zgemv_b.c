/* Test program for cblas_zgemv reverse mode (VJP verification, generic) */
...
extern void cblas_zgemv_b(const CBLAS_LAYOUT layout, const CBLAS_TRANSPOSE TransA, const CBLAS_INT M, const CBLAS_INT N, const void *alpha, void *alpha_b, const void *A, void *A_b, const CBLAS_INT lda, const void *X, void *X_b, const CBLAS_INT incX, const void *beta, void *beta_b, void *Y, void *Y_b, const CBLAS_INT incY);
...
int main(void) {
    ...
    cblas_zgemv_b(layout, transa, m, n, &alpha, alpha_b, A, A_b, lda, X, X_b, incX, &beta, beta_b, Y, Y_b, incY);
