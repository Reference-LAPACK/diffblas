/* Test program for cblas_stbmv reverse mode (VJP verification, generic) */
...
extern void cblas_stbmv(const CBLAS_LAYOUT layout, const CBLAS_UPLO Uplo, const CBLAS_TRANSPOSE TransA, const CBLAS_DIAG Diag, const CBLAS_INT N, const CBLAS_INT K, const float *A, const CBLAS_INT lda, float *X, const CBLAS_INT incX);
extern void cblas_stbmv_b(const CBLAS_LAYOUT layout, const CBLAS_UPLO Uplo, const CBLAS_TRANSPOSE TransA, const CBLAS_DIAG Diag, const CBLAS_INT N, const CBLAS_INT K, const float *A, float *A_b, const CBLAS_INT lda, float *X, float *X_b, const CBLAS_INT incX);
...
int main(void) {
    ...
    cblas_stbmv_b(layout, uplo, transa, diag, n, k, A, A_b, lda, X, X_b, incX);
