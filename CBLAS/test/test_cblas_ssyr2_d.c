/* Test program for cblas_ssyr2 differentiation */
...
extern void cblas_ssyr2_d(const CBLAS_LAYOUT layout, const CBLAS_UPLO Uplo, const CBLAS_INT N, const float alpha, float alpha_d, const float *X, float *X_d, const CBLAS_INT incX, const float *Y, float *Y_d, const CBLAS_INT incY, float *A, float *A_d, const CBLAS_INT lda);
