/* Test program for cblas_dsyr differentiation */
...
extern void cblas_dsyr_d(const CBLAS_LAYOUT layout, const CBLAS_UPLO Uplo, const CBLAS_INT N, const double alpha, double alpha_d, const double *X, double *X_d, const CBLAS_INT incX, double *A, double *A_d, const CBLAS_INT lda);
