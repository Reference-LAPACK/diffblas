/* Test program for cblas_scopy differentiation */
...
extern void cblas_scopy_d(const CBLAS_INT N, const float *X, float *X_d, const CBLAS_INT incX, float *Y, float *Y_d, const CBLAS_INT incY);
