/* Test program for cblas_dsbmv forward vector (dv) differentiation */
...
extern void cblas_dsbmv_dv(CBLAS_LAYOUT layout, CBLAS_UPLO Uplo, CBLAS_INT N, CBLAS_INT K, double alpha, double alphad[NBDirsMax], const double *A, double (*Ad)[NBDirsMax], CBLAS_INT lda, const double *X, double (*Xd)[NBDirsMax], CBLAS_INT incX, double beta, double betad[NBDirsMax], double *Y, double (*Yd)[NBDirsMax], CBLAS_INT incY, int nbdirs);
