/* Test program for cblas_zgemm differentiation */
...
extern void cblas_zgemm_d(const CBLAS_LAYOUT layout, const CBLAS_TRANSPOSE TransA, const CBLAS_TRANSPOSE TransB, const CBLAS_INT M, const CBLAS_INT N, const CBLAS_INT K, const void *alpha, void *alpha_d, const void *A, void *A_d, const CBLAS_INT lda, const void *B, void *B_d, const CBLAS_INT ldb, const void *beta, void *beta_d, void *C, void *C_d, const CBLAS_INT ldc);
