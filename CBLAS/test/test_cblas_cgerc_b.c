/* Test program for cblas_cgerc reverse mode (VJP verification, generic) */
...
extern void cblas_cgerc_b(const CBLAS_LAYOUT layout, const CBLAS_INT M, const CBLAS_INT N, const void *alpha, void *alpha_b, const void *X, void *X_b, const CBLAS_INT incX, const void *Y, void *Y_b, const CBLAS_INT incY, void *A, void *A_b, const CBLAS_INT lda);
...
int main(void) {
    ...
    cblas_cgerc_b(layout, m, n, &alpha, alpha_b, X, X_b, incX, Y, Y_b, incY, A, A_b, lda);
