/* Test program for cblas_strsv vector reverse mode (VJP verification, generic, loop over directions) */
...
extern void cblas_strsv(const CBLAS_LAYOUT layout, const CBLAS_UPLO Uplo, const CBLAS_TRANSPOSE TransA, const CBLAS_DIAG Diag, const CBLAS_INT N, const float *A, const CBLAS_INT lda, float *X, const CBLAS_INT incX);
...
int main(void) {
    ...
    cblas_strsv_bv(layout, uplo, transa, diag, n, A, &A_b[0][0], lda, X, X_b, incX, nbdirs);
