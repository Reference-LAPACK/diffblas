/* Test program for cblas_dnrm2 differentiation */
...
/* Original function */
extern double cblas_dnrm2(const CBLAS_INT N, const double *X, const CBLAS_INT incX);
/* Differentiated function */
extern double cblas_dnrm2_d(const CBLAS_INT N, const double *X, double *X_d, const CBLAS_INT incX, double *result);
