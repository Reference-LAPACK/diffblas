/* Test program for cblas_cscal vector reverse mode (VJP verification, generic, loop over directions) */
...
int main(void) {
    ...
    cblas_cscal_bv(n, &alpha, (void*)&alpha_b, X, (void*)X_b, incX, nbdirs);
