/* Test program for cblas_sgemv reverse mode (VJP verification, generic) */
...
extern void cblas_sgemv(const CBLAS_LAYOUT layout, const CBLAS_TRANSPOSE TransA, const CBLAS_INT M, const CBLAS_INT N, const float alpha, const float *A, const CBLAS_INT lda, const float *X, const CBLAS_INT incX, const float beta, float *Y, const CBLAS_INT incY);
extern void cblas_sgemv_b(const CBLAS_LAYOUT layout, const CBLAS_TRANSPOSE TransA, const CBLAS_INT M, const CBLAS_INT N, const float alpha, float *alpha_b, const float *A, float *A_b, const CBLAS_INT lda, const float *X, float *X_b, const CBLAS_INT incX, const float beta, float *beta_b, float *Y, float *Y_b, const CBLAS_INT incY);
...
int main(void) {
    ...
    cblas_sgemv_b(layout, transa, m, n, alpha, &alpha_b, A, A_b, lda, X, X_b, incX, beta, &beta_b, Y, Y_b, incY);
