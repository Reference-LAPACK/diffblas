/* Test program for cblas_ctbmv vector reverse mode (VJP verification, generic, loop over directions) */
...
extern void cblas_ctbmv(const CBLAS_LAYOUT layout, const CBLAS_UPLO Uplo, const CBLAS_TRANSPOSE TransA, const CBLAS_DIAG Diag, const CBLAS_INT N, const CBLAS_INT K, const void *A, const CBLAS_INT lda, void *X, const CBLAS_INT incX);
...
int main(void) {
    ...
    cblas_ctbmv_bv(layout, uplo, transa, diag, n, k, A, (void*)A_b, lda, X, (void*)X_b, incX, nbdirs);
    ...
    for (idir = 0; idir < nbdirs; idir++) {
        ...
        cblas_ctbmv(layout, uplo, transa, diag, n, k, A, lda, X, incX);
