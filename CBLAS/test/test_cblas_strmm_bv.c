/* Test program for cblas_strmm vector reverse mode (VJP verification, generic, loop over directions) */
...
int main(void) {
    ...
    cblas_strmm_bv(layout, side, uplo, transa, diag, m, n, alpha, &alpha_b, A, &A_b[0][0], lda, B, &B_b[0][0], ldb, nbdirs);
