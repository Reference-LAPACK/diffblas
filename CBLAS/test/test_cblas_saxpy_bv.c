/* Test program for cblas_saxpy vector reverse mode (VJP verification, generic, loop over directions) */
...
int main(void) {
    ...
    cblas_saxpy_bv(n, alpha, &alpha_b, X, X_b, incX, Y, Y_b, incY, nbdirs);
