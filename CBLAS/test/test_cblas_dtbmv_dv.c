/* Test program for cblas_dtbmv forward vector (dv) differentiation */
...
extern void cblas_dtbmv_dv(CBLAS_LAYOUT layout, CBLAS_UPLO Uplo, CBLAS_TRANSPOSE TransA, CBLAS_DIAG Diag, CBLAS_INT N, CBLAS_INT K, const double *A, double (*Ad)[NBDirsMax], CBLAS_INT lda, double *X, double (*Xd)[NBDirsMax], CBLAS_INT incX, int nbdirs);
