/* Test program for cblas_dspmv differentiation */
...
extern void cblas_dspmv_d(const CBLAS_LAYOUT layout, const CBLAS_UPLO Uplo, const CBLAS_INT N, const double alpha, double alpha_d, const double *AP, double *AP_d, const double *X, double *X_d, const CBLAS_INT incX, const double beta, double beta_d, double *Y, double *Y_d, const CBLAS_INT incY);
