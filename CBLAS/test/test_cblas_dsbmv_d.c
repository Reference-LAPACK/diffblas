/* Test program for cblas_dsbmv differentiation */
...
extern void cblas_dsbmv_d(const CBLAS_LAYOUT layout, const CBLAS_UPLO Uplo, const CBLAS_INT N, const CBLAS_INT K, const double alpha, double alpha_d, const double *A, double *A_d, const CBLAS_INT lda, const double *X, double *X_d, const CBLAS_INT incX, const double beta, double beta_d, double *Y, double *Y_d, const CBLAS_INT incY);
