/* Test program for cblas_zsyr2k reverse mode (VJP verification, generic) */
...
extern void cblas_zsyr2k(const CBLAS_LAYOUT layout, const CBLAS_UPLO Uplo, const CBLAS_TRANSPOSE Trans, const CBLAS_INT N, const CBLAS_INT K, const void *alpha, const void *A, const CBLAS_INT lda, const void *B, const CBLAS_INT ldb, const void *beta, void *C, const CBLAS_INT ldc);
extern void cblas_zsyr2k_b(const CBLAS_LAYOUT layout, const CBLAS_UPLO Uplo, const CBLAS_TRANSPOSE Trans, const CBLAS_INT N, const CBLAS_INT K, const void *alpha, void *alpha_b, const void *A, void *A_b, const CBLAS_INT lda, const void *B, void *B_b, const CBLAS_INT ldb, const void *beta, void *beta_b, void *C, void *C_b, const CBLAS_INT ldc);
...
int main(void) {
    ...
    cblas_zsyr2k_b(layout, uplo, trans, n, k, &alpha, alpha_b, A, A_b, lda, B, B_b, ldb, &beta, beta_b, C, C_b, ldc);
