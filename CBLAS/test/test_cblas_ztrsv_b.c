/* Test program for cblas_ztrsv reverse mode (VJP verification, generic) */
...
extern void cblas_ztrsv_b(const CBLAS_LAYOUT layout, const CBLAS_UPLO Uplo, const CBLAS_TRANSPOSE TransA, const CBLAS_DIAG Diag, const CBLAS_INT N, const void *A, void *A_b, const CBLAS_INT lda, void *X, void *X_b, const CBLAS_INT incX);
...
int main(void) {
    ...
    cblas_ztrsv_b(layout, uplo, transa, diag, n, A, A_b, lda, X, X_b, incX);
