/* Test program for cblas_scopy reverse mode (VJP verification, generic) */
...
extern void cblas_scopy(const CBLAS_INT N, const float *X, const CBLAS_INT incX, float *Y, const CBLAS_INT incY);
extern void cblas_scopy_b(const CBLAS_INT N, const float *X, float *X_b, const CBLAS_INT incX, float *Y, float *Y_b, const CBLAS_INT incY);
...
int main(void) {
    ...
    cblas_scopy_b(n, X, X_b, incX, Y, Y_b, incY);
