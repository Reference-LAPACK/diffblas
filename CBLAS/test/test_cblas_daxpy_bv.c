/* Test program for cblas_daxpy vector reverse mode (VJP verification, generic, loop over directions) */
...
int main(void) {
    ...
    cblas_daxpy_bv(n, alpha, &alpha_b, X, X_b, incX, Y, Y_b, incY, nbdirs);
