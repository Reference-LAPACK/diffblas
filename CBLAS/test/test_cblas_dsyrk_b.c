/* Test program for cblas_dsyrk reverse mode (VJP verification, generic) */
...
extern void cblas_dsyrk_b(const CBLAS_LAYOUT layout, const CBLAS_UPLO Uplo, const CBLAS_TRANSPOSE Trans, const CBLAS_INT N, const CBLAS_INT K, const double alpha, double *alpha_b, const double *A, double *A_b, const CBLAS_INT lda, const double beta, double *beta_b, double *C, double *C_b, const CBLAS_INT ldc);
...
int main(void) {
    ...
    cblas_dsyrk_b(layout, uplo, trans, n, k, alpha, &alpha_b, A, A_b, lda, beta, &beta_b, C, C_b, ldc);
