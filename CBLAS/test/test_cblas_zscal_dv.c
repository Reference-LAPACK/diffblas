/* Test program for cblas_zscal forward vector (dv) differentiation */
...
extern void cblas_zscal_dv(CBLAS_INT N, const void *alpha, const void *alphad, void *X, void *Xd, CBLAS_INT incX, int nbdirs);
