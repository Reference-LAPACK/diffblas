/* Test program for cblas_dnrm2 forward vector (dv) differentiation */
...
extern void cblas_dnrm2_dv(CBLAS_INT N, const double *X, double (*Xd)[NBDirsMax], CBLAS_INT incX, double *result, double resultd[NBDirsMax], int nbdirs);
