/* Test program for cblas_ztbmv vector reverse mode (VJP verification, generic, loop over directions) */
...
extern void cblas_ztbmv(const CBLAS_LAYOUT layout, const CBLAS_UPLO Uplo, const CBLAS_TRANSPOSE TransA, const CBLAS_DIAG Diag, const CBLAS_INT N, const CBLAS_INT K, const void *A, const CBLAS_INT lda, void *X, const CBLAS_INT incX);
...
int main(void) {
    ...
    cblas_ztbmv_bv(layout, uplo, transa, diag, n, k, A, (void*)A_b, lda, X, (void*)X_b, incX, nbdirs);
    ...
    for (idir = 0; idir < nbdirs; idir++) {
        ...
        cblas_ztbmv(layout, uplo, transa, diag, n, k, A, lda, X, incX);
