/* Test program for cblas_zdotc_sub vector reverse mode (VJP verification, generic, loop over directions) */
...
int main(void) {
    ...
    double complex dotc[1], dotc_orig[1], dotc_dir[1];
    double complex dotc_b[1][NBDirsMax], dotc_b_orig[1][NBDirsMax];
    double complex dotc_plus[1], dotc_minus[1];
    ...
    cblas_zdotc_sub_bv(n, X, (void*)X_b, incX, Y, (void*)Y_b, incY, dotc, (void*)dotc_b, nbdirs);
